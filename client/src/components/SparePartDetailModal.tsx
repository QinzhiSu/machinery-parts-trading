          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-semibold" style={{ color: 'oklch(0.18 0.04 265)' }}>
                  {brandName === 'SANY' ? getTranslatedSanySparePartCategory(part.category, language) : brandName === 'LiuGong' ? getTranslatedLiuGongSparePartCategory(part.category, language) : brandName === 'Shantui' ? getTranslatedShantuiSparePartCategory(part.category, language) : brandName === 'Caterpillar' ? getTranslatedCATSparePartCategory(part.category, language) : brandName === 'XCMG' ? getTranslatedXCMGSparePartCategory(part.category, language) : brandName === 'Komatsu' ? getTranslatedKomatsuSparePartCategory(part.category, language) : brandName === 'Shacman' ? getTranslatedShacmanSparePartCategory(part.category, language) : brandName === 'Toyota' ? getTranslatedToyotaSparePartCategory(part.category, language) : brandName === 'Cummins' ? getTranslatedCumminsSparePartCategory(part.category, language) : brandName === 'Isuzu' ? getTranslatedIsuzuSparePartCategory(part.category, language) : brandName === 'Sinotruk' ? getTranslatedSinotrukSparePartCategory(part.category, language) : brandName === 'Weichai' ? getTranslatedWeichaiSparePartCategory(part.category, language) : translatePartCategory(part.category)}
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed" style={{ color: 'oklch(0.45 0.02 265)' }}>
                {brandName === 'SANY' ? getTranslatedSanySparePartDescription(part.name, language) : brandName === 'LiuGong' ? getTranslatedLiuGongSparePartDescription(part.name, language) : brandName === 'Shantui' ? getTranslatedShantuiSparePartDescription(part.name, language) : brandName === 'Caterpillar' ? getTranslatedCATSparePartDescription(part.name, language) : brandName === 'XCMG' ? getTranslatedXCMGSparePartDescription(part.name, language) : brandName === 'Komatsu' ? getTranslatedKomatsuSparePartDescription(part.name, language) : brandName === 'Shacman' ? getTranslatedShacmanSparePartDescription(part.name, language) : brandName === 'Toyota' ? getTranslatedToyotaSparePartDescription(part.name, language) : brandName === 'Cummins' ? getTranslatedCumminsSparePartDescription(part.name, language) : brandName === 'Isuzu' ? getTranslatedIsuzuSparePartDescription(part.name, language) : brandName === 'Sinotruk' ? getTranslatedSinotrukSparePartDescription(part.name, language) : brandName === 'Weichai' ? getTranslatedWeichaiSparePartDescription(part.name, language) : translateDescription(part.description)}
              </p>
            </div>

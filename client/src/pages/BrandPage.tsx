                ...
                {brand.machines.map((machine, idx) => (
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      >
                        {brand.id === 'caterpillar' ? getTranslatedCATMachineSpecs(machine.model, language) : brand.id === 'shantui' ? getTranslatedShantuiMachineSpecs(machine.model, language) : brand.id === 'sany' ? getTranslatedSanyMachineSpecs(machine.model, language) : brand.id === 'xcmg' ? getTranslatedXCMGMachineSpecs(machine.specs, language) : brand.id === 'liugong' ? getTranslatedLiuGongMachineSpecs(machine.model, language) : brand.id === 'komatsu' ? getTranslatedKomatsuMachineSpecs(machine.specs, language) : brand.id === 'isuzu' ? getTranslatedIsuzuMachineSpecs(machine.specs, language) : brand.id === 'shacman' ? getTranslatedShacmanMachineSpecs(machine.specs, language) : brand.id === 'sinotruk' ? getTranslatedSinotruckMachineSpecs(machine.specs, language) : brand.id === 'toyota' ? getTranslatedToyotaMachineSpecs(machine.specs, language) : brand.id === 'cummins' ? getTranslatedCumminsMachineSpecs(machine.specs, language) : brand.id === 'weichai' ? getTranslatedWeichaiMachineSpecs(machine.specs, language) : machine.specs}
                      </div>

                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-xs leading-relaxed mb-3" style={{ color: 'oklch(0.5 0.02 265)' }}>
                        {brand.id === 'shantui' ? getTranslatedShantuiSparePartDescription(part.description, language) : brand.id === 'sany' ? getTranslatedSanySparePartDescription(part.description, language) : brand.id === 'xcmg' ? getTranslatedXCMGSparePartDescription(part.description, language) : brand.id === 'caterpillar' ? getTranslatedCATSparePartDescription(part.description, language) : brand.id === 'liugong' ? getTranslatedLiuGongSparePartDescription(part.name, language) : getTranslatedSparePartDescription(part.description, language)}
                      </p>

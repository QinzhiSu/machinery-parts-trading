...
import { getTranslatedXCMGMachineDescription, getTranslatedXCMGMachineFullName, getTranslatedXCMGMachineType, getTranslatedXCMGMachineSpecs } from '@/data/xcmgMachineTranslations';
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-xs leading-relaxed mb-3" style={{ color: 'oklch(0.5 0.02 265)' }}>
                        {brand.id === 'shantui' ? getTranslatedShantuiSparePartDescription(part.name, language) : brand.id === 'sany' ? getTranslatedSanySparePartDescription(part.name, language) : brand.id === 'xcmg' ? getTranslatedXCMGSparePartDescription(part.name, language) : brand.id === 'caterpillar' ? getTranslatedCaterpillarSparePartDescription(part.name, language) : brand.id === 'liugong' ? getTranslatedLiuGongSparePartDescription(part.name, language) : brand.id === 'komatsu' ? getTranslatedKomatsuSparePartDescription(part.name, language) : brand.id === 'isuzu' ? getTranslatedIsuzuSparePartDescription(part.name, language) : brand.id === 'shacman' ? getTranslatedShacmanSparePartDescription(part.name, language) : brand.id === 'sinotruk' ? getTranslatedSinotrukSparePartDescription(part.name, language) : brand.id === 'toyota' ? getTranslatedToyotaSparePartDescription(part.name, language) : brand.id === 'cummins' ? getTranslatedCumminsSparePartDescription(part.name, language) : brand.id === 'weichai' ? getTranslatedWeichaiSparePartDescription(part.name, language) : part.description}
                      </p>

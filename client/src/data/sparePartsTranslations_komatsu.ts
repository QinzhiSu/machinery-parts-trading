...
export const komatsuNameTranslations = {
  'Air Filter(内芯)': {
    en: 'Air Filter(内芯)',
    es: 'Filtro de Aire(内芯)',
    fr: 'Filtre à Air(内芯)',
    de: 'Luftfilter(内芯)',
    pt: 'Filtro de Ar(内芯)',
    ru: 'Воздушный фильтр(内芯)',
    ja: 'エアフィルター(内芯)',
    zh: '空气滤芯(内芯)',
    ar: 'فلتر الهواء(内芯)',
    it: 'Filtro Aria(内芯)',
  ...
  'Air Filter(外芯)': {
    en: 'Air Filter(外芯)',
    es: 'Filtro de Aire(外芯)',
    fr: 'Filtre à Air(外芯)',
    de: 'Luftfilter(外芯)',
    pt: 'Filtro de Ar(外芯)',
    ru: 'Воздушный фильтр(外芯)',
    ja: 'エアフィルター(外芯)',
    zh: '空气滤芯(外芯)',
    ar: 'فلتر الهواء(外芯)',
    it: 'Filtro Aria(外芯)',
  ...
  'Diesel Filter(新款7/8系)': {
    en: 'Diesel Filter(新款7/8系)',
    es: 'Filtro Diesel(新款7/8系)',
    fr: 'Filtre Diesel(新款7/8系)',
    de: 'Dieselfilter(新款7/8系)',
    pt: 'Filtro Diesel(新款7/8系)',
    ru: 'Дизельный фильтр(新款7/8系)',
    ja: 'ディーゼルフィルター(新款7/8系)',
    zh: '柴油滤芯(新款7/8系)',
    ar: 'مرشح الديزل(新款7/8系)',
    it: 'Filtro Diesel(新款7/8系)',
  },
  'Diesel Filter(通用型)': {
  ...
  'Oil Filter(6D102发动机)': {
    en: 'Oil Filter(6D102发动机)',
    es: 'Filtro de Aceite(6D102发动机)',
    fr: 'Filtre à Huile(6D102发动机)',
    de: 'Ölfilter(6D102发动机)',
    pt: 'Filtro de Óleo(6D102发动机)',
    ru: 'Масляный фильтр(6D102发动机)',
    ja: 'オイルフィルター(6D102发动机)',
    zh: '机油滤芯(6D102发动机)',
    ar: 'فلتر الزيت(6D102发动机)',
    it: 'Filtro Olio(6D102发动机)',
  },
  '上托轮(Carrier Roller,PC400-7参考)': {
    ...
    ar: '上托轮(Carrier Roller,PC400-7参考)',
    it: '上托轮(Carrier Roller,PC400-7参考)',
  },
  '下托链轮(Track Roller,PC300-7参考)': {
    ...
    ar: '下托链轮(Track Roller,PC300-7参考)',
    it: '下托链轮(Track Roller,PC300-7参考)',
  },
  '主液压泵(型号2)': {
    en: '主液压泵(型号2)',
    es: '主液压泵(型号2)',

...
export const xcmgMachineDescriptions: Record<string, Record<string, string>> = {
  ...
  'XCMG XE215EV eco-friendly hybrid excavator with electric-hydraulic system. Reduces fuel consumption by 30%, lower emissions, ideal for urban and environmental-sensitive projects. Hybrid Electric System (122 kW equivalent). Max digging depth: 6.8 m. Max reach height: 10.4 m.': {
    ...
    ja: 'XCMG XE215EV eco-friendly hybrid excavator with electric-hydraulic system. Reduces fuel consumption by 30%, lower emissions, 理想的な用途 urban and environmental-sensitive projects. Hybrid Electric System (122 kW equivalent). 最大掘削深度: 6.8 m. Max reach height: 10.4 m.',

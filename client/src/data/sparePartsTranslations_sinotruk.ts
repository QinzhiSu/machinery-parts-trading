...
export const sinotrukNameTranslations = {
  ...
  '输入轴转速传感器': {
    ...
    it: 'Sensore di velocità dell’albero di ingresso',
  },
  '四回路气压保护阀': {
    en: 'Four-Circuit Air Pressure Protection Valve',
    es: 'Válvula Protectora de Presión de Aire de Cuatro Circuitos',
    fr: "Soupape de Protection de Pression d'Air à Quatre Circuits",
    de: 'Vierkreis-Druckschutzventil',
  ...
  '车门玻璃升降器(左/右)': {
    ...
    es: 'Elevalunas de Puerta (Izquierdo/Derecho)',
    fr: 'Lève-vitre de Porte (Gauche/Droite)',
    de: 'Türfensterheber (Links/Rechts)',
    pt: 'Máquina de Vidro da Porta (Esquerda/Direita)',
    ru: 'Стеклоподъемник двери (левый/правый)',
    ja: 'ドアウィンドウレギュレーター（左/右）',
    zh: '车门玻璃升降器(左/右)',
    ar: 'منظم زجاج الباب (يسار/يمين)',
    it: 'Alzacristallo portiera (sinistro/destro)',
  },
  '驱动轴节叉(万向节叉)': {
    en: 'Drive Shaft Yoke (Universal Joint Fork)',
    es: 'Horquilla del Eje de Transmisión (Horquilla de Junta Universal)',
    fr: "Fourche d'Arbre de Transmission (Fourche de Joint Universel)",
    de: 'Antriebswellengabel (Kreuzgelenkgabel)',
    pt: 'Garfo do Eixo de Transmissão (Garfo de Junta Universal)',
    ru: 'Вилка приводного вала (вилка карданного шарнира)',
    ja: 'ドライブシャフトヨーク（ユニバーサルジョイントフォーク）',
    zh: '驱动轴节叉(万向节叉)',
    ar: 'شوكة عمود الإدارة (شوكة المفصل العام)',
    it: 'Forcella dell’albero di trasmissione (forcella del giunto cardanico)',
  },
  '液压油泵(举升系统)': {
    en: 'Hydraulic Oil Pump (Lifting System)',
    es: 'Bomba de Aceite Hidráulico (Sistema de Elevación)',
    fr: "Pompe à Huile Hydraulique (Système de Levage)",
    de: 'Hydraulikölpumpe (Hubsystem)',
    pt: 'Bomba de Óleo Hidráulico (Sistema de Elevação)',
    ru: 'Гидравлический масляный насос (подъемная система)',
    ja: '油圧オイルポンプ（昇降システム）',
    zh: '液压油泵(举升系统)',
...
export const sinotrukCategoryTranslations = {
  ...
  '电气/传感器': {
    ...
    es: 'Sistema Eléctrico/Sensores',
    fr: 'Système Électrique/Capteurs',
    de: 'Elektrik-/Sensorsystem',
    pt: 'Sistema Elétrico/Sensores',
    ru: 'Электрическая система/датчики',
    ja: '電気/センサーシステム',
    zh: '电气/传感器',
    ar: 'النظام الكهربائي/المستشعرات',
    it: 'Sistema elettrico/sensori',
  },
  '车身/驾驶室': {
    en: 'Body/Cab System',
    es: 'Sistema de Carrocería/Cabina',
    fr: 'Système de Carrosserie/Cabine',
    de: 'Karosserie-/Kabinen-System',
    pt: 'Sistema de Carroceria/Cabine',
    ru: 'Система кузова/кабины',
    ja: '車体/キャビンシステム',
    zh: '车身/驾驶室',
    ar: 'نظام الهيكل/الكابينة',
    it: 'Sistema carrozzeria/cabina',
  },
  '轮毂/传动轴': {
    en: 'Wheel Hub/Drive Shaft System',
    es: 'Sistema de Cubo de Rueda/Eje de Transmisión',
    fr: "Système de Moyeu de Roue/Arbre de Transmission",
    de: 'Radnaben-/Antriebswellensystem',
    pt: 'Sistema de Cubo de Roda/Eixo de Transmissão',
    ru: 'Система ступицы колеса/приводного вала',
    ja: 'ホイールハブ/ドライブシャフトシステム',
    zh: '轮毂/传动轴',
    ar: 'نظام محور العجلة/عمود الإدارة',
    it: 'Sistema mozzo ruota/albero di trasmissione',
  },
  '液压/取力': {
    en: 'Hydraulic/PTO System',
    es: 'Sistema Hidráulico/Toma de Fuerza',
    fr: 'Système Hydraulique/Prise de Force',
    de: 'Hydraulik-/Nebenabtriebssystem',
    pt: 'Sistema Hidráulico/Tomada de Força',
    ru: 'Гидравлическая система/вал отбора мощности',
    ja: '油圧/PTOシステム',
    zh: '液压/取力',
    ar: 'النظام الهيدروليكي/نظام مأخذ القدرة',

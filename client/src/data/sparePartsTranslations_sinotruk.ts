...
export const sinotrukNameTranslations = {
  ...
  'Drive Shaft Assembly(变速箱至驱动桥)': {
    ...
    es: 'Drive Shaft Conjunto(变速箱至驱动桥)',
    fr: 'Drive Shaft Assemblage(变速箱至驱动桥)',
    de: 'Drive Shaft Baugruppe(变速箱至驱动桥)',
    pt: 'Drive Shaft Conjunto(变速箱至驱动桥)',
    ru: 'Drive Shaft Узел(变速箱至驱动桥)',
    ja: 'Drive Shaft アセンブリー(变速箱至驱动桥)',
    zh: 'Drive Shaft 总成(变速箱至驱动桥)',
    ar: 'Drive Shaft تجميع(变速箱至驱动桥)',
    it: 'Drive Shaft Assemblaggio(变速箱至驱动桥)',
  },
  ...
  'Hub/Transmission轴': {
    ...
    de: 'Hub/Getriebe轴',
    pt: 'Hub/Transmissão轴',
    ru: 'Hub/Коробка передач轴',
    ja: 'Hub/トランスミッション轴',
    zh: 'Hub/变速箱轴',
    ar: 'Hub/ناقل الحركة轴',
    it: 'Hub/Trasmissione轴',
  },

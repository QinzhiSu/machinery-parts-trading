...
export const brands: Brand[] = [
  // ========== CONSTRUCTION MACHINERY ==========
  {
    ...
    spareParts: [
      { id: 'cat-sp-1', partNumber: '1R-0739', name: '机油滤芯', description: "CAT 零件。250-500小时随保养更换", image: '/manus-storage/cat_ee9e5401.png', category: '保养/滤清系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-2', partNumber: '322-3154', name: '机油滤芯(新款)', description: "CAT 零件。250-500小时随保养更换", image: '/manus-storage/cat_ee9e5401.png', category: '保养/滤清系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-3', partNumber: '1R-0750', name: '燃油滤芯(二级/精滤)', description: "CAT 零件。250-500小时或视油品", image: '/manus-storage/cat_ee9e5401.png', category: '保养/滤清系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-4', partNumber: '179-9806', name: '液压油滤芯', description: "CAT 零件。500-1000小时或视油液检测结果", image: '/manus-storage/cat_ee9e5401.png', category: '保养/滤清系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-5', partNumber: '093-7521', name: '液压油滤芯(新款)', description: "CAT 零件。500-1000小时", image: '/manus-storage/cat_ee9e5401.png', category: '保养/滤清系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-6', partNumber: '209-6000', name: '液压回油滤芯', description: "CAT 零件。500-1000小时", image: '/manus-storage/cat_ee9e5401.png', category: '保养/滤清系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-7', partNumber: '6I-2501', name: '空气滤芯(外芯)', description: "CAT 零件。250-500小时或视灰尘环境", image: '/manus-storage/cat_ee9e5401.png', category: '保养/滤清系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-8', partNumber: '6I-2502', name: '空气滤芯(内芯)', description: "CAT 零件。随外芯同步更换或每2次外芯更换1次内芯", image: '/manus-storage/cat_ee9e5401.png', category: '保养/滤清系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-9', partNumber: '193-2767', name: '散热器水箱总成', description: "CAT 零件。过热/渗漏时更换", image: '/manus-storage/cat_ee9e5401.png', category: '冷却系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-10', partNumber: '49178-00520', name: '涡轮增压器', description: "CAT 零件。动力下降/异响/漏油时更换(大修类)", image: '/manus-storage/cat_ee9e5401.png', category: '增压/进气', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-11', partNumber: '9W-3137', name: '履带链条总成', description: "CAT 零件。履带松旷/磨损超限时更换(大修类高价件)", image: '/manus-storage/cat_ee9e5401.png', category: '底盘/履带系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-12', partNumber: '348-1867', name: '下托链轮(track roller)', description: "CAT 零件。漏油/磨损时更换", image: '/manus-storage/cat_ee9e5401.png', category: '底盘/履带系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-13', partNumber: '248-7143', name: '前导向轮(Front Idler)', description: "CAT 零件。磨损/异响时更换", image: '/manus-storage/cat_ee9e5401.png', category: '底盘/履带系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-14', partNumber: '需按底盘编号核实(E320D', name: '驱动链轮(Drive Sprocket)', description: "CAT 零件。轮齿磨损/断齿时更换", image: '/manus-storage/cat_ee9e5401.png', category: '底盘/履带系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-15', partNumber: '8E-5600', name: '上托轮(Carrier Roller)', description: "CAT 零件。漏油/磨损时更换", image: '/manus-storage/cat_ee9e5401.png', category: '底盘/履带系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-16', partNumber: '1U-3351', name: '铲斗斗齿(通用J系列)', description: "CAT 零件。磨损见底或断裂时更换,高频更换件", image: '/manus-storage/cat_ee9e5401.png', category: '挖掘属性/GET', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-17', partNumber: '需与斗齿配套核实(E320系列)', name: '斗齿适配器(Adapter)', description: "CAT 零件。随斗齿更换,寿命长于斗齿本身", image: '/manus-storage/cat_ee9e5401.png', category: '挖掘属性/GET', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-18', partNumber: '6Y-3394', name: '斗齿销/锁定销(Pin-G.E.T.)', description: "CAT 零件。每次换齿时同步更换", image: '/manus-storage/cat_ee9e5401.png', category: '挖掘属性/GET', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-19', partNumber: '499-0030', name: '最终驱动/行走减速机总成', description: "CAT 零件。异响/漏油/爬升无力时更换(大修类高价件)", image: '/manus-storage/cat_ee9e5401.png', category: '传动系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-20', partNumber: '需按具体底盘序列号核实', name: '行走(履带)马达', description: "CAT 零件。异响/爬坡无力时更换(大修类)", image: '/manus-storage/cat_ee9e5401.png', category: '传动系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-21', partNumber: '需按具体底盘序列号核实', name: '回转(转台)马达及减速机', description: "CAT 零件。转台异响/回转无力时更换(大修类)", image: '/manus-storage/cat_ee9e5401.png', category: '传动系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-22', partNumber: '183-5300 (1U3302V)', name: '斗齿(J300系列,V型)', description: "CAT 零件。磨损见底或断裂时更换,高频更换件", image: '/manus-storage/cat_ee9e5401.png', category: '挖掘属性/GET(小型段)', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-23', partNumber: '8E-9490', name: '斗齿适配器(J300侧销式)', description: "CAT 零件。随斗齿磨损检查,寿命长于斗齿本身", image: '/manus-storage/cat_ee9e5401.png', category: '挖掘属性/GET(小型段)', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-24', partNumber: '8E-4402 (1U3352V)', name: '斗齿(J350系列,HD穿透型)', description: "CAT 零件。磨损见底或断裂时更换,高频更换件", image: '/manus-storage/cat_ee9e5401.png', category: '挖掘属性/GET(中型段)', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-25', partNumber: '1U-3352', name: '斗齿(J350系列,通用型)', description: "CAT 零件。磨损见底或断裂时更换,高频更换件", image: '/manus-storage/cat_ee9e5401.png', category: '挖掘属性/GET(中型段)', compatibleModels: ["CAT 320", "CAT 320D"] },

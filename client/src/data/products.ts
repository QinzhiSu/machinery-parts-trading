...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    spareParts: [
      ...
      { id: 'toyota-sp-3', partNumber: '23390-0L090', name: '柴油滤芯(前置)', description: 'Toyota Hilux 零件。每20,000km,柴油车关键件', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Maintenance/Filtration System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-4', partNumber: '87139-0K060', name: '空调/花粉滤芯', description: 'Toyota Hilux 零件。10,000-15,000km', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Maintenance/Filtration System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-5', partNumber: '04426-0L020', name: '燃油泵SCV阀', description: 'Toyota Hilux 零件。燃油系统故障时更换,注意年款', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Maintenance/Filtration System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-6', partNumber: '90916-T2033', name: '风扇/发电机V带', description: 'Toyota Hilux 零件。60,000-100,000km检查', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Transmission/Belt', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-7', partNumber: '13521-0E010(链条张紧齿轮)', name: '正时链条组件(非皮带)', description: 'Toyota Hilux 零件。链条驱动寿命较长,需定期检查', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Transmission/Belt', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-8', partNumber: '13566-0E010', name: '正时链条导轨', description: 'Toyota Hilux 零件。随链条组件检查', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Transmission/Belt', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-9', partNumber: '13616-0E010', name: '曲轴正时齿轮', description: 'Toyota Hilux 零件。大修时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Transmission/Belt', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-10', partNumber: '04465-0K360', name: '前刹车片', description: 'Toyota Hilux 零件。30,000-60,000km或视磨损', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Braking System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-11', partNumber: '04495-0K160', name: '后刹车蹄片', description: 'Toyota Hilux 零件。与前片同步检查更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Braking System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-12', partNumber: '47750-0K300', name: '刹车分泵总成(后)', description: 'Toyota Hilux 零件。渗油/卡滞时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Braking System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-13', partNumber: '47730-0K300', name: '刹车分泵缸体(前)', description: 'Toyota Hilux 零件。配合刹车片总成', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Braking System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      ...
      { id: 'toyota-sp-28', partNumber: '16278-0E010', name: '水路旁通管', description: 'Toyota Hilux 零件。随水泵一同检查', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Cooling System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-29', partNumber: '16711-0L170', name: '散热器风扇罩', description: 'Toyota Hilux 零件。风扇异响/散热不良时', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Cooling System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },

...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    spareParts: [
      ...
      { id: 'sm-sp-21', partNumber: 'DZ96189584021', name: '轴承套件 (Bearing Kit)', description: '陕汽轴承套件，包含多种规格轴承，用于变速箱和差速器。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：深沟球轴承，精度等级 P6，工作温度 -40~120℃。', image: '/manus-storage/Jiv6nemLZuOa_1734892e.png', category: 'Transmission System' },
      { id: 'sm-sp-22', partNumber: 'DZ96189584022', name: '差速器总成 (Differential Assembly)', description: '陕汽差速器总成，实现左右车轮差速转动。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：行星齿轮式，齿比 3.73，工作温度 -40~80℃。', image: '/manus-storage/9PIqbbAv6sKl_ac3611b6.jpg', category: 'Transmission System' },
      { id: 'sm-sp-23', partNumber: 'DZ96189584023', name: '转向节销 (Kingpin)', description: '陕汽转向节销，连接转向节和车轴，支撑前轮。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：锻钢，直径 40mm，长度 180mm。', image: '/manus-storage/rcF6y8CdlqOZ_f4160cdf.png', category: 'Suspension System' },
      { id: 'sm-sp-24', partNumber: 'DZ96189584024', name: '转向节销套件 (Kingpin Kit)', description: '陕汽转向节销套件，包含销、衬套、垫片等配件。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：完整套件，包含所有密封件，工作温度 -40~80℃。', image: '/manus-storage/hLxsio4HghPa_7214f548.jpg', category: 'Suspension System' },
      { id: 'sm-sp-25', partNumber: 'DZ96189584025', name: '喷油泵 (Fuel Injection Pump)', description: '陕汽柴油喷油泵，为发动机供应高压燃油。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：高压泵，工作压力 250bar，流量 80L/h。', image: '/manus-storage/1NRDozJOn0Rw_a6b889dd.webp', category: 'Fuel System' },
      { id: 'sm-sp-26', partNumber: 'DZ96189584026', name: '喷油器座 (Fuel Injector Seat)', description: '陕汽喷油器座，固定喷油器，防止泄漏。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：铜合金座，螺纹 M14×1.5，工作温度 -40~200℃。', image: '/manus-storage/MuLqL9HtJrlo_f8a53e29.webp', category: 'Fuel System' },
      { id: 'sm-sp-27', partNumber: 'DZ96189584027', name: '散热器 (Radiator)', description: '陕汽铝制散热器，高效散热，保持发动机工作温度。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：铝制芯体，散热面积 2.5m²，工作压力 1.5bar。', image: '/manus-storage/sTdwnu1ofWBX_607891a1.webp', category: 'Cooling System' },
      ...
      { id: 'sm-sp-29', partNumber: 'DZ96189584029', name: '转向柱支撑轴承 (Steering Column Bearing)', description: '陕汽转向柱支撑轴承，支撑转向柱，减少摩擦。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：球面滚子轴承，工作温度 -40~80℃。', image: '/manus-storage/BtQzActYZvaY_41cc8525.png', category: 'Steering System' },
      { id: 'sm-sp-30', partNumber: 'DZ96189584030', name: '转向节联轴节 (Steering Joint)', description: '陕汽转向节联轴节，连接转向柱和转向齿轮，传递转向力。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：万向节，直径 30mm，工作温度 -40~80℃。', image: '/manus-storage/igOuZDPxK7HX_32ead5cf.png', category: 'Steering System' },
      { id: 'sm-sp-31', partNumber: 'DZ96189584031', name: '油箱盖 (Fuel Tank Cap)', description: '陕汽油箱盖，防止燃油泄漏和蒸发。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：塑料盖，开启压力 0.5bar，工作温度 -40~80℃。', image: '/manus-storage/q9nwbDUdxFXg_ac9d8409.png', category: 'Fuel System' },
      { id: 'sm-sp-32', partNumber: 'DZ96189584032', name: '玻璃水储液罐盖 (Washer Reservoir Cap)', description: '陕汽玻璃水储液罐盖，防止液体泄漏。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：塑料盖，螺纹接口，工作温度 -40~60℃。', image: '/manus-storage/5W0I64UCfl2P_142f7e40.png', category: 'Electrical System' },
      { id: 'sm-sp-33', partNumber: 'DZ96189584033', name: '座椅控制开关 (Seat Control Switch)', description: '陕汽电动座椅控制开关，调节座椅位置和靠背。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：3针开关，电压 12V，工作温度 -40~80℃。', image: '/manus-storage/QaKD5tuZSMZi_c173962c.png', category: 'Electrical System' },
      { id: 'sm-sp-34', partNumber: 'DZ96189584034', name: '转向柱下支撑轴承 (Lower Steering Column Bearing)', description: '陕汽转向柱下支撑轴承，支撑转向柱下端。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：滚针轴承，工作温度 -40~80℃。', image: '/manus-storage/900HHZkM5Pem_baa0b9e0.png', category: 'Steering System' },
      { id: 'sm-sp-35', partNumber: 'DZ96189584035', name: '玻璃水储液罐盖（重型卡车）(Washer Reservoir Cap Heavy Duty)', description: '陕汽重型卡车玻璃水储液罐盖，耐压耐温。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：加强型塑料盖，工作温度 -40~60℃。', image: '/manus-storage/wfc5YBhp7kRC_f86b2f7c.png', category: 'Electrical System' },
      { id: 'sm-sp-36', partNumber: 'DZ96189584036', name: '座椅加热控制开关 (Seat Heating Switch)', description: '陕汽座椅加热控制开关，控制座椅加热功能。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：3档开关，电压 12V，功率 100W。', image: '/manus-storage/qJ2NNrfEUqUf_e1511d5a.png', category: 'Electrical System' },
      { id: 'sm-sp-37', partNumber: 'DZ96189584037', name: '转向柱联轴节套件 (Steering Column Joint Kit)', description: '陕汽转向柱联轴节套件，包含所有连接件。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：完整套件，工作温度 -40~80℃。', image: '/manus-storage/H3yvjxaOTHYT_9f3574c3.webp', category: 'Steering System' },
      { id: 'sm-sp-38', partNumber: 'DZ96189584038', name: '发动机垫片套件 (Engine Gasket Kit)', description: '陕汽发动机垫片套件，包含所有发动机垫片。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：完整套件，包含缸盖垫、油底壳垫等。', image: '/manus-storage/MuLqL9HtJrlo_f8a53e29.webp', category: 'Engine System' },

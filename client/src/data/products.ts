...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    spareParts: [
      ...
      { id: 'toyota-sp-14', partNumber: '48510-8Z205', name: 'Front Shock Absorber', description: 'Toyota Hilux 零件。80,000-100,000km或异响时', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '悬挂系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-15', partNumber: '48654-0K080', name: 'Front Lower Control Arm Bushing', description: 'Toyota Hilux 零件。悬挂异响、跑偏时检查', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '悬挂系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-16', partNumber: '90385-T0014', name: 'Rear Leaf Spring Hanger Bushing', description: 'Toyota Hilux 零件。弹簧异响/下沉时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '悬挂系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-17', partNumber: '需按VIN核实', name: 'Shock Absorber Upper Mount (Top Rubber)', description: 'Toyota Hilux 零件。异响/下沉时检查', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '悬挂系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-18', partNumber: '45046-09810', name: 'Steering Tie Rod Ball Joint', description: 'Toyota Hilux 零件。方向盘异响/跑偏时检查', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '转向系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-19', partNumber: '45503-0K130', name: 'Steering Gear Tie Rod End', description: 'Toyota Hilux 零件。与拉杆球头配套更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '转向系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-20', partNumber: '45601-35070', name: 'Steering Knuckle Arm (Spindle Arm)', description: 'Toyota Hilux 零件。转向异响/精度下降时', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '转向系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-21', partNumber: '90369-T0003', name: 'Front Wheel Bearing Assembly', description: 'Toyota Hilux 零件。异响/间隙过大时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '轮毂/传动轴', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-22', partNumber: '90366-T0060', name: 'Rear Wheel Bearing Assembly (with ABS Ring)', description: 'Toyota Hilux 零件。异响时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '轮毂/传动轴', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-23', partNumber: '43040-0K070', name: 'Front CV Constant Velocity Joint', description: 'Toyota Hilux 零件。异响、行驶抖动时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '轮毂/传动轴', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-24', partNumber: '43371-0K130', name: 'Drive Shaft Cross Joint (Universal Joint)', description: 'Toyota Hilux 零件。传动轴异响时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '轮毂/传动轴', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-25', partNumber: '41110-0K280', name: 'Front Differential Case', description: 'Toyota Hilux 零件。大修/异响时,专业件建议核实VIN', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '差速器/传动', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-26', partNumber: '41201-09E42', name: 'Differential Gear Assembly', description: 'Toyota Hilux 零件。大修件,非常规易损', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '差速器/传动', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
  ...
  },
  {
    ...
    spareParts: [
      ...
      { id: 'weichai-sp-26', partNumber: '4110000556111(61500030009', name: 'Connecting Rod Assembly', description: "WEICHAI 零件。大修类,异响/敲缸时检修更换", image: '/manus-storage/weichai_2cc7d2af.png', category: '传动/活塞组件', compatibleModels: ["Weichai WP10", "WP12"] },

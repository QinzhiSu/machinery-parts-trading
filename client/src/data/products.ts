...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    spareParts: [
      { id: 'toyota-sp-1', partNumber: '90915-YZZJ3', name: '机油滤芯', description: 'Toyota Hilux 零件。5,000-10,000km随保养更换', image: '/manus-storage/BUOolRSMV9Ph_112a8f44.jpg', category: '保养/滤清系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-2', partNumber: '17801-0L040', name: '空气滤芯', description: 'Toyota Hilux 零件。10,000-20,000km或视路况', image: '/manus-storage/FdonwIPPrJ9D_ca9527bd.png', category: '保养/滤清系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-3', partNumber: '23390-0L090', name: '柴油滤芯(前置)', description: 'Toyota Hilux 零件。每20,000km,柴油车关键件', image: '/manus-storage/6Gjexz977tuF_6a161744.jpg', category: '保养/滤清系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-4', partNumber: '87139-0K060', name: '空调/花粉滤芯', description: 'Toyota Hilux 零件。10,000-15,000km', image: '/manus-storage/rXWUAp5nu9Qe_ad486762.png', category: '保养/滤清系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-5', partNumber: '04426-0L020', name: '燃油泵SCV阀', description: 'Toyota Hilux 零件。燃油系统故障时更换,注意年款', image: '/manus-storage/LnBpZg74yuhY_22121b85.png', category: '保养/滤清系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-6', partNumber: '90916-T2033', name: '风扇/发电机V带', description: 'Toyota Hilux 零件。60,000-100,000km检查', image: '/manus-storage/5wKHq2a7I4qC_220144f5.jpg', category: '传动/皮带', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-7', partNumber: '13521-0E010(链条张紧齿轮)', name: '正时链条组件(非皮带)', description: 'Toyota Hilux 零件。链条驱动寿命较长,需定期检查', image: '/manus-storage/BUOolRSMV9Ph_112a8f44.jpg', category: '传动/皮带', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-8', partNumber: '13566-0E010', name: '正时链条导轨', description: 'Toyota Hilux 零件。随链条组件检查', image: '/manus-storage/FdonwIPPrJ9D_ca9527bd.png', category: '传动/皮带', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-9', partNumber: '13616-0E010', name: '曲轴正时齿轮', description: 'Toyota Hilux 零件。大修时更换', image: '/manus-storage/6Gjexz977tuF_6a161744.jpg', category: '传动/皮带', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-10', partNumber: '04465-0K360', name: '前刹车片', description: 'Toyota Hilux 零件。30,000-60,000km或视磨损', image: '/manus-storage/rXWUAp5nu9Qe_ad486762.png', category: '制动系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-11', partNumber: '04495-0K160', name: '后刹车蹄片', description: 'Toyota Hilux 零件。与前片同步检查更换', image: '/manus-storage/LnBpZg74yuhY_22121b85.png', category: '制动系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-12', partNumber: '47750-0K300', name: '刹车分泵总成(后)', description: 'Toyota Hilux 零件。渗油/卡滞时更换', image: '/manus-storage/5wKHq2a7I4qC_220144f5.jpg', category: '制动系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-13', partNumber: '47730-0K300', name: '刹车分泵缸体(前)', description: 'Toyota Hilux 零件。配合刹车片总成', image: '/manus-storage/BUOolRSMV9Ph_112a8f44.jpg', category: '制动系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-14', partNumber: '48510-8Z205', name: '前减震器', description: 'Toyota Hilux 零件。80,000-100,000km或异响时', image: '/manus-storage/FdonwIPPrJ9D_ca9527bd.png', category: '悬挂系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-15', partNumber: '48654-0K080', name: '前下摆臂衬套', description: 'Toyota Hilux 零件。悬挂异响、跑偏时检查', image: '/manus-storage/6Gjexz977tuF_6a161744.jpg', category: '悬挂系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-16', partNumber: '90385-T0014', name: '后钢板弹簧吊耳衬套', description: 'Toyota Hilux 零件。弹簧异响/下沉时更换', image: '/manus-storage/rXWUAp5nu9Qe_ad486762.png', category: '悬挂系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-17', partNumber: '需按VIN核实', name: '减震器上支座(顶胶)', description: 'Toyota Hilux 零件。异响/下沉时检查', image: '/manus-storage/LnBpZg74yuhY_22121b85.png', category: '悬挂系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-18', partNumber: '45046-09810', name: '转向拉杆球头', description: 'Toyota Hilux 零件。方向盘异响/跑偏时检查', image: '/manus-storage/5wKHq2a7I4qC_220144f5.jpg', category: '转向系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-19', partNumber: '45503-0K130', name: '转向机拉杆端', description: 'Toyota Hilux 零件。与拉杆球头配套更换', image: '/manus-storage/BUOolRSMV9Ph_112a8f44.jpg', category: '转向系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-20', partNumber: '45601-35070', name: '转向节臂(羊角臂)', description: 'Toyota Hilux 零件。转向异响/精度下降时', image: '/manus-storage/FdonwIPPrJ9D_ca9527bd.png', category: '转向系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-21', partNumber: '90369-T0003', name: '前轮轴承总成', description: 'Toyota Hilux 零件。异响/间隙过大时更换', image: '/manus-storage/6Gjexz977tuF_6a161744.jpg', category: '轮毂/传动轴', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-22', partNumber: '90366-T0060', name: '后轮轴承总成(含ABS环)', description: 'Toyota Hilux 零件。异响时更换', image: '/manus-storage/rXWUAp5nu9Qe_ad486762.png', category: '轮毂/传动轴', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-23', partNumber: '43040-0K070', name: '前CV等速万向节', description: 'Toyota Hilux 零件。异响、行驶抖动时更换', image: '/manus-storage/LnBpZg74yuhY_22121b85.png', category: '轮毂/传动轴', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-24', partNumber: '43371-0K130', name: '传动轴十字节(万向节)', description: 'Toyota Hilux 零件。传动轴异响时更换', image: '/manus-storage/5wKHq2a7I4qC_220144f5.jpg', category: '轮毂/传动轴', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-25', partNumber: '41110-0K280', name: '前差速器壳体', description: 'Toyota Hilux 零件。大修/异响时,专业件建议核实VIN', image: '/manus-storage/BUOolRSMV9Ph_112a8f44.jpg', category: '差速器/传动', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-26', partNumber: '41201-09E42', name: '差速器齿轮总成', description: 'Toyota Hilux 零件。大修件,非常规易损', image: '/manus-storage/FdonwIPPrJ9D_ca9527bd.png', category: '差速器/传动', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-27', partNumber: '16100-09711', name: '水泵总成', description: 'Toyota Hilux 零件。冷却液渗漏/异响时更换,建议6-8万km检查', image: '/manus-storage/6Gjexz977tuF_6a161744.jpg', category: '冷却系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-28', partNumber: '16278-0E010', name: '水路旁通管', description: 'Toyota Hilux 零件。随水泵一同检查', image: '/manus-storage/rXWUAp5nu9Qe_ad486762.png', category: '冷却系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-29', partNumber: '16711-0L170', name: '散热器风扇罩', description: 'Toyota Hilux 零件。风扇异响/散热不良时', image: '/manus-storage/LnBpZg74yuhY_22121b85.png', category: '冷却系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-30', partNumber: '16400-0K350', name: '散热器总成(参考)', description: 'Toyota Hilux 零件。过热/渗漏时更换', image: '/manus-storage/5wKHq2a7I4qC_220144f5.jpg', category: '冷却系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] }
    ]
  },
  {
    id: 'cummins',

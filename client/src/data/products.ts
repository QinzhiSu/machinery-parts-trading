...
export const brands: Brand[] = [
  // ========== CONSTRUCTION MACHINERY ==========
  {
    ...
    spareParts: [
      { id: 'cat-sp-1', partNumber: '106-3969', name: 'Primary Air Filter', description: 'Primary Air Filter for 320B, 320C, 320D. Engine: 3066, C6.4. High Turnover: YES', image: '/manus-storage/VAnF89sB5Or7_52c0fd2e.jpg', category: 'Filters' },
      { id: 'cat-sp-2', partNumber: '106-3973', name: 'Secondary Air Filter', description: 'Secondary Air Filter for 320B, 320C, 320D. Engine: 3066, C6.4. High Turnover: YES', image: '/manus-storage/PUs78fpWmVr0_1d294af8.jpg', category: 'Filters' },
      { id: 'cat-sp-3', partNumber: '163-0472', name: 'Valve Cover Gasket', description: 'Valve Cover Gasket for 950G, 938G. Engine: 3116, 3126. High Turnover: YES', image: '/manus-storage/7RN9mqyOaarW_c493725e.jpg', category: 'Engine' },
      { id: 'cat-sp-4', partNumber: '175-8027', name: 'Track Roller (Single Flange)', description: 'Track Roller (Single Flange) for D6R, D6T, D6N. Engine: N/A. High Turnover: YES', image: '/manus-storage/OJHDQ3kQ1oij_92b0f5d2.png', category: 'Undercarriage' },
      { id: 'cat-sp-5', partNumber: '183-2823', name: 'Fuel Priming Pump', description: 'Fuel Priming Pump for 320D, 330D, 336D. Engine: C7, C9, C13. High Turnover: YES', image: '/manus-storage/XhSg4P0JtLnG_39fc07b0.jpg', category: 'Fuel System' },
      { id: 'cat-sp-6', partNumber: '185-5294', name: 'Alternator', description: 'Alternator for 320D, 325D, 330D. Engine: C7, C9. High Turnover: Medium', image: '/manus-storage/SMLR9DG45LBB_ef9dbe22.jpg', category: 'Electrical' },
      { id: 'cat-sp-7', partNumber: '190-6681', name: 'Fan Belt (Ribbed)', description: 'Fan Belt (Ribbed) for 320D, 120K. Engine: C7. High Turnover: YES', image: '/manus-storage/OUcW5uMzlcjW_032c7470.jpg', category: 'Belts' },
      { id: 'cat-sp-8', partNumber: '197-9386', name: 'Piston Ring Set', description: 'Piston Ring Set for 320C, 320D. Engine: 3066 / C6.4. High Turnover: Medium', image: '/manus-storage/VAnF89sB5Or7_52c0fd2e.jpg', category: 'Engine' },
      ...
      { id: 'cat-sp-16', partNumber: '207-1556', name: 'Starter Motor', description: 'Starter Motor for 320C, 320D. Engine: 3066, C6.4. High Turnover: Medium', image: '/manus-storage/PUs78fpWmVr0_1d294af8.jpg', category: 'Electrical' },
      { id: 'cat-sp-17', partNumber: '221-9355', name: 'Cylinder Head Gasket', description: 'Cylinder Head Gasket for 320D, 120K, M325C. Engine: C7. High Turnover: YES (Repair)', image: '/manus-storage/7RN9mqyOaarW_c493725e.jpg', category: 'Engine' },
      { id: 'cat-sp-18', partNumber: '230-2520', name: 'Connecting Rod Bearing', description: 'Connecting Rod Bearing for 345D, 349D, D8R. Engine: C13, C15. High Turnover: Medium', image: '/manus-storage/OJHDQ3kQ1oij_92b0f5d2.png', category: 'Engine' },
      { id: 'cat-sp-19', partNumber: '235-2858', name: 'Turbocharger', description: 'Turbocharger for 320D Excavator. Engine: C7. High Turnover: Medium', image: '/manus-storage/XhSg4P0JtLnG_39fc07b0.jpg', category: 'Engine' },
      { id: 'cat-sp-20', partNumber: '243-6710', name: 'Main Bearing (Standard)', description: 'Main Bearing (Standard) for 320D, 330D. Engine: C7, C9. High Turnover: Medium', image: '/manus-storage/SMLR9DG45LBB_ef9dbe22.jpg', category: 'Engine' },
      { id: 'cat-sp-21', partNumber: '248-5513', name: 'Thermostat', description: 'Thermostat for Universal. Engine: C7, C9, C13. High Turnover: YES (Cooling)', image: '/manus-storage/OUcW5uMzlcjW_032c7470.jpg', category: 'Engine' },
      { id: 'cat-sp-22', partNumber: '295-9126', name: 'Injection Pump', description: 'Injection Pump for 320D GC, 420E. Engine: C4.4, C6.6. High Turnover: Medium', image: '/manus-storage/VAnF89sB5Or7_52c0fd2e.jpg', category: 'Fuel System' },
      { id: 'cat-sp-23', partNumber: '326-1644', name: 'Water Separator', description: 'Water Separator for 320D, 323D, 420E. Engine: C4.4, C6.6, C7. High Turnover: YES (Must-stock)', image: '/manus-storage/PUs78fpWmVr0_1d294af8.jpg', category: 'Filters' },
      { id: 'cat-sp-24', partNumber: '326-4700', name: 'Fuel Injector (Common Rail)', description: 'Fuel Injector (Common Rail) for 320D Excavator. Engine: C6.4. High Turnover: YES (Critical)', image: '/manus-storage/7RN9mqyOaarW_c493725e.jpg', category: 'Fuel System' },
      { id: 'cat-sp-25', partNumber: '332-6020', name: 'Full Gasket Kit (Overhaul)', description: 'Full Gasket Kit (Overhaul) for 330D, 336D, D6R. Engine: C9. High Turnover: Medium (Major)', image: '/manus-storage/OJHDQ3kQ1oij_92b0f5d2.png', category: 'Engine' },
      { id: 'cat-sp-26', partNumber: '352-0203', name: 'Water Pump', description: 'Water Pump for 345D, 349D, D8R, D8T. Engine: C13, C15, C18. High Turnover: Medium', image: '/manus-storage/XhSg4P0JtLnG_39fc07b0.jpg', category: 'Engine' },
      { id: 'cat-sp-27', partNumber: '4T-6381', name: 'Cutting Edge (Dozer)', description: 'Cutting Edge (Dozer) for D6R, D6T Bulldozer. Engine: N/A. High Turnover: YES', image: '/manus-storage/SMLR9DG45LBB_ef9dbe22.jpg', category: 'Wear Parts' },
      { id: 'cat-sp-28', partNumber: '4T-6387', name: 'End Bit (Left)', description: 'End Bit (Left) for D6R, D6T Bulldozer. Engine: N/A. High Turnover: YES', image: '/manus-storage/OUcW5uMzlcjW_032c7470.jpg', category: 'Wear Parts' },
      { id: 'cat-sp-29', partNumber: '4T-6388', name: 'End Bit (Right)', description: 'End Bit (Right) for D6R, D6T Bulldozer. Engine: N/A. High Turnover: YES', image: '/manus-storage/VAnF89sB5Or7_52c0fd2e.jpg', category: 'Wear Parts' },
      { id: 'cat-sp-30', partNumber: '6I-9254', name: 'Tooth Adapter (Center)', description: 'Tooth Adapter (Center) for 320 Series Excavator. Engine: N/A. High Turnover: YES', image: '/manus-storage/PUs78fpWmVr0_1d294af8.jpg', category: 'Wear Parts' },
      { id: 'cat-sp-31', partNumber: 'CR5508', name: 'Carrier Roller', description: 'Carrier Roller for 320B, 320C, 320D. Engine: N/A. High Turnover: YES', image: '/manus-storage/7RN9mqyOaarW_c493725e.jpg', category: 'Undercarriage' },
    ]
  },
  {
    id: 'shantui',
  ...
  },
  {
    ...
    spareParts: [
      ...
      { id: 'xcmg-803070130', partNumber: '803070130', name: 'Idler Arm', description: 'XCMG Idler Arm (OEM: 803070130). Category: Excavator Undercarriage. Applicable Models: XE215DA/XE155UCR/XE520E. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/axMq3scQ8xZr_i9j0k1l2.jpg', category: 'Excavator Undercarriage', compatibleModels: ["XE215DA/XE155UCR/XE520E"] },
      ...
      { id: 'xcmg-803070133', partNumber: '803070133', name: 'Track Pin', description: 'XCMG Track Pin (OEM: 803070133). Category: Excavator Undercarriage. Applicable Models: XE215DA/XE155UCR/XE520E. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/axMq3scQ8xZr_i9j0k1l2.jpg', category: 'Excavator Undercarriage', compatibleModels: ["XE215DA/XE155UCR/XE520E"] },
      ...
      { id: 'xcmg-803090104', partNumber: '803090104', name: 'Camshaft', description: 'XCMG Camshaft (OEM: 803090104). Category: Excavator Engine System. Applicable Models: XE215DA/XE370CA/XE520E. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/7kSIAoqERqKl_34604984.webp', category: 'Excavator Engine System', compatibleModels: ["XE215DA/XE370CA/XE520E"] },
      { id: 'xcmg-803090105', partNumber: '803090105', name: 'Piston', description: 'XCMG Piston (OEM: 803090105). Category: Excavator Engine System. Applicable Models: XE215DA/XE370CA/XE520E. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/7kSIAoqERqKl_34604984.webp', category: 'Excavator Engine System', compatibleModels: ["XE215DA/XE370CA/XE520E"] },
      ...
      { id: 'xcmg-803090107', partNumber: '803090107', name: 'Valve', description: 'XCMG Valve (OEM: 803090107). Category: Excavator Engine System. Applicable Models: XE215DA/XE370CA/XE520E. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/7kSIAoqERqKl_34604984.webp', category: 'Excavator Engine System', compatibleModels: ["XE215DA/XE370CA/XE520E"] },
      ...
      { id: 'xcmg-803100103', partNumber: '803100103', name: 'Boom', description: 'XCMG Boom (OEM: 803100103). Category: Excavator Working Device. Applicable Models: XE215DA/XE370CA/XE520E. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/HUMEcesbyAE8_d9da0548.png', category: 'Excavator Working Device', compatibleModels: ["XE215DA/XE370CA/XE520E"] },
      { id: 'xcmg-803100104', partNumber: '803100104', name: 'Arm', description: 'XCMG Arm (OEM: 803100104). Category: Excavator Working Device. Applicable Models: XE215DA/XE370CA/XE520E. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/HUMEcesbyAE8_d9da0548.png', category: 'Excavator Working Device', compatibleModels: ["XE215DA/XE370CA/XE520E"] },
      { id: 'xcmg-803100105', partNumber: '803100105', name: 'Bucket', description: 'XCMG Bucket (OEM: 803100105). Category: Excavator Working Device. Applicable Models: XE215DA/XE370CA/XE520E. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/HUMEcesbyAE8_d9da0548.png', category: 'Excavator Working Device', compatibleModels: ["XE215DA/XE370CA/XE520E"] },
      ...
      { id: 'xcmg-803100108', partNumber: '803100108', name: 'Cabin', description: 'XCMG Cabin (OEM: 803100108). Category: Excavator Working Device. Applicable Models: XE215DA/XE370CA/XE520E. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/HUMEcesbyAE8_d9da0548.png', category: 'Excavator Working Device', compatibleModels: ["XE215DA/XE370CA/XE520E"] },
      ...
      { id: 'xcmg-803120101', partNumber: '803120101', name: 'Brake Disc', description: 'XCMG Brake Disc (OEM: 803120101). Category: Loader Brake System. Applicable Models: XC9260/XC968. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/RrQL1gjKniwG_ff95782f.png', category: 'Loader Brake System', compatibleModels: ["XC9260/XC968"] },
      { id: 'xcmg-803120102', partNumber: '803120102', name: 'Brake Pad', description: 'XCMG Brake Pad (OEM: 803120102). Category: Loader Brake System. Applicable Models: XC9260/XC968. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/RrQL1gjKniwG_ff95782f.png', category: 'Loader Brake System', compatibleModels: ["XC9260/XC968"] },
      { id: 'xcmg-803120103', partNumber: '803120103', name: 'Brake Cylinder', description: 'XCMG Brake Cylinder (OEM: 803120103). Category: Loader Brake System. Applicable Models: XC9260/XC968. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/RrQL1gjKniwG_ff95782f.png', category: 'Loader Brake System', compatibleModels: ["XC9260/XC968"] },
      { id: 'xcmg-803120104', partNumber: '803120104', name: 'Brake Hose', description: 'XCMG Brake Hose (OEM: 803120104). Category: Loader Brake System. Applicable Models: XC9260/XC968. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/RrQL1gjKniwG_ff95782f.png', category: 'Loader Brake System', compatibleModels: ["XC9260/XC968"] },
      { id: 'xcmg-803130101', partNumber: '803130101', name: 'Wheel', description: 'XCMG Wheel (OEM: 803130101). Category: Loader Wheel System. Applicable Models: XC9260/XC968. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/mEykvoZZnbwy_e5cea219.png', category: 'Loader Wheel System', compatibleModels: ["XC9260/XC968"] },
      { id: 'xcmg-803130102', partNumber: '803130102', name: 'Tire', description: 'XCMG Tire (OEM: 803130102). Category: Loader Wheel System. Applicable Models: XC9260/XC968. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/mEykvoZZnbwy_e5cea219.png', category: 'Loader Wheel System', compatibleModels: ["XC9260/XC968"] },
      { id: 'xcmg-803130103', partNumber: '803130103', name: 'Wheel Hub', description: 'XCMG Wheel Hub (OEM: 803130103). Category: Loader Wheel System. Applicable Models: XC9260/XC968. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/mEykvoZZnbwy_e5cea219.png', category: 'Loader Wheel System', compatibleModels: ["XC9260/XC968"] },
      { id: 'xcmg-803130104', partNumber: '803130104', name: 'Bearing', description: 'XCMG Bearing (OEM: 803130104). Category: Loader Wheel System. Applicable Models: XC9260/XC968. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/mEykvoZZnbwy_e5cea219.png', category: 'Loader Wheel System', compatibleModels: ["XC9260/XC968"] },
      { id: 'xcmg-803140101', partNumber: '803140101', name: 'Loader Bucket', description: 'XCMG Loader Bucket (OEM: 803140101). Category: Loader Working Device. Applicable Models: XC9260/XC968. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/HUMEcesbyAE8_d9da0548.png', category: 'Loader Working Device', compatibleModels: ["XC9260/XC968"] },
      { id: 'xcmg-803140102', partNumber: '803140102', name: 'Bucket Tooth', description: 'XCMG Bucket Tooth (OEM: 803140102). Category: Loader Working Device. Applicable Models: XC9260/XC968. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/HUMEcesbyAE8_d9da0548.png', category: 'Loader Working Device', compatibleModels: ["XC9260/XC968"] },
      { id: 'xcmg-803140103', partNumber: '803140103', name: 'Boom Arm', description: 'XCMG Boom Arm (OEM: 803140103). Category: Loader Working Device. Applicable Models: XC9260/XC968. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/HUMEcesbyAE8_d9da0548.png', category: 'Loader Working Device', compatibleModels: ["XC9260/XC968"] },
      ...
      { id: 'xcmg-803140105', partNumber: '803140105', name: 'Steering Cylinder', description: 'XCMG Steering Cylinder (OEM: 803140105). Category: Loader Working Device. Applicable Models: XC9260/XC968. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/HUMEcesbyAE8_d9da0548.png', category: 'Loader Working Device', compatibleModels: ["XC9260/XC968"] },
      { id: 'xcmg-803140106', partNumber: '803140106', name: 'Cabin', description: 'XCMG Cabin (OEM: 803140106). Category: Loader Working Device. Applicable Models: XC9260/XC968. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/HUMEcesbyAE8_d9da0548.png', category: 'Loader Working Device', compatibleModels: ["XC9260/XC968"] },
      { id: 'xcmg-803150101', partNumber: '803150101', name: 'Loader Hydraulic Pump', description: 'XCMG Loader Hydraulic Pump (OEM: 803150101). Category: Loader Hydraulic System. Applicable Models: XC9260/XC968. High-quality genuine XCMG spare part with warranty.', image: '/manus-storage/Tut5cGqK9Ja8_a34e1d85.webp', category: 'Loader Hydraulic System', compatibleModels: ["XC9260/XC968"] },
  ...
  },
  {
    ...
    spareParts: [
      { id: 'lg-sp-1', partNumber: '40C0441', name: 'Engine Oil Filter', description: 'LiuGong OEM Part 40C0441. Category: Filtration System. Applicable Models: CLG906E CLG907E CLG908E. Engine: Yanmar 4TNV94L. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Filtration System', compatibleModels: ["CLG906E", "CLG907E", "CLG908E"] },
      { id: 'lg-sp-2', partNumber: '40C0440', name: 'Fuel Filter', description: 'LiuGong OEM Part 40C0440. Category: Filtration System. Applicable Models: CLG906E CLG907E CLG908E. Engine: Yanmar 4TNV94L. High-quality genuine spare part.', image: '/manus-storage/8xIz2IE825nH_16361bb9.png', category: 'Filtration System', compatibleModels: ["CLG906E", "CLG907E", "CLG908E"] },
      { id: 'lg-sp-3', partNumber: '53C0583', name: 'Fuel Water Separator', description: 'LiuGong OEM Part 53C0583. Category: Filtration System. Applicable Models: CLG906E CLG907E CLG908E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/RiYwoZdOYNtc_9ec44613.jpg', category: 'Filtration System', compatibleModels: ["CLG906E", "CLG907E", "CLG908E"] },
      { id: 'lg-sp-4', partNumber: '40C0506', name: 'Air Filter Element', description: 'LiuGong OEM Part 40C0506. Category: Filtration System. Applicable Models: CLG906E CLG907E CLG908E. Engine: Yanmar 4TNV94L. High-quality genuine spare part.', image: '/manus-storage/rgEppbmNDisC_015a13d9.png', category: 'Filtration System', compatibleModels: ["CLG906E", "CLG907E", "CLG908E"] },
      { id: 'lg-sp-5', partNumber: '40C5856', name: 'Air Filter Assembly', description: 'LiuGong OEM Part 40C5856. Category: Filtration System. Applicable Models: CLG855N CLG856H CLG862H. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/zin8YH0vRMUW_fa7e89e7.jpg', category: 'Filtration System', compatibleModels: ["CLG855N", "CLG856H", "CLG862H"] },
      { id: 'lg-sp-6', partNumber: '53C1037', name: 'Hydraulic Return Oil Filter', description: 'LiuGong OEM Part 53C1037. Category: Filtration System. Applicable Models: CPC20 CPC25 CPC30 CPC35. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Filtration System', compatibleModels: ["CPC20", "CPC25", "CPC30", "CPC35"] },
      { id: 'lg-sp-7', partNumber: 'SP101730', name: 'Engine Oil Filter', description: 'LiuGong OEM Part SP101730. Category: Filtration System. Applicable Models: CLG922E CLG925E CLG930E. Engine: Cummins 6LT9.3. High-quality genuine spare part.', image: '/manus-storage/8xIz2IE825nH_16361bb9.png', category: 'Filtration System', compatibleModels: ["CLG922E", "CLG925E", "CLG930E"] },
      { id: 'lg-sp-8', partNumber: 'SP101731', name: 'Fuel Filter Element', description: 'LiuGong OEM Part SP101731. Category: Filtration System. Applicable Models: CLG922E CLG925E CLG930E. Engine: Cummins 6LT9.3. High-quality genuine spare part.', image: '/manus-storage/RiYwoZdOYNtc_9ec44613.jpg', category: 'Filtration System', compatibleModels: ["CLG922E", "CLG925E", "CLG930E"] },
      { id: 'lg-sp-9', partNumber: 'SP101733', name: 'Air Filter Inner Outer', description: 'LiuGong OEM Part SP101733. Category: Filtration System. Applicable Models: CLG922E CLG925E CLG930E. Engine: Cummins 6LT9.3. High-quality genuine spare part.', image: '/manus-storage/rgEppbmNDisC_015a13d9.png', category: 'Filtration System', compatibleModels: ["CLG922E", "CLG925E", "CLG930E"] },
      { id: 'lg-sp-10', partNumber: '40C1032', name: 'Inner Air Filter', description: 'LiuGong OEM Part 40C1032. Category: Filtration System. Applicable Models: CLG933E CLG936E CLG938EHD. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/zin8YH0vRMUW_fa7e89e7.jpg', category: 'Filtration System', compatibleModels: ["CLG933E", "CLG936E", "CLG938EHD"] },
      { id: 'lg-sp-11', partNumber: '40C1033', name: 'Outer Air Filter', description: 'LiuGong OEM Part 40C1033. Category: Filtration System. Applicable Models: CLG933E CLG936E CLG938EHD. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Filtration System', compatibleModels: ["CLG933E", "CLG936E", "CLG938EHD"] },
      { id: 'lg-sp-12', partNumber: '40C0071', name: 'Fuel Filter', description: 'LiuGong OEM Part 40C0071. Category: Filtration System. Applicable Models: ZL30E ZL30C. Engine: Weichai WD615. High-quality genuine spare part.', image: '/manus-storage/8xIz2IE825nH_16361bb9.png', category: 'Filtration System', compatibleModels: ["ZL30E", "ZL30C"] },
      { id: 'lg-sp-13', partNumber: '3288812', name: 'Fan V Belt', description: 'LiuGong OEM Part 3288812. Category: Filtration System. Applicable Models: CLG856H CLG933E. Engine: Cummins 6BTA5.9. High-quality genuine spare part.', image: '/manus-storage/RiYwoZdOYNtc_9ec44613.jpg', category: 'Filtration System', compatibleModels: ["CLG856H", "CLG933E"] },
      { id: 'lg-sp-14', partNumber: '3289224', name: 'Multi Rib Belt', description: 'LiuGong OEM Part 3289224. Category: Filtration System. Applicable Models: CLG939EES CLG945E. Engine: Cummins L9.3. High-quality genuine spare part.', image: '/manus-storage/rgEppbmNDisC_015a13d9.png', category: 'Filtration System', compatibleModels: ["CLG939EES", "CLG945E"] },
      { id: 'lg-sp-15', partNumber: 'SP101732', name: 'Crankshaft Front Oil Seal', description: 'LiuGong OEM Part SP101732. Category: Seal & Gasket System. Applicable Models: CLG922E CLG933E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/zin8YH0vRMUW_fa7e89e7.jpg', category: 'Seal & Gasket System', compatibleModels: ["CLG922E", "CLG933E"] },
      { id: 'lg-sp-16', partNumber: '13B0288', name: 'Dust Wiper Seal', description: 'LiuGong OEM Part 13B0288. Category: Seal & Gasket System. Applicable Models: CLG906E CLG922E CLG933E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Seal & Gasket System', compatibleModels: ["CLG906E", "CLG922E", "CLG933E"] },
      { id: 'lg-sp-17', partNumber: '60218856', name: 'Hub Oil Seal', description: 'LiuGong OEM Part 60218856. Category: Seal & Gasket System. Applicable Models: CLG856H SW936K SW956H. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/8xIz2IE825nH_16361bb9.png', category: 'Seal & Gasket System', compatibleModels: ["CLG856H", "SW936K", "SW956H"] },
      { id: 'lg-sp-18', partNumber: 'B240101000011', name: 'Main Pump Seal Repair Kit', description: 'LiuGong OEM Part B240101000011. Category: Seal & Gasket System. Applicable Models: CLG922E CLG933E CLG936E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/RiYwoZdOYNtc_9ec44613.jpg', category: 'Seal & Gasket System', compatibleModels: ["CLG922E", "CLG933E", "CLG936E"] },
      { id: 'lg-sp-19', partNumber: '4110000556132', name: 'Rubber Sealing Ring', description: 'LiuGong OEM Part 4110000556132. Category: Seal & Gasket System. Applicable Models: CLG950 CLG970. Engine: Cummins QSG12. High-quality genuine spare part.', image: '/manus-storage/rgEppbmNDisC_015a13d9.png', category: 'Seal & Gasket System', compatibleModels: ["CLG950", "CLG970"] },
      { id: 'lg-sp-20', partNumber: 'D38-000-74+A', name: 'Water Pump Gasket', description: 'LiuGong OEM Part D38-000-74+A. Category: Seal & Gasket System. Applicable Models: XS142J XS162J. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/zin8YH0vRMUW_fa7e89e7.jpg', category: 'Seal & Gasket System', compatibleModels: ["XS142J", "XS162J"] },
      { id: 'lg-sp-21', partNumber: '129900-23001', name: 'Connecting Rod Gasket', description: 'LiuGong OEM Part 129900-23001. Category: Seal & Gasket System. Applicable Models: CLG906E. Engine: Yanmar 4TNV94L. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Seal & Gasket System', compatibleModels: ["CLG906E"] },
      { id: 'lg-sp-22', partNumber: '729906-22950', name: 'Piston Ring Set', description: 'LiuGong OEM Part 729906-22950. Category: Seal & Gasket System. Applicable Models: CLG906E. Engine: Yanmar 4TNV94L. High-quality genuine spare part.', image: '/manus-storage/8xIz2IE825nH_16361bb9.png', category: 'Seal & Gasket System', compatibleModels: ["CLG906E"] },
      { id: 'lg-sp-23', partNumber: 'SP138335', name: 'Injector Seal Kit', description: 'LiuGong OEM Part SP138335. Category: Seal & Gasket System. Applicable Models: CLG835H CLG922E. Engine: Cummins 6LT9.3. High-quality genuine spare part.', image: '/manus-storage/RiYwoZdOYNtc_9ec44613.jpg', category: 'Seal & Gasket System', compatibleModels: ["CLG835H", "CLG922E"] },
      { id: 'lg-sp-24', partNumber: 'B240101000012', name: 'Boom Cylinder Seal Kit', description: 'LiuGong OEM Part B240101000012. Category: Seal & Gasket System. Applicable Models: CLG922E CLG933E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/rgEppbmNDisC_015a13d9.png', category: 'Seal & Gasket System', compatibleModels: ["CLG922E", "CLG933E"] },
      { id: 'lg-sp-25', partNumber: 'B240101000013', name: 'Arm Cylinder Seal Kit', description: 'LiuGong OEM Part B240101000013. Category: Seal & Gasket System. Applicable Models: CLG922E CLG933E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/zin8YH0vRMUW_fa7e89e7.jpg', category: 'Seal & Gasket System', compatibleModels: ["CLG922E", "CLG933E"] },
      { id: 'lg-sp-26', partNumber: 'B240101000014', name: 'Bucket Cylinder Seal Kit', description: 'LiuGong OEM Part B240101000014. Category: Seal & Gasket System. Applicable Models: CLG922E CLG933E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Seal & Gasket System', compatibleModels: ["CLG922E", "CLG933E"] },
      { id: 'lg-sp-27', partNumber: '11D1121', name: 'Bucket Pin Shaft', description: 'LiuGong OEM Part 11D1121. Category: Working Device System. Applicable Models: CLG906E CLG907E CLG908E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/8xIz2IE825nH_16361bb9.png', category: 'Working Device System', compatibleModels: ["CLG906E", "CLG907E", "CLG908E"] },
      { id: 'lg-sp-28', partNumber: '55A2618', name: 'Bushing Sleeve', description: 'LiuGong OEM Part 55A2618. Category: Working Device System. Applicable Models: CLG906E CLG907E CLG908E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/RiYwoZdOYNtc_9ec44613.jpg', category: 'Working Device System', compatibleModels: ["CLG906E", "CLG907E", "CLG908E"] },
      { id: 'lg-sp-29', partNumber: '72A0151', name: 'Standard Bucket Tooth', description: 'LiuGong OEM Part 72A0151. Category: Working Device System. Applicable Models: CLG856H CLG922E CLG933E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/rgEppbmNDisC_015a13d9.png', category: 'Working Device System', compatibleModels: ["CLG856H", "CLG922E", "CLG933E"] },
      { id: 'lg-sp-30', partNumber: '14A0215', name: 'Tooth Lock Pin', description: 'LiuGong OEM Part 14A0215. Category: Working Device System. Applicable Models: CLG856H CLG922E CLG933E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/zin8YH0vRMUW_fa7e89e7.jpg', category: 'Working Device System', compatibleModels: ["CLG856H", "CLG922E", "CLG933E"] },
      { id: 'lg-sp-31', partNumber: '60165232', name: 'Heavy Duty Bucket Tooth', description: 'LiuGong OEM Part 60165232. Category: Working Device System. Applicable Models: CLG922E CLG933E CLG952F CLG965F. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Working Device System', compatibleModels: ["CLG922E", "CLG933E", "CLG952F", "CLG965F"] },
      { id: 'lg-sp-32', partNumber: '60165233', name: 'Tooth Adapter Holder', description: 'LiuGong OEM Part 60165233. Category: Working Device System. Applicable Models: CLG922E CLG933E CLG952F. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/8xIz2IE825nH_16361bb9.png', category: 'Working Device System', compatibleModels: ["CLG922E", "CLG933E", "CLG952F"] },
      { id: 'lg-sp-33', partNumber: 'B250101000041', name: 'Bucket Pin', description: 'LiuGong OEM Part B250101000041. Category: Working Device System. Applicable Models: CLG906E CLG922E CLG933E CLG936E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/RiYwoZdOYNtc_9ec44613.jpg', category: 'Working Device System', compatibleModels: ["CLG906E", "CLG922E", "CLG933E", "CLG936E"] },
      { id: 'lg-sp-34', partNumber: 'B250101000042', name: 'Boom Bushing', description: 'LiuGong OEM Part B250101000042. Category: Working Device System. Applicable Models: CLG906E CLG922E CLG933E CLG936E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/rgEppbmNDisC_015a13d9.png', category: 'Working Device System', compatibleModels: ["CLG906E", "CLG922E", "CLG933E", "CLG936E"] },
      { id: 'lg-sp-35', partNumber: '10C3793', name: 'Arm Pin Shaft', description: 'LiuGong OEM Part 10C3793. Category: Working Device System. Applicable Models: CLG922E CLG925E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/zin8YH0vRMUW_fa7e89e7.jpg', category: 'Working Device System', compatibleModels: ["CLG922E", "CLG925E"] },
      { id: 'lg-sp-36', partNumber: '10C3790', name: 'Arm Bushing', description: 'LiuGong OEM Part 10C3790. Category: Working Device System. Applicable Models: CLG922E CLG925E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Working Device System', compatibleModels: ["CLG922E", "CLG925E"] },
      { id: 'lg-sp-37', partNumber: '10C3698', name: 'Boom Pin Shaft', description: 'LiuGong OEM Part 10C3698. Category: Working Device System. Applicable Models: CLG933E CLG936E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/8xIz2IE825nH_16361bb9.png', category: 'Working Device System', compatibleModels: ["CLG933E", "CLG936E"] },
      { id: 'lg-sp-38', partNumber: '10C3697', name: 'Boom Bushing', description: 'LiuGong OEM Part 10C3697. Category: Working Device System. Applicable Models: CLG933E CLG936E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/RiYwoZdOYNtc_9ec44613.jpg', category: 'Working Device System', compatibleModels: ["CLG933E", "CLG936E"] },
      { id: 'lg-sp-39', partNumber: '11119724', name: 'Track Chain Assembly', description: 'LiuGong OEM Part 11119724. Category: Undercarriage System. Applicable Models: CLG922E CLG933E CLG936E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/rgEppbmNDisC_015a13d9.png', category: 'Undercarriage System', compatibleModels: ["CLG922E", "CLG933E", "CLG936E"] },
      { id: 'lg-sp-40', partNumber: '13021205', name: 'Drive Sprocket', description: 'LiuGong OEM Part 13021205. Category: Undercarriage System. Applicable Models: CLG922E CLG933E CLG936E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/zin8YH0vRMUW_fa7e89e7.jpg', category: 'Undercarriage System', compatibleModels: ["CLG922E", "CLG933E", "CLG936E"] },
      { id: 'lg-sp-41', partNumber: 'B230102000021', name: 'Front Idler Wheel', description: 'LiuGong OEM Part B230102000021. Category: Undercarriage System. Applicable Models: CLG906E CLG922E CLG933E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Undercarriage System', compatibleModels: ["CLG906E", "CLG922E", "CLG933E"] },
      { id: 'lg-sp-42', partNumber: 'B230103000022', name: 'Lower Track Roller', description: 'LiuGong OEM Part B230103000022. Category: Undercarriage System. Applicable Models: CLG922E CLG933E CLG936E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/8xIz2IE825nH_16361bb9.png', category: 'Undercarriage System', compatibleModels: ["CLG922E", "CLG933E", "CLG936E"] },
      { id: 'lg-sp-43', partNumber: 'B230104000023', name: 'Upper Carrier Roller', description: 'LiuGong OEM Part B230104000023. Category: Undercarriage System. Applicable Models: CLG922E CLG933E CLG936E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/RiYwoZdOYNtc_9ec44613.jpg', category: 'Undercarriage System', compatibleModels: ["CLG922E", "CLG933E", "CLG936E"] },
      { id: 'lg-sp-44', partNumber: 'B230201000031', name: 'Track Adjuster Cylinder', description: 'LiuGong OEM Part B230201000031. Category: Undercarriage System. Applicable Models: CLG922E CLG933E CLG936E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/rgEppbmNDisC_015a13d9.png', category: 'Undercarriage System', compatibleModels: ["CLG922E", "CLG933E", "CLG936E"] },
      { id: 'lg-sp-45', partNumber: 'B230105000024', name: 'Track Shoe Plate', description: 'LiuGong OEM Part B230105000024. Category: Undercarriage System. Applicable Models: CLG906E CLG922E CLG933E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/zin8YH0vRMUW_fa7e89e7.jpg', category: 'Undercarriage System', compatibleModels: ["CLG906E", "CLG922E", "CLG933E"] },
      { id: 'lg-sp-46', partNumber: '13021206', name: 'Sprocket Segment', description: 'LiuGong OEM Part 13021206. Category: Undercarriage System. Applicable Models: CLG939EES CLG945E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Undercarriage System', compatibleModels: ["CLG939EES", "CLG945E"] },
      { id: 'lg-sp-47', partNumber: 'B230102000025', name: 'Idler Oil Seal', description: 'LiuGong OEM Part B230102000025. Category: Undercarriage System. Applicable Models: CLG922E CLG933E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/8xIz2IE825nH_16361bb9.png', category: 'Undercarriage System', compatibleModels: ["CLG922E", "CLG933E"] },
      { id: 'lg-sp-48', partNumber: '249490002', name: 'High Pressure Hydraulic Hose', description: 'LiuGong OEM Part 249490002. Category: Hydraulic System. Applicable Models: All Liugong Excavator. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/RiYwoZdOYNtc_9ec44613.jpg', category: 'Hydraulic System', compatibleModels: ["All", "Liugong", "Excavator"] },
      { id: 'lg-sp-49', partNumber: 'SP105060', name: 'Fuel Pump Solenoid Valve', description: 'LiuGong OEM Part SP105060. Category: Hydraulic System. Applicable Models: CLG835H CLG856H. Engine: Cummins 6LT9.3. High-quality genuine spare part.', image: '/manus-storage/rgEppbmNDisC_015a13d9.png', category: 'Hydraulic System', compatibleModels: ["CLG835H", "CLG856H"] },
      { id: 'lg-sp-50', partNumber: '5346207', name: 'Hydraulic Solenoid Valve', description: 'LiuGong OEM Part 5346207. Category: Hydraulic System. Applicable Models: CLG855N CLG856H. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/zin8YH0vRMUW_fa7e89e7.jpg', category: 'Hydraulic System', compatibleModels: ["CLG855N", "CLG856H"] },
      { id: 'lg-sp-51', partNumber: '31C0118', name: 'Pipe Elbow Joint', description: 'LiuGong OEM Part 31C0118. Category: Hydraulic System. Applicable Models: All Liugong Models. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Hydraulic System', compatibleModels: ["All", "Liugong", "Models"] },
      { id: 'lg-sp-52', partNumber: '44C0027', name: 'Steering Control Valve', description: 'LiuGong OEM Part 44C0027. Category: Hydraulic System. Applicable Models: CLG856H CLG862H. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/8xIz2IE825nH_16361bb9.png', category: 'Hydraulic System', compatibleModels: ["CLG856H", "CLG862H"] },
      { id: 'lg-sp-53', partNumber: 'SP138336', name: 'Fuel Injection Pump', description: 'LiuGong OEM Part SP138336. Category: Engine System. Applicable Models: CLG835H CLG922E. Engine: Cummins 6LT9.3. High-quality genuine spare part.', image: '/manus-storage/RiYwoZdOYNtc_9ec44613.jpg', category: 'Engine System', compatibleModels: ["CLG835H", "CLG922E"] },
      { id: 'lg-sp-54', partNumber: 'SP138330', name: 'Fuel Injector Nozzle', description: 'LiuGong OEM Part SP138330. Category: Engine System. Applicable Models: CLG835H CLG922E. Engine: Cummins 6LT9.3. High-quality genuine spare part.', image: '/manus-storage/rgEppbmNDisC_015a13d9.png', category: 'Engine System', compatibleModels: ["CLG835H", "CLG922E"] },
      { id: 'lg-sp-55', partNumber: '3530521', name: 'Turbocharger Assembly', description: 'LiuGong OEM Part 3530521. Category: Engine System. Applicable Models: CLG856H CLG933E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/zin8YH0vRMUW_fa7e89e7.jpg', category: 'Engine System', compatibleModels: ["CLG856H", "CLG933E"] },
      { id: 'lg-sp-56', partNumber: '61560113227', name: 'Generator Fan Belt', description: 'LiuGong OEM Part 61560113227. Category: Engine System. Applicable Models: ZL50G. Engine: Weichai WD615. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Engine System', compatibleModels: ["ZL50G"] },
      { id: 'lg-sp-57', partNumber: 'D38-000-74', name: 'Cooling Water Pump', description: 'LiuGong OEM Part D38-000-74. Category: Engine System. Applicable Models: XS142S CLG856H. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/8xIz2IE825nH_16361bb9.png', category: 'Engine System', compatibleModels: ["XS142S", "CLG856H"] },
      { id: 'lg-sp-58', partNumber: '3793021', name: 'Turbocharger', description: 'LiuGong OEM Part 3793021. Category: Engine System. Applicable Models: CLG939EES. Engine: Cummins L9.3. High-quality genuine spare part.', image: '/manus-storage/RiYwoZdOYNtc_9ec44613.jpg', category: 'Engine System', compatibleModels: ["CLG939EES"] },
      { id: 'lg-sp-59', partNumber: '3590044', name: 'Turbocharger', description: 'LiuGong OEM Part 3590044. Category: Engine System. Applicable Models: CLG856H. Engine: Cummins M11. High-quality genuine spare part.', image: '/manus-storage/rgEppbmNDisC_015a13d9.png', category: 'Engine System', compatibleModels: ["CLG856H"] },
      { id: 'lg-sp-60', partNumber: '3966430', name: 'Camshaft Shaft', description: 'LiuGong OEM Part 3966430. Category: Engine System. Applicable Models: CLG816H. Engine: Cummins B3.3. High-quality genuine spare part.', image: '/manus-storage/zin8YH0vRMUW_fa7e89e7.jpg', category: 'Engine System', compatibleModels: ["CLG816H"] },
      { id: 'lg-sp-61', partNumber: '129907-44740', name: 'Cooling Fan Blade', description: 'LiuGong OEM Part 129907-44740. Category: Engine System. Applicable Models: CLG906E. Engine: Yanmar 4TNV94L. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Engine System', compatibleModels: ["CLG906E"] },
      { id: 'lg-sp-62', partNumber: '40C1048', name: 'Engine Drive Belt', description: 'LiuGong OEM Part 40C1048. Category: Engine System. Applicable Models: CLG906E. Engine: Yanmar 4TNV94L. High-quality genuine spare part.', image: '/manus-storage/8xIz2IE825nH_16361bb9.png', category: 'Engine System', compatibleModels: ["CLG906E"] },
      { id: 'lg-sp-63', partNumber: '60218855', name: 'Brake Pad Shoe', description: 'LiuGong OEM Part 60218855. Category: Loader & Road Machinery System. Applicable Models: CLG856H SW936K SW956H. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/RiYwoZdOYNtc_9ec44613.jpg', category: 'Loader & Road Machinery System', compatibleModels: ["CLG856H", "SW936K", "SW956H"] },
      { id: 'lg-sp-64', partNumber: 'B260101000051', name: 'Transmission Filter', description: 'LiuGong OEM Part B260101000051. Category: Loader & Road Machinery System. Applicable Models: CLG856H SW956H SW960E. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/rgEppbmNDisC_015a13d9.png', category: 'Loader & Road Machinery System', compatibleModels: ["CLG856H", "SW956H", "SW960E"] },
      { id: 'lg-sp-65', partNumber: 'SP157484', name: 'Fan Belt', description: 'LiuGong OEM Part SP157484. Category: Loader & Road Machinery System. Applicable Models: CLG856H. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/zin8YH0vRMUW_fa7e89e7.jpg', category: 'Loader & Road Machinery System', compatibleModels: ["CLG856H"] },
      { id: 'lg-sp-66', partNumber: 'SP187404', name: 'Hydraulic Rubber Hose', description: 'LiuGong OEM Part SP187404. Category: Loader & Road Machinery System. Applicable Models: CLG856H. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Loader & Road Machinery System', compatibleModels: ["CLG856H"] },
      { id: 'lg-sp-67', partNumber: 'SP130554', name: 'Air Filter', description: 'LiuGong OEM Part SP130554. Category: Loader & Road Machinery System. Applicable Models: CLG4215D. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/8xIz2IE825nH_16361bb9.png', category: 'Loader & Road Machinery System', compatibleModels: ["CLG4215D"] },
      { id: 'lg-sp-68', partNumber: '4215D-001', name: 'Grader Blade Pin', description: 'LiuGong OEM Part 4215D-001. Category: Loader & Road Machinery System. Applicable Models: CLG4215D. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/RiYwoZdOYNtc_9ec44613.jpg', category: 'Loader & Road Machinery System', compatibleModels: ["CLG4215D"] },
      { id: 'lg-sp-69', partNumber: '6608F-002', name: 'Compactor Drum Bearing', description: 'LiuGong OEM Part 6608F-002. Category: Loader & Road Machinery System. Applicable Models: XS6608F. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/rgEppbmNDisC_015a13d9.png', category: 'Loader & Road Machinery System', compatibleModels: ["XS6608F"] },
      { id: 'lg-sp-70', partNumber: 'CPC20-001', name: 'Lift Cylinder Seal Kit', description: 'LiuGong OEM Part CPC20-001. Category: Forklift System. Applicable Models: CPC20 CPC25. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/zin8YH0vRMUW_fa7e89e7.jpg', category: 'Forklift System', compatibleModels: ["CPC20", "CPC25"] },
      { id: 'lg-sp-71', partNumber: 'CPC30-002', name: 'Steering Cylinder Seal Kit', description: 'LiuGong OEM Part CPC30-002. Category: Forklift System. Applicable Models: CPC30 CPC35. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Forklift System', compatibleModels: ["CPC30", "CPC35"] },
      { id: 'lg-sp-72', partNumber: '490BPG-003', name: 'Engine Oil Filter', description: 'LiuGong OEM Part 490BPG-003. Category: Forklift System. Applicable Models: CPC20 CPC25. Engine: Xinchai 490BPG. High-quality genuine spare part.', image: '/manus-storage/8xIz2IE825nH_16361bb9.png', category: 'Forklift System', compatibleModels: ["CPC20", "CPC25"] },
      { id: 'lg-sp-73', partNumber: 'C240PKJ-004', name: 'Fuel Filter Element', description: 'LiuGong OEM Part C240PKJ-004. Category: Forklift System. Applicable Models: CPCD20 CPCD25. Engine: Isuzu C240PKJ. High-quality genuine spare part.', image: '/manus-storage/RiYwoZdOYNtc_9ec44613.jpg', category: 'Forklift System', compatibleModels: ["CPCD20", "CPCD25"] },
      { id: 'lg-sp-74', partNumber: '777A-001', name: 'Backhoe Bucket Tooth', description: 'LiuGong OEM Part 777A-001. Category: Backhoe Loader System. Applicable Models: Liugong 777A 764A. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/rgEppbmNDisC_015a13d9.png', category: 'Backhoe Loader System', compatibleModels: ["Liugong", "777A", "764A"] },
      { id: 'lg-sp-75', partNumber: '777A-002', name: 'Loader Bucket Pin', description: 'LiuGong OEM Part 777A-002. Category: Backhoe Loader System. Applicable Models: Liugong 777A 764A. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/zin8YH0vRMUW_fa7e89e7.jpg', category: 'Backhoe Loader System', compatibleModels: ["Liugong", "777A", "764A"] },
      { id: 'lg-sp-76', partNumber: '764A-003', name: 'Track Roller', description: 'LiuGong OEM Part 764A-003. Category: Backhoe Loader System. Applicable Models: Liugong 764A. Engine: N/A. High-quality genuine spare part.', image: '/manus-storage/2bhfKuw2wEtg_a2ac2d21.jpg', category: 'Backhoe Loader System', compatibleModels: ["Liugong", "764A"] }
    ]
  },
  {
    id: 'sany',
  ...
  // ========== TRUCKS & ENGINES ==========
  {
    ...
    spareParts: [
      { id: 'iz-sp-1', partNumber: '8-97602-428-0', name: '机油滤清器 (Oil Filter)', description: 'Isuzu 原厂机油滤清器，高效过滤发动机机油中的杂质和金属颗粒，保护发动机。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：纸质滤芯，流量 60L/min，工作温度 -40~120℃。', image: '/manus-storage/yxC5ZD3L2zUE_d8fb95cb.jpg', category: 'Lubrication System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-2', partNumber: '8-97602-429-0', name: '燃油滤清器 (Fuel Filter)', description: 'Isuzu 原厂燃油滤清器，精密过滤燃油中的杂质和水分，提高喷油精度。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：纸质滤芯，过滤精度 10μm，工作压力 0.3-0.5bar。', image: '/manus-storage/byx0Bv8p9czO_81205870.jpg', category: 'Fuel System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-3', partNumber: '8-97602-430-0', name: '空气滤清器 (Air Filter)', description: 'Isuzu 高效空气滤清器，有效过滤进气中的灰尘和颗粒，保证发动机进气清洁。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：纸质滤芯，过滤精度 5μm，流量 200m³/h。', image: '/manus-storage/enLwuJeEPvn0_3de8ef60.jpg', category: 'Engine System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-4', partNumber: '8-97602-431-0', name: '活塞环套件 (Piston Ring Set)', description: 'Isuzu 原厂活塞环，精密加工，耐高温耐磨损，密封活塞和气缸，防止气体泄漏。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：铸铁，厚度 1.5-2mm，工作温度 300℃。', image: '/manus-storage/AdtHTxe5citR_4143c7b5.jpg', category: 'Engine System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-5', partNumber: '8-97602-432-0', name: '气门室盖垫 (Valve Cover Gasket)', description: 'Isuzu 气门室盖密封垫片，防止机油泄漏，保护气门机构。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：硅橡胶垫片，厚度 2mm，耐油温度 200℃。', image: '/manus-storage/lvWKFs8LJMSi_4425bf62.jpg', category: 'Engine System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-6', partNumber: '8-97602-433-0', name: '缸盖垫 (Cylinder Head Gasket)', description: 'Isuzu 缸盖密封垫片，密封气缸和缸盖，防止冷却液和机油泄漏。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：金属石棉垫片，厚度 1mm，工作压力 15bar。', image: '/manus-storage/n4y9t1gRbigZ_a2e143c0.png', category: 'Engine System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-7', partNumber: '8-97602-434-0', name: '水泵总成 (Water Pump Assembly)', description: 'Isuzu 冷却水泵总成，高效循环冷却液，采用铝制泵体，保持发动机工作温度。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：铝制泵体，流量 80L/min，工作温度 -40~120℃。', image: '/manus-storage/fH4PectUpFgw_3a4d53be.jpg', category: 'Cooling System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-8', partNumber: '8-97602-435-0', name: '节温器 (Thermostat)', description: 'Isuzu 冷却系统节温器，精确控制冷却液温度，提高发动机效率，降低油耗。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：黄铜阀芯，开启温度 82℃，工作压力 0.5bar。', image: '/manus-storage/le4Hw3O4MlmA_a72ae1b7.jpg', category: 'Cooling System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-9', partNumber: '8-97602-436-0', name: '喷油器 (Fuel Injector)', description: 'Isuzu 燃油喷油器，精密喷射，雾化效果好，提高燃油利用率和发动机性能。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：电磁式喷油器，喷油压力 200bar，喷油量 50mm³/s。', image: '/manus-storage/y9pbq4jGWWSx_858eaa9d.jpg', category: 'Fuel System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-10', partNumber: '8-97602-437-0', name: '高压燃油泵 (High Pressure Fuel Pump)', description: 'Isuzu 高压燃油泵，提供稳定的高压燃油，确保燃油喷射精度。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：齿轮泵，工作压力 200bar，流量 60L/min。', image: '/manus-storage/epH20GlTE0gF_9042edee.jpg', category: 'Fuel System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-11', partNumber: '8-97602-438-0', name: '前油封 (Front Oil Seal)', description: 'Isuzu 曲轴前端油封，防止机油从曲轴前端泄漏，保护发动机。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：氟橡胶油封，内径 40mm，工作温度 -40~150℃。', image: '/manus-storage/WsTPyoaAVFJT_5daab65d.jpg', category: 'Engine System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-12', partNumber: '8-97602-439-0', name: '后油封 (Rear Oil Seal)', description: 'Isuzu 曲轴后端油封，防止机油从曲轴后端泄漏，确保发动机密封。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：氟橡胶油封，内径 50mm，工作温度 -40~150℃。', image: '/manus-storage/kw1xBifZnetT_911f8b80.jpg', category: 'Engine System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-13', partNumber: '8-97602-440-0', name: '气门盖 (Valve Cover)', description: 'Isuzu 发动机气门盖，保护气门机构，防止杂质进入。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：铝制，厚度 3mm，重量 2kg。', image: '/manus-storage/I6YM8o739jNJ_cf97a341.jpg', category: 'Engine System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-14', partNumber: '8-97602-441-0', name: '机油泵 (Oil Pump)', description: 'Isuzu 发动机机油泵，循环供油，采用齿轮泵设计，确保润滑系统正常工作。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：齿轮泵，流量 70L/min，工作压力 5bar。', image: '/manus-storage/6lZq5V7GhAch_4ced24fd.jpg', category: 'Lubrication System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-15', partNumber: '8-97602-442-0', name: '冷却液管 (Coolant Hose)', description: 'Isuzu 冷却液输送管，连接水泵和散热器，耐高温耐压，确保冷却液循环畅通。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：橡胶软管，内径 20mm，工作温度 -40~120℃。', image: '/manus-storage/l04iiQ8VXpuV_31dece8f.jpg', category: 'Cooling System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-16', partNumber: '8-97602-443-0', name: '高压油管 (High Pressure Fuel Pipe)', description: 'Isuzu 喷油器高压油管，连接燃油泵和喷油器，耐高压防泄漏。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：高压钢管，工作压力 250bar，内径 3mm。', image: '/manus-storage/mTRIIbz5npZ7_ac87be38.jpg', category: 'Fuel System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-17', partNumber: '8-97602-444-0', name: '交流发电机 (Alternator)', description: 'Isuzu 发动机交流发电机，为电气系统供电，保证车辆正常运行。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：输出功率 100A，输出电压 14V，工作温度 -40~120℃。', image: '/manus-storage/g6y8Nuhx4tVz_07246d51.jpg', category: 'Electrical System', compatibleModels: ["\u4e94\u5341\u94c3", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-18', partNumber: '8-97602-445-0', name: '皮带张紧轮 (Belt Tensioner)', description: 'Isuzu 发动机皮带张紧轮，自动调节皮带张力，确保皮带正常运转。易损件，建议每 10 万公里检查。兼容车型：五十铃 NPR、NQR、NRR 等。规格：铸铁轮体，直径 70mm，工作温度 -40~120℃。', image: '/manus-storage/belt_tensioner_isuzu.jpg', category: 'Engine System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-19', partNumber: '8-97602-446-0', name: '发动机皮带 (Serpentine Belt)', description: 'Isuzu 多槽皮带，驱动发电机、水泵、空压机等辅助装置。高复购率易损件，建议每 10 万公里更换。兼容车型：五十铃 NPR、NQR、NRR 等。规格：长度 2500mm，宽度 25mm，厚度 8mm。', image: '/manus-storage/serpentine_belt_isuzu.jpg', category: 'Engine System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-20', partNumber: '8-97602-447-0', name: '刹车片套件 (Brake Pad Set)', description: 'Isuzu 原厂刹车片，陶瓷材质，高摩擦系数，制动效果好。高复购率易损件，建议每 5-8 万公里更换。兼容车型：五十铃 NPR、NQR、NRR 等。规格：陶瓷刹车片，厚度 12mm，工作温度 -40~300℃。', image: '/manus-storage/brake_pad_isuzu.jpg', category: 'Brake System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-21', partNumber: '8-97602-448-0', name: '刹车盘 (Brake Disc)', description: 'Isuzu 前轮刹车盘，铸铁材质，散热性能好，与刹车片配套使用。易损件，建议每 10 万公里检查更换。兼容车型：五十铃 NPR、NQR、NRR 等。规格：直径 330mm，厚度 28mm，工作温度 -40~300℃。', image: '/manus-storage/brake_disc_isuzu.jpg', category: 'Brake System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-22', partNumber: '8-97602-449-0', name: '制动液 (Brake Fluid)', description: 'Isuzu DOT 4 制动液，高沸点配方，防腐蚀，确保制动系统可靠性。消耗品，建议每 2 年更换一次。兼容车型：五十铃 NPR、NQR、NRR 等。规格：1L 瓶装，工作温度 -40~120℃，沸点 230℃。', image: '/manus-storage/brake_fluid_isuzu.jpg', category: 'Brake System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-23', partNumber: '8-97602-450-0', name: '启动马达 (Starter Motor)', description: 'Isuzu 发动机启动马达，高扭矩设计，启动可靠。高故障率件，故障时需立即更换。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：输出功率 4.5kW，输出扭矩 150Nm，工作温度 -40~80℃。', image: '/manus-storage/starter_motor_isuzu.jpg', category: 'Electrical System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-24', partNumber: '8-97602-451-0', name: '蓄电池 (Battery)', description: 'Isuzu 12V 蓄电池，大容量设计，冷启动能力强。消耗品，建议每 3-4 年更换一次。兼容车型：五十铃 NPR、NQR、NRR 等。规格：12V 200Ah，冷启动电流 1500A，工作温度 -40~60℃。', image: '/manus-storage/battery_isuzu.jpg', category: 'Electrical System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-25', partNumber: '8-97602-452-0', name: '散热器 (Radiator)', description: 'Isuzu 冷却系统散热器，铝制芯体，散热效率高。易损件，长期使用易堵塞，建议定期清洗或更换。兼容车型：五十铃 NPR、NQR、NRR 等。规格：铝制，尺寸 600×400×50mm，工作压力 1.5bar。', image: '/manus-storage/radiator_isuzu.jpg', category: 'Cooling System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-26', partNumber: '8-97602-453-0', name: '冷却风扇 (Cooling Fan)', description: 'Isuzu 电动冷却风扇，自动温度控制，降低油耗。高故障率件，电机易烧坏，建议定期检查。兼容车型：五十铃 NPR、NQR、NRR 等。规格：电动马达 2.2kW，风扇直径 600mm，工作温度 -40~120℃。', image: '/manus-storage/cooling_fan_isuzu.jpg', category: 'Cooling System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-27', partNumber: '8-97602-454-0', name: '轮胎 (Tire)', description: 'Isuzu 商用轮胎，耐磨性强，载重能力大。高复购率易损件，建议每 8-10 万公里更换。兼容车型：五十铃 NPR、NQR、NRR 等。规格：尺寸 7.50R16，花纹深度 15mm，工作温度 -40~70℃。', image: '/manus-storage/tire_isuzu.jpg', category: 'Tire System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-28', partNumber: '8-97602-455-0', name: '轮毂轴承 (Wheel Hub Bearing)', description: 'Isuzu 轮毂轴承，精密加工，耐磨损。易损件，长期运行易发热，建议定期检查润滑。兼容车型：五十铃 NPR、NQR、NRR 等。规格：双列圆锥滚子轴承，内径 50mm，工作温度 -40~120℃。', image: '/manus-storage/wheel_bearing_isuzu.jpg', category: 'Suspension System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-29', partNumber: '8-97602-456-0', name: '减震器 (Shock Absorber)', description: 'Isuzu 液压减震器，缓冲性能好，乘坐舒适。易损件，建议每 8 万公里检查更换。兼容车型：五十铃 NPR、NQR、NRR 等。规格：液压式，行程 200mm，工作压力 20bar，工作温度 -40~100℃。', image: '/manus-storage/shock_absorber_isuzu.jpg', category: 'Suspension System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-30', partNumber: '8-97602-457-0', name: '离合器片 (Clutch Disc)', description: 'Isuzu 离合器摩擦片，高摩擦系数，传动效率高。易损件，建议每 10 万公里检查更换。兼容车型：五十铃 NPR、NQR、NRR 等。规格：直径 330mm，厚度 8mm，工作温度 -40~200℃。', image: '/manus-storage/clutch_disc_isuzu.jpg', category: 'Transmission System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-31', partNumber: '8-97602-458-0', name: '变速箱油 (Transmission Fluid)', description: 'Isuzu 手动变速箱专用油，粘度合适，防磨损。消耗品，建议每 5 万公里更换一次。兼容车型：五十铃 NPR、NQR、NRR 等。规格：SAE 80W-90，4L 瓶装，工作温度 -40~100℃。', image: '/manus-storage/transmission_fluid_isuzu.jpg', category: 'Transmission System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-32', partNumber: '8-97602-459-0', name: '方向盘转向泵 (Power Steering Pump)', description: 'Isuzu 液压转向泵，转向轻便，操控性好。高故障率件，泵体易磨损，建议定期检查。兼容车型：五十铃 NPR、NQR、NRR 等。规格：齿轮泵，流量 40L/min，工作压力 150bar，工作温度 -40~100℃。', image: '/manus-storage/steering_pump_isuzu.jpg', category: 'Steering System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
      { id: 'iz-sp-33', partNumber: '8-97602-460-0', name: '转向液 (Power Steering Fluid)', description: 'Isuzu 转向系统专用液，防腐蚀，防泡沫。消耗品，建议每 2 年更换一次。兼容车型：五十铃 NPR、NQR、NRR 等。规格：合成油，2L 瓶装，工作温度 -40~100℃，粘度 32cSt。', image: '/manus-storage/steering_fluid_isuzu.jpg', category: 'Steering System', compatibleModels: ["五十铃", "NPR", "NQR", "NRR"] },
    ]
  },
  {
    id: 'shacman',
    ...
    spareParts: [
      { id: 'sm-sp-1', partNumber: 'DZ96189584001', name: '机油滤清器 (Engine Oil Filter)', description: '陕汽原厂机油滤清器，高效过滤发动机机油中的杂质和金属颗粒，保护发动机。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。发动机型号：潍柴 WD615、WD10、WD12 或康明斯 Cummins。规格：纸质滤芯，流量 80L/min，工作温度 -40~120℃。', image: '/manus-storage/e1SPKaMyXaFf_aadcedec.webp', category: 'Lubrication System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-2', partNumber: 'DZ96189584002', name: '燃油滤清器 (Fuel Filter)', description: '陕汽原厂燃油滤清器，精密过滤燃油中的杂质和水分，提高喷油精度。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。发动机型号：潍柴或康明斯。规格：纸质滤芯，过滤精度 10μm，工作压力 0.3-0.5bar。', image: '/manus-storage/eoA6y2Zpvbnr_66a73ae1.webp', category: 'Fuel System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-3', partNumber: 'DZ96189584003', name: '空气滤清器 (Air Filter)', description: '陕汽高效空气滤清器，有效过滤进气中的灰尘和颗粒，保证发动机进气清洁。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。发动机型号：潍柴或康明斯。规格：纸质滤芯，过滤精度 5μm，流量 250m³/h。', image: '/manus-storage/5HS49kYwkL3T_7c6d3cb5.jpg', category: 'Engine System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-4', partNumber: 'DZ96189584004', name: '活塞环套件 (Piston Ring Set)', description: '陕汽原厂活塞环，精密加工，耐高温耐磨损，密封活塞和气缸，防止气体泄漏。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。发动机型号：潍柴或康明斯。规格：铸铁，厚度 1.5-2mm，工作温度 300℃。', image: '/manus-storage/Py7BOJxipE3Q_b819d746.jpg', category: 'Engine System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-5', partNumber: 'DZ96189584005', name: '油封组件 (Oil Seal Set)', description: '陕汽发动机油封组件，防止机油泄漏，保护发动机密封。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。发动机型号：潍柴或康明斯。规格：氟橡胶油封，工作温度 -40~150℃。', image: '/manus-storage/ehiFwnwf5Plz_a367baae.jpg', category: 'Engine System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-6', partNumber: 'DZ96189584006', name: '水泵总成 (Water Pump Assembly)', description: '陕汽冷却水泵总成，高效循环冷却液，采用铝制泵体，保持发动机工作温度。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。发动机型号：潍柴或康明斯。规格：铝制泵体，流量 100L/min，工作温度 -40~120℃。', image: '/manus-storage/gK1ib54AVxRC_8bf1988d.jpg', category: 'Cooling System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-7', partNumber: 'DZ96189584007', name: '节温器 (Thermostat)', description: '陕汽冷却系统节温器，精确控制冷却液温度，提高发动机效率，降低油耗。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。发动机型号：潍柴或康明斯。规格：黄铜阀芯，开启温度 82℃，工作压力 0.5bar。', image: '/manus-storage/lo6JlAgkaXRI_a13ef9ba.jpg', category: 'Cooling System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-8', partNumber: 'DZ96189584008', name: '制动垫片 (Brake Pad Set)', description: '陕汽原厂制动垫片，高摩擦系数，耐高温耐磨损，确保制动安全。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：半金属垫片，厚度 12-15mm，工作温度 -40~350℃。', image: '/manus-storage/H9y4FpXxw85c_e8344166.png', category: 'Brake System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-9', partNumber: 'DZ96189584009', name: '离合器片 (Clutch Plate)', description: '陕汽原厂离合器片，高摩擦系数，耐高温，确保传动平稳。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：铜基烧结，厚度 4.5mm，工作温度 -40~300℃。', image: '/manus-storage/eTlFABJlgUIk_46ac34c8.png', category: 'Transmission System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-10', partNumber: 'DZ96189584010', name: '变速箱支架 (Gearbox Support)', description: '陕汽变速箱支架，承载变速箱重量，减震降噪。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：铸铁支架，重量 8kg，工作温度 -40~80℃。', image: '/manus-storage/kAzjE4mH041q_1cc2e18b.png', category: 'Transmission System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-11', partNumber: 'DZ96189584011', name: '后悬架 (Rear Suspension)', description: '陕汽后悬架总成，采用钢板弹簧设计，提供稳定的悬挂效果。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：钢板弹簧，承载能力 15吨，工作温度 -40~80℃。', image: '/manus-storage/sIH1eg74EIHg_7a3bffdd.png', category: 'Suspension System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-12', partNumber: 'DZ96189584012', name: '悬架弹簧 (Leaf Spring)', description: '陕汽悬架钢板弹簧，承载重量，缓冲颠簸。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：锰钢弹簧，厚度 8mm，承载能力 10吨。', image: '/manus-storage/Vqa5xEv6OQPa_5a4e6006.jpg', category: 'Suspension System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-13', partNumber: 'DZ96189584013', name: '交流发电机 (Alternator)', description: '陕汽原厂交流发电机，为电气系统供电，保证车辆正常运行。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：输出功率 120A，输出电压 14V，工作温度 -40~120℃。', image: '/manus-storage/rha4WtBc2lpV_52d7f2e8.jpg', category: 'Electrical System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-14', partNumber: 'DZ96189584014', name: '启动马达 (Starter Motor)', description: '陕汽启动马达，快速启动发动机。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：功率 5.5kW，转速 11000rpm，工作温度 -40~120℃。', image: '/manus-storage/xHLvVTuk4XqP_1f965fe1.jpg', category: 'Electrical System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-15', partNumber: 'DZ96189584015', name: '电池 (Battery)', description: '陕汽原厂蓄电池，提供启动电流，稳定供电。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：12V 200Ah，冷启动电流 1500A，工作温度 -40~65℃。', image: '/manus-storage/yX87GzCvbe04_c21db199.jpg', category: 'Electrical System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-16', partNumber: 'DZ96189584016', name: '液压制动系统 (Hydraulic Brake System)', description: '陕汽液压制动系统，提供强大制动力，确保安全。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：工作压力 280bar，制动力 50吨，响应时间 0.1s。', image: '/manus-storage/58dRus5sseim_e2517033.jpg', category: 'Brake System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-17', partNumber: 'DZ96189584017', name: '变速箱滤清器 (Transmission Filter)', description: '陕汽变速箱滤清器，过滤变速箱油中的杂质，保护变速箱。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：纸质滤芯，过滤精度 10μm，流量 50L/min。', image: '/manus-storage/l6Db14lg7gq8_e3b87d09.png', category: 'Transmission System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-18', partNumber: 'DZ96189584018', name: '减震器 (Shock Absorber)', description: '陕汽减震器，吸收路面冲击，提高乘坐舒适度。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：双筒式，行程 200mm，工作压力 15bar。', image: '/manus-storage/7NGBLv06H284_2a195f08.jpg', category: 'Suspension System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-19', partNumber: 'DZ96189584019', name: '离合器压盘 (Clutch Cover)', description: '陕汽离合器压盘，与离合器片配合，实现动力传递。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：铸铁压盘，直径 350mm，压力 1200N。', image: '/manus-storage/Ge7H3bUW6F8c_a1710576.jpg', category: 'Transmission System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-20', partNumber: 'DZ96189584020', name: '缸盖垫 (Cylinder Head Gasket)', description: '陕汽缸盖垫，防止冷却液和机油泄漏，确保发动机密封。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：多层钢板垫，厚度 1.5mm，工作温度 -40~150℃。', image: '/manus-storage/luWJm8JCFur4_8e224124.webp', category: 'Engine System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-21', partNumber: 'DZ96189584021', name: '轴承套件 (Bearing Kit)', description: '陕汽轴承套件，包含多种规格轴承，用于变速箱和差速器。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：深沟球轴承，精度等级 P6，工作温度 -40~120℃。', image: '/manus-storage/Oo8MIcQYU94D_7be51583.webp', category: 'Transmission System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-22', partNumber: 'DZ96189584022', name: '差速器总成 (Differential Assembly)', description: '陕汽差速器总成，实现左右车轮差速转动。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：行星齿轮式，齿比 3.73，工作温度 -40~80℃。', image: '/manus-storage/X7Pq7vOxnbcE_3ee93f6d.webp', category: 'Transmission System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-23', partNumber: 'DZ96189584023', name: '转向节销 (Kingpin)', description: '陕汽转向节销，连接转向节和车轴，支撑前轮。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：锻钢，直径 40mm，长度 180mm。', image: '/manus-storage/ku1aLlq3pDBg_ad36e387.jpg', category: 'Suspension System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-24', partNumber: 'DZ96189584024', name: '转向节销套件 (Kingpin Kit)', description: '陕汽转向节销套件，包含销、衬套、垫片等配件。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：完整套件，包含所有密封件，工作温度 -40~80℃。', image: '/manus-storage/PdzRxVISVOV0_f68c6842.jpg', category: 'Suspension System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-25', partNumber: 'DZ96189584025', name: '喷油泵 (Fuel Injection Pump)', description: '陕汽柴油喷油泵，为发动机供应高压燃油。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：高压泵，工作压力 250bar，流量 80L/h。', image: '/manus-storage/9WJLlPn4LQEa_29d2d462.jpg', category: 'Fuel System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-26', partNumber: 'DZ96189584026', name: '喷油器座 (Fuel Injector Seat)', description: '陕汽喷油器座，固定喷油器，防止泄漏。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：铜合金座，螺纹 M14×1.5，工作温度 -40~200℃。', image: '/manus-storage/gC9wNjS849An_6f7154f8.jpg', category: 'Fuel System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-27', partNumber: 'DZ96189584027', name: '散热器 (Radiator)', description: '陕汽铝制散热器，高效散热，保持发动机工作温度。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：铝制芯体，散热面积 2.5m²，工作压力 1.5bar。', image: '/manus-storage/uTleBWqFZum7_6d0ccaae.png', category: 'Cooling System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-28', partNumber: 'DZ96189584028', name: '冷却液软管 (Coolant Hose)', description: '陕汽冷却液软管，连接散热器和水泵，耐高温。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：橡胶软管，内径 32mm，工作温度 -40~120℃。', image: '/manus-storage/pbNdRJKcOx7s_ecb5ff65.webp', category: 'Cooling System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-29', partNumber: 'DZ96189584029', name: '转向柱支撑轴承 (Steering Column Bearing)', description: '陕汽转向柱支撑轴承，支撑转向柱，减少摩擦。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：球面滚子轴承，工作温度 -40~80℃。', image: '/manus-storage/9wvTRl99wcMX_8eba63a6.jpg', category: 'Steering System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-30', partNumber: 'DZ96189584030', name: '转向节联轴节 (Steering Joint)', description: '陕汽转向节联轴节，连接转向柱和转向齿轮，传递转向力。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：万向节，直径 30mm，工作温度 -40~80℃。', image: '/manus-storage/JdVEya1tJQz2_b771f93b.jpg', category: 'Steering System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-31', partNumber: 'DZ96189584031', name: '油箱盖 (Fuel Tank Cap)', description: '陕汽油箱盖，防止燃油泄漏和蒸发。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：塑料盖，开启压力 0.5bar，工作温度 -40~80℃。', image: '/manus-storage/3RuFb2S6PHyp_4ade1fc3.jpg', category: 'Fuel System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-32', partNumber: 'DZ96189584032', name: '玻璃水储液罐盖 (Washer Reservoir Cap)', description: '陕汽玻璃水储液罐盖，防止液体泄漏。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：塑料盖，螺纹接口，工作温度 -40~60℃。', image: '/manus-storage/DsuqePZsEFya_fedd03c1.webp', category: 'Electrical System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-33', partNumber: 'DZ96189584033', name: '座椅控制开关 (Seat Control Switch)', description: '陕汽电动座椅控制开关，调节座椅位置和靠背。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：3针开关，电压 12V，工作温度 -40~80℃。', image: '/manus-storage/utzh5e7pKw9x_3e5c0eff.jpg', category: 'Electrical System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-34', partNumber: 'DZ96189584034', name: '转向柱下支撑轴承 (Lower Steering Column Bearing)', description: '陕汽转向柱下支撑轴承，支撑转向柱下端。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：滚针轴承，工作温度 -40~80℃。', image: '/manus-storage/6zsxgXqTrKcO_288eb5e1.jpg', category: 'Steering System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-35', partNumber: 'DZ96189584035', name: '玻璃水储液罐盖（重型卡车）(Washer Reservoir Cap Heavy Duty)', description: '陕汽重型卡车玻璃水储液罐盖，耐压耐温。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：加强型塑料盖，工作温度 -40~60℃。', image: '/manus-storage/Oo8MIcQYU94D_7be51583.webp', category: 'Electrical System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-36', partNumber: 'DZ96189584036', name: '座椅加热控制开关 (Seat Heating Switch)', description: '陕汽座椅加热控制开关，控制座椅加热功能。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：3档开关，电压 12V，功率 100W。', image: '/manus-storage/PdzRxVISVOV0_f68c6842.jpg', category: 'Electrical System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-37', partNumber: 'DZ96189584037', name: '转向柱联轴节套件 (Steering Column Joint Kit)', description: '陕汽转向柱联轴节套件，包含所有连接件。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：完整套件，工作温度 -40~80℃。', image: '/manus-storage/9wvTRl99wcMX_8eba63a6.jpg', category: 'Steering System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-38', partNumber: 'DZ96189584038', name: '发动机垫片套件 (Engine Gasket Kit)', description: '陕汽发动机垫片套件，包含所有发动机垫片。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：完整套件，包含缸盖垫、油底壳垫等。', image: '/manus-storage/JdVEya1tJQz2_b771f93b.jpg', category: 'Engine System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-39', partNumber: 'DZ96189584039', name: '制动软管 (Brake Hose)', description: '陕汽制动软管，传输制动液，耐高压。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：橡胶软管，内径 10mm，工作压力 280bar。', image: '/manus-storage/k9iofFnUAOYC_363c61d0.png', category: 'Brake System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-40', partNumber: 'DZ96189584040', name: '制动总泵 (Brake Master Cylinder)', description: '陕汽制动总泵，产生制动压力，控制制动系统。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：双腔总泵，排量 50ml，工作压力 280bar。', image: '/manus-storage/oHjbrEot2X81_9f3574c3.webp', category: 'Brake System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-41', partNumber: 'DZ96189584041', name: '制动分泵 (Brake Wheel Cylinder)', description: '陕汽制动分泵，推动制动蹄，实现制动。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：双活塞分泵，排量 25ml，工作压力 280bar。', image: '/manus-storage/mRpaJf7e6swT_ac3611b6.webp', category: 'Brake System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-42', partNumber: 'DZ96189584042', name: '制动盘 (Brake Disc)', description: '陕汽制动盘，与制动垫片配合，实现制动。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：铸铁盘，厚度 30mm，直径 330mm。', image: '/manus-storage/mR4Pir0ztUBS_2a5cfcfc.webp', category: 'Brake System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-43', partNumber: 'DZ96189584043', name: '制动鼓 (Brake Drum)', description: '陕汽制动鼓，与制动蹄配合，实现制动。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：铸铁鼓，直径 330mm，厚度 12mm。', image: '/manus-storage/lm4KRBZfLNLU_a6b889dd.webp', category: 'Brake System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-44', partNumber: 'DZ96189584044', name: '制动蹄 (Brake Shoe)', description: '陕汽制动蹄，与制动鼓配合，实现制动。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：铸铁蹄，长度 250mm，宽度 60mm。', image: '/manus-storage/Cgoga9i8UKSi_8bfc8367.png', category: 'Brake System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-45', partNumber: 'DZ96189584045', name: '空气制动阀 (Air Brake Valve)', description: '陕汽空气制动阀，控制空气制动系统。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：电磁阀，工作压力 6-8bar，响应时间 0.1s。', image: '/manus-storage/XFXeeTbb8OWJ_a878ec54.webp', category: 'Brake System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-46', partNumber: 'DZ96189584046', name: '空气压缩机 (Air Compressor)', description: '陕汽空气压缩机，为空气制动系统供气。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：排量 100L/min，工作压力 8bar，功率 5kW。', image: '/manus-storage/YIhWT7x9aSh3_d749ccde.webp', category: 'Brake System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-47', partNumber: 'DZ96189584047', name: '空气干燥器 (Air Dryer)', description: '陕汽空气干燥器，干燥压缩空气，防止结冰。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：吸收式干燥器，处理能力 100L/min。', image: '/manus-storage/Tc8DG4d4KHXE_35b27165.webp', category: 'Brake System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-48', partNumber: 'DZ96189584048', name: '储气罐 (Air Tank)', description: '陕汽储气罐，储存压缩空气，稳定系统压力。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：钢制罐，容积 100L，工作压力 8bar。', image: '/manus-storage/zohBkcU4aRAj_17a1039f.webp', category: 'Brake System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-49', partNumber: 'DZ96189584049', name: '前轮毂轴承 (Front Wheel Hub Bearing)', description: '陕汽前轮毂轴承，支撑前轮，减少摩擦。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：圆锥滚子轴承，工作温度 -40~120℃。', image: '/manus-storage/LqSXMYuT9rRz_c173962c.png', category: 'Suspension System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-50', partNumber: 'DZ96189584050', name: '后轮毂轴承 (Rear Wheel Hub Bearing)', description: '陕汽后轮毂轴承，支撑后轮，减少摩擦。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：圆锥滚子轴承，工作温度 -40~120℃。', image: '/manus-storage/XTo98a90f5zv_ac9d8409.png', category: 'Suspension System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-51', partNumber: 'DZ96189584051', name: '转向拉杆 (Steering Tie Rod)', description: '陕汽转向拉杆，连接转向齿轮和转向节，传递转向力。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：锻钢杆，长度 800mm，工作温度 -40~80℃。', image: '/manus-storage/ZqWLRktfi4E1_32ead5cf.png', category: 'Steering System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-52', partNumber: 'DZ96189584052', name: '转向拉杆端头 (Tie Rod End)', description: '陕汽转向拉杆端头，连接拉杆和转向节。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：球头端头，螺纹 M20×1.5，工作温度 -40~80℃。', image: '/manus-storage/kBF28pSE4jo2_10cc9723.png', category: 'Steering System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
      { id: 'sm-sp-53', partNumber: 'DZ96189584053', name: '转向齿轮 (Steering Gear)', description: '陕汽转向齿轮，将转向柱的旋转转换为拉杆的直线运动。兼容车型：陕汽 F3000、H3000、X3000、X5000、X6000 等。规格：齿条齿轮式，传动比 16:1，工作温度 -40~80℃。', image: '/manus-storage/n4y9t1gRbigZ_f4160cdf.png', category: 'Steering System', compatibleModels: ["\u9655\u6c7d", "F3000", "H3000", "X3000", "X5000", "X6000"] },
    ]
  },
  {
    id: 'sinotruk',
    ...
    spareParts: [
      // Lubrication System
      { id: 'st-sp-1', partNumber: 'VG1560118229', name: '机油滤清器 (Engine Oil Filter)', description: '重汽豪沃原厂机油滤清器，高效过滤发动机机油中的杂质和金属颗粒，保护发动机。兼容车型：重汽 HOWO 4×2、6×4、8×4、T7S、TX、SITRAK C7H 等。发动机型号：潍柴 WD615、WD10、WD12 或康明斯。规格：纸质滤芯，流量 120L/min，工作温度 -40~120℃。', image: '/manus-storage/ucpUdUZdpIAr_0fcb9d5f.webp', category: 'Lubrication System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "4\u00d72", "6\u00d74", "8\u00d74", "T7S", "TX", "SITRAK", "C7H"] },
      { id: 'st-sp-2', partNumber: 'VG1560080012', name: '机油泵 (Oil Pump)', description: '重汽豪沃机油泵，为发动机润滑系统供油。兼容车型：重汽 HOWO 系列。发动机型号：潍柴或康明斯。规格：排量 8.5cc/rev，工作压力 0.5-0.8bar。', image: '/manus-storage/fcPGf6qqKLeF_220f6fb4.jpg', category: 'Lubrication System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-3', partNumber: 'VG1560080013', name: '机油滤清器座 (Oil Filter Seat)', description: '重汽豪沃机油滤清器座，连接机油滤清器和发动机。兼容车型：重汽 HOWO 系列。规格：铸铁，工作压力 0.8bar。', image: '/manus-storage/8yoUd9lwI4QU_fb1bcb17.jpg', category: 'Lubrication System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      
      // Fuel System
      { id: 'st-sp-4', partNumber: 'VG1560080012', name: '燃油滤清器 (Fuel Filter)', description: '重汽豪沃原厂燃油滤清器，精密过滤燃油中的杂质和水分，提高喷油精度。兼容车型：重汽 HOWO 系列。发动机型号：潍柴或康明斯。规格：纸质滤芯，过滤精度 10μm，工作压力 0.3-0.5bar。', image: '/manus-storage/PdEw62cQZKqP_ac3ef499.webp', category: 'Fuel System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-5', partNumber: 'WG9925551410', name: '燃油滤清器总成 (Fuel Filter Assembly)', description: '重汽豪沃燃油滤清器总成，含滤芯和座。兼容车型：重汽 HOWO 系列。规格：纸质滤芯，过滤精度 5μm，工作压力 0.5bar。', image: '/manus-storage/o9DYZg0gms0G_2a6014f9.jpg', category: 'Fuel System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-6', partNumber: 'VG1560080011', name: '喷油器 (Fuel Injector)', description: '重汽豪沃原厂喷油器，精密喷射燃油到气缸。兼容车型：重汽 HOWO 系列。发动机型号：潍柴或康明斯。规格：喷油压力 200bar，喷油量 50mm³/st。', image: '/manus-storage/3yVLeyGHnP5n_3fcfe09f.webp', category: 'Fuel System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-7', partNumber: 'VG1560080010', name: '高压油管 (High Pressure Fuel Pipe)', description: '重汽豪沃高压燃油管，连接喷油泵和喷油器。兼容车型：重汽 HOWO 系列。规格：工作压力 200bar，长度 1.2m。', image: '/manus-storage/ZX4YdBMDdIvf_a58a6b13.jpg', category: 'Fuel System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      
      // Engine System
      { id: 'st-sp-8', partNumber: 'VG1560118230', name: '空气滤清器 (Air Filter)', description: '重汽豪沃高效空气滤清器，有效过滤进气中的灰尘和颗粒，保证发动机进气清洁。兼容车型：重汽 HOWO 系列。发动机型号：潍柴或康明斯。规格：纸质滤芯，过滤精度 5μm，流量 250m³/h。', image: '/manus-storage/keKWTf7psn43_42aec80d.jpg', category: 'Engine System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-9', partNumber: 'VG1560118231', name: '活塞环套件 (Piston Ring Set)', description: '重汽豪沃原厂活塞环，精密加工，耐高温耐磨损，密封活塞和气缸，防止气体泄漏。兼容车型：重汽 HOWO 系列。发动机型号：潍柴或康明斯。规格：铸铁，厚度 1.5-2mm，工作温度 300℃。', image: '/manus-storage/lqsRdwHew27F_d931e63d.jpg', category: 'Engine System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-10', partNumber: 'VG1560118232', name: '气门油封 (Valve Oil Seal)', description: '重汽豪沃气门油封，防止机油进入气缸，保护发动机。兼容车型：重汽 HOWO 系列。发动机型号：潍柴或康明斯。规格：氟橡胶油封，工作温度 -40~150℃。', image: '/manus-storage/QEmbgAIpztPF_520f4185.webp', category: 'Engine System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-11', partNumber: 'VG1560118233', name: '进气门 (Intake Valve)', description: '重汽豪沃进气门，控制进气流量。兼容车型：重汽 HOWO 系列。发动机型号：潍柴或康明斯。规格：钛合金，直径 45mm，工作温度 400℃。', image: '/manus-storage/yvtgySs57Yno_3df46036.webp', category: 'Engine System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-12', partNumber: 'VG1560118234', name: '排气门 (Exhaust Valve)', description: '重汽豪沃排气门，排出燃烧废气。兼容车型：重汽 HOWO 系列。发动机型号：潍柴或康明斯。规格：钛合金，直径 42mm，工作温度 450℃。', image: '/manus-storage/panh7ArNe8Kz_5454ef99.webp', category: 'Engine System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-13', partNumber: 'VG1560118235', name: '缸盖垫 (Cylinder Head Gasket)', description: '重汽豪沃缸盖垫，密封气缸盖和缸体。兼容车型：重汽 HOWO 系列。发动机型号：潍柴或康明斯。规格：石棉垫，厚度 1.5mm，工作压力 25bar。', image: '/manus-storage/dE26oJpkG7vY_85a0cb88.jpg', category: 'Engine System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-14', partNumber: 'VG1560118236', name: '前油封 (Front Oil Seal)', description: '重汽豪沃曲轴前油封，防止机油泄漏。兼容车型：重汽 HOWO 系列。发动机型号：潍柴或康明斯。规格：氟橡胶油封，工作温度 -40~150℃。', image: '/manus-storage/BHGlWOSjhU5w_9f29cc56.webp', category: 'Engine System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-15', partNumber: 'VG1560118237', name: '后油封 (Rear Oil Seal)', description: '重汽豪沃曲轴后油封，防止机油泄漏。兼容车型：重汽 HOWO 系列。发动机型号：潍柴或康明斯。规格：氟橡胶油封，工作温度 -40~150℃。', image: '/manus-storage/baN8ShRqAIuM_6af4f6db.webp', category: 'Engine System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      
      // Cooling System
      { id: 'st-sp-16', partNumber: 'VG1560118238', name: '水泵总成 (Water Pump Assembly)', description: '重汽豪沃冷却水泵总成，高效循环冷却液，采用铝制泵体，保持发动机工作温度。兼容车型：重汽 HOWO 系列。发动机型号：潍柴或康明斯。规格：铝制泵体，流量 100L/min，工作温度 -40~120℃。', image: '/manus-storage/m5OZXX2sDczn_4cc5bbb3.webp', category: 'Cooling System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-17', partNumber: 'VG1560118239', name: '节温器 (Thermostat)', description: '重汽豪沃冷却系统节温器，精确控制冷却液温度，提高发动机效率，降低油耗。兼容车型：重汽 HOWO 系列。发动机型号：潍柴或康明斯。规格：黄铜阀芯，开启温度 82℃，工作压力 0.5bar。', image: '/manus-storage/G0GeO0WrMAUD_64511560.webp', category: 'Cooling System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-18', partNumber: 'VG1560118240', name: '冷却液管 (Coolant Hose)', description: '重汽豪沃冷却液管，连接水泵、散热器和发动机。兼容车型：重汽 HOWO 系列。规格：橡胶管，直径 50mm，工作温度 -40~120℃。', image: '/manus-storage/0P7QMn0UmDbr_370e6c09.jpg', category: 'Cooling System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-19', partNumber: 'VG1560118241', name: '散热器 (Radiator)', description: '重汽豪沃散热器，散发冷却液的热量。兼容车型：重汽 HOWO 系列。规格：铝制，散热面积 2.5m²，工作压力 0.5bar。', image: '/manus-storage/dEjyxIKSGUQ9_da05659c.jpg', category: 'Cooling System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-20', partNumber: 'VG1560118242', name: '液压油冷却器 (Hydraulic Oil Cooler)', description: '重汽豪沃液压油冷却器，冷却液压系统油液。兼容车型：重汽 HOWO 系列。规格：铝制，散热面积 1.5m²，工作压力 280bar。', image: '/manus-storage/BHGlWOSjhU5w_9f29cc56.webp', category: 'Cooling System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      
      // Brake System
      { id: 'st-sp-21', partNumber: 'VG1560118243', name: '制动垫片 (Brake Pad Set)', description: '重汽豪沃原厂制动垫片，高摩擦系数，耐高温耐磨损，确保制动安全。兼容车型：重汽 HOWO 系列。规格：半金属垫片，厚度 12-15mm，工作温度 -40~350℃。', image: '/manus-storage/baN8ShRqAIuM_6af4f6db.webp', category: 'Brake System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-22', partNumber: 'WG9100443050', name: '前制动垫片 (Front Brake Pad)', description: '重汽豪沃前制动垫片，前轮制动。兼容车型：重汽 HOWO 系列。规格：半金属垫片，厚度 15mm，摩擦系数 0.45。', image: '/manus-storage/ucpUdUZdpIAr_0fcb9d5f.webp', category: 'Brake System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-23', partNumber: 'VG1560118244', name: '制动盘 (Brake Disc)', description: '重汽豪沃制动盘，与制动垫片配合实现制动。兼容车型：重汽 HOWO 系列。规格：铸铁盘，厚度 30mm，直径 370mm。', image: '/manus-storage/PdEw62cQZKqP_ac3ef499.webp', category: 'Brake System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-24', partNumber: 'VG1560118245', name: '制动蹄 (Brake Shoe)', description: '重汽豪沃制动蹄，鼓式制动系统。兼容车型：重汽 HOWO 系列。规格：铸铁蹄，厚度 8mm，工作温度 -40~350℃。', image: '/manus-storage/fcPGf6qqKLeF_220f6fb4.jpg', category: 'Brake System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-25', partNumber: 'VG1560118246', name: '制动软管 (Brake Hose)', description: '重汽豪沃制动软管，传输制动液压。兼容车型：重汽 HOWO 系列。规格：橡胶管，直径 12mm，工作压力 280bar。', image: '/manus-storage/8yoUd9lwI4QU_fb1bcb17.jpg', category: 'Brake System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-26', partNumber: 'VG1560118247', name: '制动总泵 (Brake Master Cylinder)', description: '重汽豪沃制动总泵，产生制动压力。兼容车型：重汽 HOWO 系列。规格：铸铁泵，直径 32mm，工作压力 280bar。', image: '/manus-storage/o9DYZg0gms0G_2a6014f9.jpg', category: 'Brake System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-27', partNumber: 'VG1560118248', name: '制动分泵 (Brake Wheel Cylinder)', description: '重汽豪沃制动分泵，推动制动垫片。兼容车型：重汽 HOWO 系列。规格：铸铁泵，直径 28mm，工作压力 280bar。', image: '/manus-storage/3yVLeyGHnP5n_3fcfe09f.webp', category: 'Brake System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-28', partNumber: 'VG1560118249', name: '空气压缩机 (Air Compressor)', description: '重汽豪沃空气压缩机，为气制动系统供气。兼容车型：重汽 HOWO 系列。规格：排气量 8.5L/min，工作压力 0.8bar。', image: '/manus-storage/ZX4YdBMDdIvf_a58a6b13.jpg', category: 'Brake System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      
      // Transmission System
      { id: 'st-sp-29', partNumber: 'VG1560118250', name: '离合器片 (Clutch Plate)', description: '重汽豪沃原厂离合器片，高摩擦系数，耐高温，确保传动平稳。兼容车型：重汽 HOWO 系列。规格：铜基烧结，厚度 4.5mm，工作温度 -40~300℃。', image: '/manus-storage/keKWTf7psn43_42aec80d.jpg', category: 'Transmission System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-30', partNumber: 'VG1560118251', name: '变速箱滤清器 (Transmission Filter)', description: '重汽豪沃变速箱滤清器，过滤变速箱油。兼容车型：重汽 HOWO 系列。规格：纸质滤芯，过滤精度 10μm，工作压力 0.5bar。', image: '/manus-storage/lqsRdwHew27F_d931e63d.jpg', category: 'Transmission System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-31', partNumber: 'VG1560118252', name: '变速箱支架 (Gearbox Support)', description: '重汽豪沃变速箱支架，承载变速箱重量，减震降噪。兼容车型：重汽 HOWO 系列。规格：铸铁支架，重量 8kg，工作温度 -40~80℃。', image: '/manus-storage/QEmbgAIpztPF_520f4185.webp', category: 'Transmission System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-32', partNumber: 'VG1560118253', name: '离合器压盘 (Clutch Pressure Plate)', description: '重汽豪沃离合器压盘，压紧离合器片。兼容车型：重汽 HOWO 系列。规格：铸铁盘，直径 350mm，工作温度 -40~300℃。', image: '/manus-storage/yvtgySs57Yno_3df46036.webp', category: 'Transmission System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-33', partNumber: 'VG1560118254', name: '轴承套件 (Bearing Kit)', description: '重汽豪沃轴承套件，支撑变速箱轴。兼容车型：重汽 HOWO 系列。规格：滚珠轴承，直径 50mm，工作温度 -40~120℃。', image: '/manus-storage/panh7ArNe8Kz_5454ef99.webp', category: 'Transmission System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      
      // Suspension System
      { id: 'st-sp-34', partNumber: 'VG1560118255', name: '后悬架 (Rear Suspension)', description: '重汽豪沃后悬架总成，采用钢板弹簧设计，提供稳定的悬挂效果。兼容车型：重汽 HOWO 系列。规格：钢板弹簧，承载能力 15吨，工作温度 -40~80℃。', image: '/manus-storage/dE26oJpkG7vY_85a0cb88.jpg', category: 'Suspension System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-35', partNumber: 'VG1560118256', name: '悬架弹簧 (Leaf Spring)', description: '重汽豪沃悬架钢板弹簧，承载重量，缓冲颠簸。兼容车型：重汽 HOWO 系列。规格：锰钢弹簧，厚度 8mm，承载能力 10吨。', image: '/manus-storage/BHGlWOSjhU5w_9f29cc56.webp', category: 'Suspension System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-36', partNumber: 'VG1560118257', name: '减震器 (Shock Absorber)', description: '重汽豪沃减震器，吸收悬架振动。兼容车型：重汽 HOWO 系列。规格：液压减震器，长度 600mm，工作压力 50bar。', image: '/manus-storage/baN8ShRqAIuM_6af4f6db.webp', category: 'Suspension System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-37', partNumber: 'VG1560118258', name: '转向节销 (Kingpin)', description: '重汽豪沃转向节销，连接转向节和悬架。兼容车型：重汽 HOWO 系列。规格：铸铁销，直径 50mm，工作温度 -40~80℃。', image: '/manus-storage/ucpUdUZdpIAr_0fcb9d5f.webp', category: 'Suspension System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-38', partNumber: 'VG1560118259', name: '转向节销套件 (Kingpin Repair Kit)', description: '重汽豪沃转向节销套件，含销和轴承。兼容车型：重汽 HOWO 系列。规格：铸铁销，直径 50mm，含轴承和垫片。', image: '/manus-storage/PdEw62cQZKqP_ac3ef499.webp', category: 'Suspension System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      
      // Electrical System
      { id: 'st-sp-39', partNumber: 'VG1560118260', name: '交流发电机 (Alternator)', description: '重汽豪沃原厂交流发电机，为电气系统供电，保证车辆正常运行。兼容车型：重汽 HOWO 系列。规格：输出功率 120A，输出电压 14V，工作温度 -40~120℃。', image: '/manus-storage/fcPGf6qqKLeF_220f6fb4.jpg', category: 'Electrical System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-40', partNumber: 'VG1560118261', name: '启动马达 (Starter Motor)', description: '重汽豪沃启动马达，快速启动发动机。兼容车型：重汽 HOWO 系列。规格：功率 5.5kW，转速 11000rpm，工作温度 -40~120℃。', image: '/manus-storage/8yoUd9lwI4QU_fb1bcb17.jpg', category: 'Electrical System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-41', partNumber: 'VG1560118262', name: '电池 (Battery)', description: '重汽豪沃原厂蓄电池，提供启动电流，稳定供电。兼容车型：重汽 HOWO 系列。规格：12V 200Ah，冷启动电流 1500A，工作温度 -40~65℃。', image: '/manus-storage/o9DYZg0gms0G_2a6014f9.jpg', category: 'Electrical System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-42', partNumber: 'VG1560118263', name: '点火开关 (Ignition Switch)', description: '重汽豪沃点火开关，控制发动机启动。兼容车型：重汽 HOWO 系列。规格：电流 15A，工作温度 -40~80℃。', image: '/manus-storage/3yVLeyGHnP5n_3fcfe09f.webp', category: 'Electrical System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-43', partNumber: 'VG1560118264', name: '车灯总成 (Light Assembly)', description: '重汽豪沃车灯总成，包括前灯、后灯、转向灯等。兼容车型：重汽 HOWO 系列。规格：LED 灯，功率 55W，工作温度 -40~80℃。', image: '/manus-storage/ZX4YdBMDdIvf_a58a6b13.jpg', category: 'Electrical System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      
      // Steering System
      { id: 'st-sp-44', partNumber: 'VG1560118265', name: '转向柱支撑轴承 (Steering Column Bearing)', description: '重汽豪沃转向柱支撑轴承，支撑转向柱。兼容车型：重汽 HOWO 系列。规格：滚珠轴承，直径 40mm，工作温度 -40~80℃。', image: '/manus-storage/keKWTf7psn43_42aec80d.jpg', category: 'Steering System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-45', partNumber: 'VG1560118266', name: '转向节联轴节 (Steering Joint)', description: '重汽豪沃转向节联轴节，连接转向柱和转向齿轮。兼容车型：重汽 HOWO 系列。规格：铸铁联轴节，直径 30mm，工作温度 -40~80℃。', image: '/manus-storage/lqsRdwHew27F_d931e63d.jpg', category: 'Steering System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-46', partNumber: 'VG1560118267', name: '转向拉杆 (Steering Tie Rod)', description: '重汽豪沃转向拉杆，连接转向节和转向齿轮。兼容车型：重汽 HOWO 系列。规格：铸铁杆，长度 1.2m，工作温度 -40~80℃。', image: '/manus-storage/QEmbgAIpztPF_520f4185.webp', category: 'Steering System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-47', partNumber: 'VG1560118268', name: '转向齿轮 (Steering Gear)', description: '重汽豪沃转向齿轮，将转向柱的转动转换为轮胎的转向。兼容车型：重汽 HOWO 系列。规格：齿轮比 18:1，工作温度 -40~80℃。', image: '/manus-storage/yvtgySs57Yno_3df46036.webp', category: 'Steering System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-48', partNumber: 'VG1560118269', name: '转向泵 (Steering Pump)', description: '重汽豪沃转向泵，为转向系统供油。兼容车型：重汽 HOWO 系列。规格：排量 8.5cc/rev，工作压力 150bar。', image: '/manus-storage/panh7ArNe8Kz_5454ef99.webp', category: 'Steering System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      
      // Other Components
      { id: 'st-sp-49', partNumber: 'VG1560118270', name: '液压油滤清器 (Hydraulic Oil Filter)', description: '重汽豪沃液压油滤清器，过滤液压系统油液。兼容车型：重汽 HOWO 系列。规格：纸质滤芯，过滤精度 10μm，工作压力 280bar。', image: '/manus-storage/dE26oJpkG7vY_85a0cb88.jpg', category: 'Hydraulic System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-50', partNumber: 'VG1560118271', name: '油箱盖 (Fuel Tank Cap)', description: '重汽豪沃油箱盖，密封油箱。兼容车型：重汽 HOWO 系列。规格：塑料盖，直径 80mm，工作温度 -40~80℃。', image: '/manus-storage/BHGlWOSjhU5w_9f29cc56.webp', category: 'Fuel System', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
      { id: 'st-sp-51', partNumber: 'VG1560118272', name: '玻璃水储液罐盖 (Washer Reservoir Cap)', description: '重汽豪沃玻璃水储液罐盖，密封玻璃水储液罐。兼容车型：重汽 HOWO 系列。规格：塑料盖，直径 60mm，工作温度 -40~80℃。', image: '/manus-storage/baN8ShRqAIuM_6af4f6db.webp', category: 'Other', compatibleModels: ["\u91cd\u6c7d", "HOWO", "\u7cfb\u5217"] },
    ]
  },
  {
    id: 'toyota',
    ...
    spareParts: [
      ...
      { id: 'ty-sp-3', partNumber: '90915-20004-2', name: '機油滿油器雙件組 (Dual Oil Filter Pack)', description: '丰田機油滿油器雙件組，經濟實惠。兼容车型：丰田 Hilux、Tacoma、Tundra、4Runner、Land Cruiser、Fortuner 等。', image: '/manus-storage/BoFXFbcwtZDk_803a6975.jpg', category: 'Lubrication System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra", "4Runner", "Land", "Cruiser", "Fortuner"] },
      { id: 'ty-sp-4', partNumber: '04152-37010', name: '機油泵 (Oil Pan)', description: '丰田發動機機油泵，存儲發動機機油。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：铝制，容量 5.5L。', image: '/manus-storage/wndpHoCfDJpH_891ddd5e.webp', category: 'Lubrication System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-5', partNumber: '16100-09470', name: '水泵總成 (Water Pump Assembly)', description: '丰田冷却水泵總成，高效循環冷却液，提高發動機效率。兼容车型：丰田 4Runner、4.0L、Tacoma、5.0L、Tundra、5.7L V8 等。规格：铝制泵体，流量 150L/min。', image: '/manus-storage/JNAI0tJAIecg_ea841084.webp', category: 'Cooling System', compatibleModels: ["\u4e30\u7530", "4Runner"] },
      { id: 'ty-sp-6', partNumber: '90916-03144', name: '节温器 (Thermostat)', description: '丰田冷却系统节温器，精確控制冷却液温度，提高發動機效率。兼容车型：丰田 Hilux、Tacoma、Tundra、Land Cruiser 等。规格：黄铜阀芯，開啟温度 82℃。', image: '/manus-storage/OVoSRC85OgZP_a1b5e0cd.jpg', category: 'Cooling System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra", "Land", "Cruiser"] },
      { id: 'ty-sp-7', partNumber: '16100-09525', name: '水泵總成帶水管 (Water Pump with Hose)', description: '丰田水泵總成帶水管，完整組件。兼容车型：丰田 2010-2019 车款。规格：铝制，流量 160L/min。', image: '/manus-storage/YPxsSOE7geR4_99054084.jpg', category: 'Cooling System', compatibleModels: ["\u4e30\u7530", "2010-2019", "\u8f66\u6b3e"] },
      { id: 'ty-sp-8', partNumber: '16100-69357', name: '水泵總成柴油版 (Diesel Water Pump)', description: '丰田柴油發動機水泵總成，適用柴油车型。兼容车型：丰田 HiAce、Hilux、Surf、4Runner、Prado、Land Cruiser、Dyna 等。發動機型号：1KZT、1KZ-TE、1KD-FTV、2KD-FTV。', image: '/manus-storage/NGUokJ9xcsyu_49692f89.jpg', category: 'Cooling System', compatibleModels: ["\u4e30\u7530", "HiAce", "Hilux", "Surf", "4Runner", "Prado", "Land", "Cruiser", "Dyna"] },
      { id: 'ty-sp-9', partNumber: '16100-69356', name: '水泵總成柴油版-2 (Diesel Water Pump Alt)', description: '丰田柴油發動機水泵總成事版。兼容车型：丰田 HiAce、Hilux、Surf、4Runner、Prado、Land Cruiser 等。發動機型号：1KZT、1KZ-TE、1KD-FTV、2KD-FTV。', image: '/manus-storage/wz4PDFlwwrPh_285944d3.jpg', category: 'Cooling System', compatibleModels: ["\u4e30\u7530", "HiAce", "Hilux", "Surf", "4Runner", "Prado", "Land", "Cruiser"] },
      
      // Fuel System
      { id: 'ty-sp-10', partNumber: '23390-64480', name: '燈油滿油器 (Fuel Filter)', description: '丰田柴油發動機燈油滿油器，精密過溺燈油中的雜質和水分。兼容车型：丰田 Hilux、Tacoma、Tundra、Land Cruiser 等。规格：紙質滿油芯，過溺精度 10μm。', image: '/manus-storage/CaxCHBrIWosK_615ef53d.webp', category: 'Fuel System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra", "Land", "Cruiser"] },
      { id: 'ty-sp-11', partNumber: '23300-21030', name: '燈油水管滿油器 (Fuel Tank Filter)', description: '丰田燈油水管內滿油滿油器，保護燈油水管。兼容车型：丰田 Yaris〇4Runner、Rav4 等。规格：紙質滿油芯。', image: '/manus-storage/DCUSG4lowAM6_c429826a.jpg', category: 'Fuel System', compatibleModels: ["\u4e30\u7530", "Yaris\u30074Runner", "Rav4"] },
      { id: 'ty-sp-12', partNumber: '23300-62040', name: '燈油泵 (Fuel Tank)', description: '丰田燈油泵，存儲燈油。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：銅制，容量 80L。', image: '/manus-storage/BoFXFbcwtZDk_803a6975.jpg', category: 'Fuel System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-13', partNumber: '23210-75040', name: '燈油泵需水管 (Fuel Tank Filler Hose)', description: '丰田燈油泵需水管，連接燈油泵。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：橡胶管。', image: '/manus-storage/wndpHoCfDJpH_891ddd5e.webp', category: 'Fuel System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-14', partNumber: '23300-54130', name: '燈油泵需水管組件 (Fuel Tank Hose Assembly)', description: '丰田燈油泵需水管組件。兼容车型：丰田 Hilux、Tacoma、Tundra 等。', image: '/manus-storage/JNAI0tJAIecg_ea841084.webp', category: 'Fuel System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      
      // Engine System
      { id: 'ty-sp-15', partNumber: '17801-54090', name: '空氣滿油器 (Air Filter)', description: '丰田空氣滿油器，有效過溺進氣中的灰塵和顆粒。兼容车型：丰田 Hilux、Tacoma、Tundra、Land Cruiser 等。规格：紙質滿油芯，過溺精度 5μm。', image: '/manus-storage/OVoSRC85OgZP_a1b5e0cd.jpg', category: 'Engine System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra", "Land", "Cruiser"] },
      { id: 'ty-sp-16', partNumber: '13011-54150', name: '活塞環套件 (Piston Ring Set)', description: '丰田發動機活塞環，精密加工，耐高溫耐磨搊。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：鐵、厩度 1.5-2mm。', image: '/manus-storage/YPxsSOE7geR4_99054084.jpg', category: 'Engine System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-17', partNumber: '11012-54120', name: '氣門油封 (Valve Oil Seal)', description: '丰田氣門油封，防止機油進入氣缸。兼容车型：丰田 Hilux、Tacoma、Tundra、Land Cruiser 等。规格：氟橡胶油封。', image: '/manus-storage/NGUokJ9xcsyu_49692f89.jpg', category: 'Engine System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra", "Land", "Cruiser"] },
      { id: 'ty-sp-18', partNumber: '13101-54150', name: '進氣門 (Intake Valve)', description: '丰田發動機進氣門，控制進氣流量。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：鐵合金、直径 45mm。', image: '/manus-storage/wz4PDFlwwrPh_285944d3.jpg', category: 'Engine System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-19', partNumber: '13111-54150', name: '排氣門 (Exhaust Valve)', description: '丰田發動機排氣門，排出燂烧废氣。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：鐵合金、直径 42mm。', image: '/manus-storage/CaxCHBrIWosK_615ef53d.webp', category: 'Engine System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-20', partNumber: '11213-54120', name: '缸蓋墠 (Cylinder Head Gasket)', description: '丰田發動機缸蓋墠，密封氣缸蓋和氣体。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：石棒墠、厩度 1.5mm。', image: '/manus-storage/DCUSG4lowAM6_c429826a.jpg', category: 'Engine System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-21', partNumber: '90080-36002', name: '前油封 (Front Oil Seal)', description: '丰田發動機曲軸前油封，防止機油洩漏。兼容车型：丰田 Hilux、Tacoma、Tundra、Land Cruiser 等。规格：氟橡胶油封。', image: '/manus-storage/BoFXFbcwtZDk_803a6975.jpg', category: 'Engine System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra", "Land", "Cruiser"] },
      { id: 'ty-sp-22', partNumber: '90080-36052', name: '後油封 (Rear Oil Seal)', description: '丰田發動機曲軸後油封，防止機油洩漏。兼容车型：丰田 Hilux、Tacoma、Tundra、Land Cruiser 等。规格：氟橡胶油封。', image: '/manus-storage/wndpHoCfDJpH_891ddd5e.webp', category: 'Engine System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra", "Land", "Cruiser"] },
      { id: 'ty-sp-23', partNumber: '11213-54140', name: '氣門室蓋墠 (Valve Cover Gasket)', description: '丰田發動機氣門室蓋墠，密封氣門室。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：石棒墠、厩度 1.5mm。', image: '/manus-storage/JNAI0tJAIecg_ea841084.webp', category: 'Engine System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      
      // Brake System
      { id: 'ty-sp-24', partNumber: '04465-35090', name: '制動境片 (Brake Pad Set)', description: '丰田原廠制動境片，高摩擦系數，耐高溫耐磨搊。兼容车型：丰田 Hilux、Tacoma、Tundra、Land Cruiser 等。规格：半金屬境片、厩度 12-15mm。', image: '/manus-storage/OVoSRC85OgZP_a1b5e0cd.jpg', category: 'Brake System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra", "Land", "Cruiser"] },
      { id: 'ty-sp-25', partNumber: '04465-12090', name: '前制動境片 (Front Brake Pad)', description: '丰田前輪制動境片。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：半金屬境片、厩度 15mm。', image: '/manus-storage/YPxsSOE7geR4_99054084.jpg', category: 'Brake System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-26', partNumber: '04465-35190', name: '後制動境片 (Rear Brake Pad)', description: '丰田後輪制動境片。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：半金屬境片、厩度 12mm。', image: '/manus-storage/NGUokJ9xcsyu_49692f89.jpg', category: 'Brake System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-27', partNumber: '43512-60080', name: '制動盤 (Brake Disc)', description: '丰田制動盤，與制動境片配合實現制動。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：鐵盤、厩度 30mm、直径 370mm。', image: '/manus-storage/wz4PDFlwwrPh_285944d3.jpg', category: 'Brake System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-28', partNumber: '04945-60050', name: '制動軟管 (Brake Hose)', description: '丰田制動軟管，傳輸制動液壓。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：橡胶管、直径 12mm。', image: '/manus-storage/CaxCHBrIWosK_615ef53d.webp', category: 'Brake System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-29', partNumber: '47201-60050', name: '制動總泵 (Brake Master Cylinder)', description: '丰田制動總泵，產生制動壓力。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：鐵泵、直径 32mm。', image: '/manus-storage/DCUSG4lowAM6_c429826a.jpg', category: 'Brake System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-30', partNumber: '47730-60050', name: '制動分泵 (Brake Wheel Cylinder)', description: '丰田制動分泵，推動制動境片。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：鐵泵、直径 28mm。', image: '/manus-storage/BoFXFbcwtZDk_803a6975.jpg', category: 'Brake System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      
      // Transmission System
      { id: 'ty-sp-31', partNumber: '31250-60050', name: '離合器片 (Clutch Plate)', description: '丰田原廠離合器片，高摩擦系數，耐高溫。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：銅基燒結、厩度 4.5mm。', image: '/manus-storage/wndpHoCfDJpH_891ddd5e.webp', category: 'Transmission System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-32', partNumber: '35330-60050', name: '變速箱滿油器 (Transmission Filter)', description: '丰田變速箱滿油器，過溺變速箱油。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：紙質滿油芯、過溺精度 10μm。', image: '/manus-storage/JNAI0tJAIecg_ea841084.webp', category: 'Transmission System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-33', partNumber: '12310-60050', name: '變速箱支架 (Gearbox Support)', description: '丰田變速箱支架，承載變速箱重量。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：鐵支架、重量 8kg。', image: '/manus-storage/OVoSRC85OgZP_a1b5e0cd.jpg', category: 'Transmission System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-34', partNumber: '31330-60050', name: '離合器壓盤 (Clutch Pressure Plate)', description: '丰田離合器壓盤，壓緊離合器片。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：鐵盤、直径 350mm。', image: '/manus-storage/YPxsSOE7geR4_99054084.jpg', category: 'Transmission System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-35', partNumber: '90080-36062', name: '軸承套件 (Bearing Kit)', description: '丰田軸承套件，支撑變速箱軸。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：溻珠軸承、直径 50mm。', image: '/manus-storage/NGUokJ9xcsyu_49692f89.jpg', category: 'Transmission System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      
      // Electrical System
      { id: 'ty-sp-36', partNumber: '27060-28050', name: '交流發電機 (Alternator)', description: '丰田發動機交流發電機，為電氣系統供電。兼容车型：丰田 Hilux、Tacoma、Tundra、Land Cruiser 等。规格：輸出力 100A、輸出電壓 14V。', image: '/manus-storage/wz4PDFlwwrPh_285944d3.jpg', category: 'Electrical System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra", "Land", "Cruiser"] },
      { id: 'ty-sp-37', partNumber: '28100-54050', name: '啟動馬達 (Starter Motor)', description: '丰田啟動馬達，起動發動機。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：輸出力 3.5kW、輸出所需電壓 12V。', image: '/manus-storage/CaxCHBrIWosK_615ef53d.webp', category: 'Electrical System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-38', partNumber: '28800-54010', name: '電池 (Battery)', description: '丰田電池，為發動機供電。兼容车型：丰田 Hilux、Tacoma、Tundra、Land Cruiser 等。规格：電壓 12V、容量 100Ah。', image: '/manus-storage/DCUSG4lowAM6_c429826a.jpg', category: 'Electrical System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra", "Land", "Cruiser"] },
      { id: 'ty-sp-39', partNumber: '84320-60050', name: '點火開關 (Ignition Switch)', description: '丰田點火開關，控制發動機點火。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：電壓 12V。', image: '/manus-storage/BoFXFbcwtZDk_803a6975.jpg', category: 'Electrical System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-40', partNumber: '81110-60050', name: '車燈總成 (Headlight Assembly)', description: '丰田車燈總成，提供夜間照明。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：電壓 12V、功率 55W。', image: '/manus-storage/wndpHoCfDJpH_891ddd5e.webp', category: 'Electrical System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      
      // Suspension System
      { id: 'ty-sp-41', partNumber: '48080-60050', name: '減震器 (Shock Absorber)', description: '丰田減震器，吸收悸架振動。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：液壓減震器、長度 600mm。', image: '/manus-storage/JNAI0tJAIecg_ea841084.webp', category: 'Suspension System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-42', partNumber: '48131-60050', name: '上悸架控制臂 (Upper Control Arm)', description: '丰田上悸架控制臂，連接上悸架。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：鐵臂。', image: '/manus-storage/OVoSRC85OgZP_a1b5e0cd.jpg', category: 'Suspension System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-43', partNumber: '48160-60050', name: '下悸架控制臂 (Lower Control Arm)', description: '丰田下悸架控制臂，連接下悸架。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：鐵臂。', image: '/manus-storage/YPxsSOE7geR4_99054084.jpg', category: 'Suspension System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-44', partNumber: '48080-60090', name: '悸架彈簧 (Leaf Spring)', description: '丰田悸架鉄板彈簧，承載重量、緩衝顏笃。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：鎖鉄彈簧、厩度 8mm。', image: '/manus-storage/NGUokJ9xcsyu_49692f89.jpg', category: 'Suspension System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
      { id: 'ty-sp-45', partNumber: '48090-60050', name: '後悸架 (Rear Suspension)', description: '丰田後悸架總成，採用鉄板彈簧設計，提供穩定的悸掙效果。兼容车型：丰田 Hilux、Tacoma、Tundra 等。规格：鉄板彈簧、承載能力 15吨。', image: '/manus-storage/wz4PDFlwwrPh_285944d3.jpg', category: 'Suspension System', compatibleModels: ["\u4e30\u7530", "Hilux", "Tacoma", "Tundra"] },
    ]
  },
  {
    id: 'cummins',
  ...
  },
  {
    ...
    spareParts: [
      { id: 'wc-sp-oil-filter', partNumber: 'WD615.47', name: '机油滤清器 (Oil Filter)', description: '潍柴 WD615 系列发动机机油滤清器，高效过滤发动机机油中的杂质和污染物，保护发动机寿命。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/2pLOTXYgjNj7_fbf89341.webp', category: 'Lubrication System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-fuel-filter', partNumber: 'WD615.48', name: '燃油滤清器 (Fuel Filter)', description: '潍柴原厂燃油滤清器，精密过滤燃油中的杂质，提高燃油喷射精度，延长喷油器寿命。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/aVqla6ayZoN7_c367eff8.jpg', category: 'Fuel System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-air-filter', partNumber: 'WD615.49', name: '空气滤清器 (Air Filter)', description: '潍柴高效空气滤清器，有效过滤进气中的灰尘和污染物，保证发动机进气清洁。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/KRoaO0aSy76f_55963d55.jpg', category: 'Engine System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-piston-ring', partNumber: 'WD615.50', name: '活塞环套件 (Piston Ring Set)', description: '潍柴原厂活塞环，精密加工，耐高温耐磨损，确保发动机密封性能。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/25m1DaILzdQN_9146ba84.jpg', category: 'Engine System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-connecting-rod', partNumber: 'WD615.51', name: '连杆瓦 (Connecting Rod Bearing)', description: '潍柴连杆瓦，采用高强度合金材料，承载能力强，耐磨性好。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/EybUq9Zt8lj2_dc09746c.jpg', category: 'Engine System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-main-bearing', partNumber: 'WD615.52', name: '主轴承套件 (Main Bearing Set)', description: '潍柴主轴承，精密加工，确保曲轴运转平稳，减少振动和噪音。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/Irhm1QUOw6PT_10bcfc69.webp', category: 'Engine System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-valve-seal', partNumber: 'WD615.53', name: '气门油封 (Valve Oil Seal)', description: '潍柴气门油封，防止机油泄漏，保护气门导管，延长发动机寿命。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/RCtq76O6Gvj0_af56ca83.webp', category: 'Engine System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-intake-valve', partNumber: 'WD615.54', name: '进气门 (Intake Valve)', description: '潍柴进气门，精密铸造，耐高温，确保进气效率和发动机性能。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/XFXeeTbb8OWJ_af011932.webp', category: 'Engine System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-exhaust-valve', partNumber: 'WD615.55', name: '排气门 (Exhaust Valve)', description: '潍柴排气门，耐高温耐腐蚀，确保排气畅通，保证发动机正常运转。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/Tc8DG4d4KHXE_b7eaae48.webp', category: 'Engine System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-water-pump', partNumber: 'WD615.56', name: '水泵 (Water Pump)', description: '潍柴水泵，高效循环冷却液，保持发动机工作温度，防止过热。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/Ddut7EfwwSJ7_12e1b77c.webp', category: 'Cooling System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-thermostat', partNumber: 'WD615.57', name: '节温器 (Thermostat)', description: '潍柴节温器，精确控制冷却液温度，提高发动机效率，降低油耗。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/gGXpsSW7Y760_c91cc3f9.jpg', category: 'Cooling System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-injector', partNumber: 'WD615.58', name: '喷油器 (Fuel Injector)', description: '潍柴喷油器，精密喷射，雾化效果好，提高燃油利用率和发动机性能。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/sTdwnu1ofWBX_e4503289.webp', category: 'Fuel System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-fuel-pipe', partNumber: 'WD615.59', name: '高压油管 (High Pressure Fuel Pipe)', description: '潍柴高压油管，耐高压，防泄漏，确保燃油稳定供应。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/mTRIIbz5npZ7_ac87be38.jpg', category: 'Fuel System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-front-seal', partNumber: 'WD615.60', name: '前油封 (Front Oil Seal)', description: '潍柴前油封，防止机油泄漏，保护曲轴，延长发动机寿命。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/CeNZLuLgECIi_ebff47dc.webp', category: 'Engine System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-rear-seal', partNumber: 'WD615.61', name: '后油封 (Rear Oil Seal)', description: '潍柴后油封，防止机油泄漏，保护曲轴后端，确保发动机密封。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/0O0Eyc6Levn4_4987ba86.webp', category: 'Engine System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-hydraulic-filter', partNumber: 'WD615.62', name: '液压油滤清器 (Hydraulic Oil Filter)', description: '潍柴液压油滤清器，过滤液压系统中的杂质，保护液压元件。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/4QlS3RdfrWXV_4c383fdb.png', category: 'Lubrication System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-coolant-hose', partNumber: 'WD615.63', name: '冷却液管 (Coolant Hose)', description: '潍柴冷却液管，耐高温耐压，确保冷却液循环畅通。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/l04iiQ8VXpuV_6009392e.jpg', category: 'Cooling System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-oil-cooler', partNumber: 'WD615.64', name: '机油冷却器 (Oil Cooler)', description: '潍柴机油冷却器，有效降低机油温度，保护发动机，延长机油寿命。兼容车型：陕汽、中国重汽、福田等。发动机型号：WD615、WD10、WD12。', image: '/manus-storage/G4hOmf1Mbs1L_c21a9ea8.jpg', category: 'Lubrication System', compatibleModels: ["\u9655\u6c7d", "\u4e2d\u56fd\u91cd\u6c7d", "\u798f\u7530\u7b49"] },
      { id: 'wc-sp-19', partNumber: 'WD615.65', name: '皮带张紧轮 (Belt Tensioner)', description: '潍柴发动机皮带张紧轮，自动调节皮带张力。易损件，建议每 10 万公里检查。兼容车型：陕汽、中国重汽、福田等。', image: '/manus-storage/belt_tensioner_weichai.jpg', category: 'Engine System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
      { id: 'wc-sp-20', partNumber: 'WD615.66', name: '发动机皮带 (Serpentine Belt)', description: '潍柴多槽皮带，驱动发电机、水泵等辅助装置。高复购率易损件，建议每 10 万公里更换。规格：长度 2800mm，宽度 28mm。', image: '/manus-storage/serpentine_belt_weichai.jpg', category: 'Engine System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
      { id: 'wc-sp-21', partNumber: 'WD615.67', name: '刹车片套件 (Brake Pad Set)', description: '潍柴原厂刹车片，陶瓷材质，高摩擦系数。高复购率易损件，建议每 5-8 万公里更换。规格：陶瓷刹车片，厚度 12mm。', image: '/manus-storage/brake_pad_weichai.jpg', category: 'Brake System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
      { id: 'wc-sp-22', partNumber: 'WD615.68', name: '刹车盘 (Brake Disc)', description: '潍柴前轮刹车盘，铸铁材质，散热性能好。易损件，建议每 10 万公里检查更换。规格：直径 330mm，厚度 28mm。', image: '/manus-storage/brake_disc_weichai.jpg', category: 'Brake System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
      { id: 'wc-sp-23', partNumber: 'WD615.69', name: '制动液 (Brake Fluid)', description: '潍柴 DOT 4 制动液，高沸点配方。消耗品，建议每 2 年更换一次。规格：1L 瓶装，沸点 230℃。', image: '/manus-storage/brake_fluid_weichai.jpg', category: 'Brake System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
      { id: 'wc-sp-24', partNumber: 'WD615.70', name: '启动马达 (Starter Motor)', description: '潍柴发动机启动马达，高扭矩设计。高故障率件，故障时需立即更换。规格：输出功率 5.5kW，输出扭矩 180Nm。', image: '/manus-storage/starter_motor_weichai.jpg', category: 'Electrical System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
      { id: 'wc-sp-25', partNumber: 'WD615.71', name: '蓄电池 (Battery)', description: '潍柴 12V 蓄电池，大容量设计。消耗品，建议每 3-4 年更换一次。规格：12V 200Ah，冷启动电流 1500A。', image: '/manus-storage/battery_weichai.jpg', category: 'Electrical System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
      { id: 'wc-sp-26', partNumber: 'WD615.72', name: '散热器 (Radiator)', description: '潍柴冷却系统散热器，铝制芯体。易损件，长期使用易堵塞，建议定期清洗。规格：铝制，尺寸 700×450×60mm。', image: '/manus-storage/radiator_weichai.jpg', category: 'Cooling System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
      { id: 'wc-sp-27', partNumber: 'WD615.73', name: '冷却风扇 (Cooling Fan)', description: '潍柴电动冷却风扇，自动温度控制。高故障率件，电机易烧坏，建议定期检查。规格：电动马达 2.5kW，风扇直径 650mm。', image: '/manus-storage/cooling_fan_weichai.jpg', category: 'Cooling System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
      { id: 'wc-sp-28', partNumber: 'WD615.74', name: '轮胎 (Tire)', description: '潍柴商用轮胎，耐磨性强。高复购率易损件，建议每 8-10 万公里更换。规格：尺寸 8.25R16，花纹深度 15mm。', image: '/manus-storage/tire_weichai.jpg', category: 'Tire System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
      { id: 'wc-sp-29', partNumber: 'WD615.75', name: '轮毂轴承 (Wheel Hub Bearing)', description: '潍柴轮毂轴承，精密加工。易损件，长期运行易发热，建议定期检查润滑。规格：双列圆锥滚子轴承，内径 55mm。', image: '/manus-storage/wheel_bearing_weichai.jpg', category: 'Suspension System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
      { id: 'wc-sp-30', partNumber: 'WD615.76', name: '减震器 (Shock Absorber)', description: '潍柴液压减震器，缓冲性能好。易损件，建议每 8 万公里检查更换。规格：液压式，行程 220mm，工作压力 25bar。', image: '/manus-storage/shock_absorber_weichai.jpg', category: 'Suspension System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
      { id: 'wc-sp-31', partNumber: 'WD615.77', name: '离合器片 (Clutch Disc)', description: '潍柴离合器摩擦片，高摩擦系数。易损件，建议每 10 万公里检查更换。规格：直径 350mm，厚度 8mm。', image: '/manus-storage/clutch_disc_weichai.jpg', category: 'Transmission System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
      { id: 'wc-sp-32', partNumber: 'WD615.78', name: '变速箱油 (Transmission Fluid)', description: '潍柴手动变速箱专用油，粘度合适。消耗品，建议每 5 万公里更换一次。规格：SAE 80W-90，4L 瓶装。', image: '/manus-storage/transmission_fluid_weichai.jpg', category: 'Transmission System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
      { id: 'wc-sp-33', partNumber: 'WD615.79', name: '方向盘转向泵 (Power Steering Pump)', description: '潍柴液压转向泵，转向轻便。高故障率件，泵体易磨损，建议定期检查。规格：齿轮泵，流量 45L/min，工作压力 150bar。', image: '/manus-storage/steering_pump_weichai.jpg', category: 'Steering System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
      { id: 'wc-sp-34', partNumber: 'WD615.80', name: '转向液 (Power Steering Fluid)', description: '潍柴转向系统专用液，防腐蚀。消耗品，建议每 2 年更换一次。规格：合成油，2L 瓶装，粘度 32cSt。', image: '/manus-storage/steering_fluid_weichai.jpg', category: 'Steering System', compatibleModels: ["陕汽", "中国重汽", "福田等"] },
    ]
  },
];

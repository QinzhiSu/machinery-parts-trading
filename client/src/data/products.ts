...
export const brands: Brand[] = [
  // ========== CONSTRUCTION MACHINERY ==========
  {
    ...
    spareParts: [
      ...
      { id: 'cat-sp-14', partNumber: '', name: '驱动链轮(Drive Sprocket)', description: "CAT 零件。轮齿磨损/断齿时更换", image: '/manus-storage/cat_ee9e5401.png', category: '底盘/履带系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      ...
      { id: 'cat-sp-17', partNumber: '', name: '斗齿适配器(Adapter)', description: "CAT 零件。随斗齿更换,寿命长于斗齿本身", image: '/manus-storage/cat_ee9e5401.png', category: '挖掘属性/GET', compatibleModels: ["CAT 320", "CAT 320D"] },
      ...
      { id: 'cat-sp-20', partNumber: '', name: '行走(履带)马达', description: "CAT 零件。异响/爬坡无力时更换(大修类)", image: '/manus-storage/cat_ee9e5401.png', category: '传动系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-21', partNumber: '', name: '回转(转台)马达及减速机', description: "CAT 零件。转台异响/回转无力时更换(大修类)", image: '/manus-storage/cat_ee9e5401.png', category: '传动系统', compatibleModels: ["CAT 320", "CAT 320D"] },

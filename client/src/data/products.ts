...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    spareParts: [
      { id: 'sany-sp-1', partNumber: '60201217', name: 'Fuel Filter', description: "SANY part. Replace every 250-500 hours during maintenance.", image: '/manus-storage/sany_5f4793a0.png', category: 'Maintenance/Filtration System', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-2', partNumber: 'B222100000551', name: 'Oil Filter', description: "SANY part. Replace every 250-500 hours during maintenance.", image: '/manus-storage/sany_5f4793a0.png', category: 'Maintenance/Filtration System', compatibleModels: ["SANY SY", "SY365"] },
      ...
      { id: 'sany-sp-6', partNumber: '60201217', name: 'Fuel Filter (Alternative Part Number)', description: "SANY part. Replace every 250-500 hours.", image: '/manus-storage/sany_5f4793a0.png', category: 'Maintenance/Filtration System', compatibleModels: ["SANY SY", "SY365"] },
      ...
      { id: 'sany-sp-8', partNumber: '', name: 'Bucket Tooth', description: "SANY part. Replace when worn to bottom or cracked (high-frequency replacement item).", image: '/manus-storage/sany_5f4793a0.png', category: 'Bucket/GET', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-9', partNumber: '', name: 'Front Idler', description: "SANY part. Replace when worn or making noise.", image: '/manus-storage/sany_5f4793a0.png', category: 'Chassis/Track System', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-10', partNumber: '', name: 'Drive Sprocket', description: "SANY part. Replace when teeth are worn or broken (major overhaul high-cost item).", image: '/manus-storage/sany_5f4793a0.png', category: 'Chassis/Track System', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-11', partNumber: '', name: 'Bottom Roller', description: "SANY part. Replace when leaking or worn.", image: '/manus-storage/sany_5f4793a0.png', category: 'Chassis/Track System', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-12', partNumber: '', name: 'Top Roller/Carrier Roller', description: "SANY part. Replace when leaking or worn.", image: '/manus-storage/sany_5f4793a0.png', category: 'Chassis/Track System', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-13', partNumber: '', name: 'Track Chain Assembly', description: "SANY part. Replace when track is loose or worn beyond limit (major overhaul high-cost item).", image: '/manus-storage/sany_5f4793a0.png', category: 'Chassis/Track System', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-14', partNumber: 'Trasteel Track', name: 'Track Shoe', description: "SANY part. Replace when worn or cracked.", image: '/manus-storage/sany_5f4793a0.png', category: 'Chassis/Track System', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-15', partNumber: 'A28VO130', name: 'Main Hydraulic Pump (Rexroth Type)', description: "SANY part. Replace when making noise, insufficient oil supply, or pressure drops (major overhaul high-cost item).", image: '/manus-storage/sany_5f4793a0.png', category: 'Hydraulic System', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-16', partNumber: '', name: 'Travel Motor/Final Drive Assembly', description: "SANY part. Replace when making noise or lack of climbing power (major overhaul high-cost item).", image: '/manus-storage/sany_5f4793a0.png', category: 'Hydraulic System', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-17', partNumber: 'KYB', name: 'Swing Motor and Reduction Gearbox', description: "SANY part. Replace when swing platform makes noise or lacks swing power (major overhaul item).", image: '/manus-storage/sany_5f4793a0.png', category: 'Hydraulic System', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-18', partNumber: 'Cummins', name: 'Turbocharger', description: "SANY part. Replace when power drops, making noise, or leaking (major overhaul item).", image: '/manus-storage/sany_5f4793a0.png', category: 'Engine System', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-19', partNumber: '', name: 'Alternator Assembly', description: "SANY part. Replace when charging is abnormal or making noise.", image: '/manus-storage/sany_5f4793a0.png', category: 'Engine System', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-20', partNumber: '', name: 'Starter Motor Assembly', description: "SANY part. Replace when starting is weak or making noise.", image: '/manus-storage/sany_5f4793a0.png', category: 'Engine System', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-21', partNumber: '', name: 'Bucket Cylinder Seal Repair Kit', description: "SANY part. Replace when leaking or seal is aged.", image: '/manus-storage/sany_5f4793a0.png', category: 'Hydraulic Cylinder/Seals', compatibleModels: ["SANY SY", "SY365"] }
    ]
  },
  {
    id: 'komatsu',
    ...
    spareParts: [
      { id: 'komatsu-sp-1', partNumber: '600-211-5241', name: 'Oil Filter', description: "KOMATSU part. Replace every 250-500 hours during maintenance.", image: '/manus-storage/komatsu_4cb14839.png', category: 'Maintenance/Filtration System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-2', partNumber: '6136-71-6120', name: 'Diesel Filter', description: "KOMATSU part. Replace every 250-500 hours or based on fuel quality.", image: '/manus-storage/komatsu_4cb14839.png', category: 'Maintenance/Filtration System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-3', partNumber: 'ST40611A', name: 'Air Filter (Outer Element)', description: "KOMATSU part. Replace every 250-500 hours or based on dust environment.", image: '/manus-storage/komatsu_4cb14839.png', category: 'Maintenance/Filtration System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-4', partNumber: 'ST40611B', name: 'Air Filter (Inner Element)', description: "KOMATSU part. Replace synchronously with outer element.", image: '/manus-storage/komatsu_4cb14839.png', category: 'Maintenance/Filtration System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      ...
      { id: 'komatsu-sp-7', partNumber: '600-411-1151', name: 'Diesel Filter (New Series 7/8)', description: "KOMATSU part. Replace every 250-500 hours.", image: '/manus-storage/komatsu_4cb14839.png', category: 'Maintenance/Filtration System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-8', partNumber: '600-311-9121', name: 'Diesel Filter (Universal)', description: "KOMATSU part. Replace every 250-500 hours.", image: '/manus-storage/komatsu_4cb14839.png', category: 'Maintenance/Filtration System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-9', partNumber: '6735-51-5140', name: 'Oil Filter (6D102 Engine)', description: "KOMATSU part. Replace every 250-500 hours during maintenance.", image: '/manus-storage/komatsu_4cb14839.png', category: 'Maintenance/Filtration System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-10', partNumber: '208-27-31221', name: 'Drive Sprocket (Old Model)', description: "KOMATSU part. Replace when teeth are worn or broken (major overhaul item).", image: '/manus-storage/komatsu_4cb14839.png', category: 'Chassis/Track System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-11', partNumber: '20Y-27-11582', name: 'Drive Sprocket (Series 7/8)', description: "KOMATSU part. Replace when teeth are worn or broken (major overhaul item).", image: '/manus-storage/komatsu_4cb14839.png', category: 'Chassis/Track System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-12', partNumber: '20Y-32-02091', name: 'Track Shoe Assembly', description: "KOMATSU part. Replace when worn or cracked (major overhaul item).", image: '/manus-storage/komatsu_4cb14839.png', category: 'Chassis/Track System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-13', partNumber: '207-30-00510', name: 'Track Roller (Lower)', description: "KOMATSU part. Replace when leaking or worn.", image: '/manus-storage/komatsu_4cb14839.png', category: 'Chassis/Track System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-14', partNumber: '208-30-00510', name: 'Carrier Roller (Upper)', description: "KOMATSU part. Replace when leaking or worn.", image: '/manus-storage/komatsu_4cb14839.png', category: 'Chassis/Track System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-15', partNumber: '2057019570', name: 'Bucket Tooth (K25 Series)', description: "KOMATSU part. Replace when worn to bottom or cracked (high-frequency replacement item).", image: '/manus-storage/komatsu_4cb14839.png', category: 'Excavation/GET', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-16', partNumber: '207-70-14151RC', name: 'Bucket Tooth Lock Pin', description: "KOMATSU part. Replace synchronously when bucket teeth are replaced.", image: '/manus-storage/komatsu_4cb14839.png', category: 'Excavation/GET', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-17', partNumber: '708-2L-00400', name: 'Main Hydraulic Pump Assembly', description: "KOMATSU part. Replace when abnormal noise, insufficient supply or pressure drop occurs (major overhaul item).", image: '/manus-storage/komatsu_4cb14839.png', category: 'Hydraulic System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-18', partNumber: '708-2L-31411', name: 'Main Hydraulic Pump (Model 2)', description: "KOMATSU part. Replace when abnormal noise or insufficient supply occurs (major overhaul item).", image: '/manus-storage/komatsu_4cb14839.png', category: 'Hydraulic System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-19', partNumber: '706-7G-01170', name: 'Swing Motor Assembly', description: "KOMATSU part. Replace when swing is noisy or weak (major overhaul item).", image: '/manus-storage/komatsu_4cb14839.png', category: 'Hydraulic System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
      { id: 'komatsu-sp-20', partNumber: '708-2L-06710', name: 'Relief Valve', description: "KOMATSU part. Replace when hydraulic pressure is abnormal or unstable.", image: '/manus-storage/komatsu_4cb14839.png', category: 'Hydraulic System', compatibleModels: ["Komatsu PC200", "PC200-8"] },
  ...
  // ========== TRUCKS & ENGINES ==========
  {
    ...
    spareParts: [
      ...
      { id: 'isuzu-sp-2', partNumber: 'ST10716 (KRH0642', name: 'Oil Filter (Secondary)', description: "ISUZU 零件。250-500小时", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-3', partNumber: 'ST10720 (KRH0643', name: 'Oil Filter (Model 2)', description: "ISUZU 零件。250-500小时", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-4', partNumber: 'ST20703 (KSP0281', name: 'Diesel Filter', description: "ISUZU 零件。250-500小时或视油品", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      ...
      { id: 'isuzu-sp-7', partNumber: '30732 (83984918)', name: 'Hydraulic Oil Filter (Model 2)', description: "ISUZU 零件。500-1000小时", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-8', partNumber: 'ST70810 (KRJ4008)', name: 'Hydraulic Oil Filter (Model 3)', description: "ISUZU 零件。500-1000小时", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-9', partNumber: 'ST30813 (4294135)', name: 'Pilot Valve Filter', description: "ISUZU 零件。500-1000小时", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-10', partNumber: '1-13200-487-2 (1132004872)', name: 'Oil Filter (Truck Version)', description: "ISUZU 零件。250-500小时", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      ...
      { id: 'isuzu-sp-12', partNumber: '1136500161 (1-13650016-1)', name: 'Water Pump Assembly (Model 2)', description: "ISUZU 零件。冷却液渗漏/异响时更换", image: '/manus-storage/isuzu_208688e1.png', category: 'Cooling System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-13', partNumber: '114400-2720 (RHC62C)', name: 'Turbocharger', description: "ISUZU 零件。动力下降/异响/漏油时更换(大修类)", image: '/manus-storage/isuzu_208688e1.png', category: 'Intake/Boost System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-14', partNumber: '1-11310-199-0 (1113101990)', name: 'Oil Pump Assembly', description: "ISUZU 零件。润滑不良/压力异常时更换(大修类)", image: '/manus-storage/isuzu_208688e1.png', category: 'Lubrication System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-15', partNumber: '1-13100277-0 (1131002770)', name: 'Oil Transfer Pump', description: "ISUZU 零件。润滑不良时更换", image: '/manus-storage/isuzu_208688e1.png', category: 'Lubrication System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-16', partNumber: '898175-9510', name: 'Oil Pump (High Pressure)', description: "ISUZU 零件。润滑不良/压力异常时更换", image: '/manus-storage/isuzu_208688e1.png', category: 'Lubrication System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-17', partNumber: 'ST40629AB (1421339', name: 'Air Filter (6HK1)', description: "ISUZU 零件。250-500小时或视灰尘环境", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-18', partNumber: 'ST10767 (4484495)', name: 'Oil Filter (6HK1)', description: "ISUZU 零件。250-500小时随保养更换", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-19', partNumber: 'ST29121 (4085912', name: 'Diesel Filter (6HK1 Primary)', description: "ISUZU 零件。250-500小时或视油品", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-20', partNumber: 'ST20304 (4S00483', name: 'Diesel Filter (6HK1 Secondary)', description: "ISUZU 零件。250-500小时", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-21', partNumber: 'ST30855 (4448402', name: 'Hydraulic Oil Filter (6HK1)', description: "ISUZU 零件。500-1000小时或视油液检测", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-22', partNumber: 'ST70810 (4210224)', name: 'Hydraulic Oil Filter (6HK1 Model 2)', description: "ISUZU 零件。500-1000小时", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-23', partNumber: 'ST30807 (4207841', name: 'Pilot Valve Filter (6HK1)', description: "ISUZU 零件。500-1000小时", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-24', partNumber: '1-13201023-0 (1132010230)', name: 'Oil Filter Assembly (6HK1-3rd Gen)', description: "ISUZU 零件。250-500小时随保养更换", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-25', partNumber: 'ST20880 (4679981', name: 'Diesel Filter (6HK1-3rd Gen)', description: "ISUZU 零件。250-500小时", image: '/manus-storage/isuzu_208688e1.png', category: 'Maintenance/Filtration System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-26', partNumber: '8-98042848-2 (1-87310835-0)', name: 'Water Pump Assembly (6HK1)', description: "ISUZU 零件。冷却液渗漏/异响时更换", image: '/manus-storage/isuzu_208688e1.png', category: 'Cooling System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-27', partNumber: '1-13650133-3', name: 'Water Pump Assembly (6HK1 Model 2)', description: "ISUZU 零件。冷却液渗漏/异响时更换", image: '/manus-storage/isuzu_208688e1.png', category: 'Cooling System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-28', partNumber: '8-97627-356-1 (8976273561)', name: 'Water Pump Assembly (6HK1 FVR Truck)', description: "ISUZU 零件。冷却液渗漏/异响时更换", image: '/manus-storage/isuzu_208688e1.png', category: 'Cooling System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-29', partNumber: '8-97515301-1', name: 'Electronic Oil Pump', description: "ISUZU 零件。润滑不良/压力异常时更换(大修类)", image: '/manus-storage/isuzu_208688e1.png', category: 'Lubrication System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-30', partNumber: '8-98091565-1 (8-98091565-0', name: 'Fuel Injection Pump Assembly', description: "ISUZU 零件。喷油不良/启动困难时更换(大修类)", image: '/manus-storage/isuzu_208688e1.png', category: 'Fuel System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-31', partNumber: '8-94392-713-5', name: 'Fuel Injection Pump (Model 2)', description: "ISUZU 零件。喷油不良时更换(大修类)", image: '/manus-storage/isuzu_208688e1.png', category: 'Fuel System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-32', partNumber: '8-97602-049-4', name: 'Fuel Injection Pump (FTR/FXR/FVR Truck)', description: "ISUZU 零件。喷油不良时更换(大修类)", image: '/manus-storage/isuzu_208688e1.png', category: 'Fuel System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-33', partNumber: '1144003900', name: 'Turbocharger (RHG6 Type)', description: "ISUZU 零件。动力下降/异响/漏油时更换(大修类高价件)", image: '/manus-storage/isuzu_208688e1.png', category: 'Intake/Boost System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-34', partNumber: '114400-4050 (1144004050)', name: 'Turbocharger (RHG6, SH300)', description: "ISUZU 零件。动力下降/异响/漏油时更换(大修类)", image: '/manus-storage/isuzu_208688e1.png', category: 'Intake/Boost System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      ...
      { id: 'isuzu-sp-36', partNumber: '1136603321', name: 'Cooling Fan Blade', description: "ISUZU 零件。异响/扇叶断裂时更换", image: '/manus-storage/isuzu_208688e1.png', category: 'Cooling System', compatibleModels: ["Isuzu 6BG1", "6HK1"] },
      { id: 'isuzu-sp-37', partNumber: '1141420320 (1141420280)', name: 'Exhaust Manifold', description: "ISUZU 零件。裂纹/漏气时更换", image: '/manus-storage/isuzu_208688e1.png', category: 'Intake/Exhaust', compatibleModels: ["Isuzu 6BG1", "6HK1"] }
    ]
  },
  {
    id: 'shacman',
    ...
    spareParts: [
      { id: 'shacman-sp-1', partNumber: '4110000556209', name: 'Oil Filter', description: 'Shacman Delong 零件。5,000-10,000km随保养更换', image: '/manus-storage/shacman_273a0f44.png', category: 'Maintenance/Filtration System', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-2', partNumber: '6126300080205', name: 'Diesel Filter', description: 'Shacman Delong 零件。每20,000km或视油品', image: '/manus-storage/shacman_273a0f44.png', category: 'Maintenance/Filtration System', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-3', partNumber: '612630110319', name: 'Air Filter', description: 'Shacman Delong 零件。10,000-20,000km视路况', image: '/manus-storage/shacman_273a0f44.png', category: 'Maintenance/Filtration System', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-4', partNumber: 'DZ91189550169', name: 'Fuel Filter (Oil-Water Separator)', description: 'Shacman Delong 零件。5,000-10,000km,雨季/劣质油缩短', image: '/manus-storage/shacman_273a0f44.png', category: 'Maintenance/Filtration System', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-5', partNumber: 'DZ95009440015', name: 'Brake Pad Spring', description: 'Shacman Delong 零件。随蹄片更换检查', image: '/manus-storage/shacman_273a0f44.png', category: 'Braking System', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-6', partNumber: 'DZ9100189008', name: 'Exhaust Brake Butterfly Valve', description: 'Shacman Delong 零件。异响/制动效果下降时检修', image: '/manus-storage/shacman_273a0f44.png', category: 'Braking System', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-7', partNumber: 'DZ9114160032', name: 'Clutch Disc Assembly', description: 'Shacman Delong 零件。离合器打滑/异响时更换', image: '/manus-storage/shacman_273a0f44.png', category: '传动/离合器', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-8', partNumber: 'DZ97259190435', name: 'Turbo Intake Pipe', description: 'Shacman Delong 零件。漏气/开裂时检修更换', image: '/manus-storage/shacman_273a0f44.png', category: '增压/进气', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-9', partNumber: 'DZ15221443120', name: 'Anti-roll Bar Shock Absorber', description: 'Shacman Delong 零件。异响/漏油时更换', image: '/manus-storage/shacman_273a0f44.png', category: '悬挂减震', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-10', partNumber: 'DZ13241440150', name: 'Rear Suspension Shock Absorber', description: 'Shacman Delong 零件。异响/漏油时更换', image: '/manus-storage/shacman_273a0f44.png', category: '悬挂减震', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-11', partNumber: 'DZ13241440080', name: 'Cabin Rear Shock Absorber', description: 'Shacman Delong 零件。抑制驾驶室晃动,异响时更换', image: '/manus-storage/shacman_273a0f44.png', category: '悬挂减震', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-12', partNumber: 'DZ9X259520006', name: 'Drive Bridge Air Spring (Air Bag)', description: 'Shacman Delong 零件。老化/漏气时更换', image: '/manus-storage/shacman_273a0f44.png', category: '悬挂减震', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-13', partNumber: 'DZ9325952015', name: 'Front Leaf Spring Assembly (with Bracket/Shackle)', description: 'Shacman Delong 零件。下沉/断裂时更换', image: '/manus-storage/shacman_273a0f44.png', category: '悬挂减震', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-14', partNumber: 'DZ15221740011', name: 'Wiper Linkage Assembly (with Motor)', description: 'Shacman Delong 零件。雨刮不工作/异响时更换', image: '/manus-storage/shacman_273a0f44.png', category: '车身/电气', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-15', partNumber: 'D90009410196', name: 'Front Wheel Hub Assembly', description: 'Shacman Delong 零件。异响/轴承间隙过大时更换', image: '/manus-storage/shacman_273a0f44.png', category: '轮毂/传动', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-16', partNumber: 'DZ16231440072', name: 'Height Valve (Air Suspension)', description: 'Shacman Delong 零件。车身高度异常时检修更换', image: '/manus-storage/shacman_273a0f44.png', category: '悬挂系统', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-17', partNumber: 'DZ9114311067', name: 'Drive Shaft Assembly (F3000)', description: 'Shacman Delong 零件。异响/抖动/大修时更换', image: '/manus-storage/shacman_273a0f44.png', category: 'Transmission/Universal Joint', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-18', partNumber: 'AZ9114310125', name: 'Drive Shaft Yoke', description: 'Shacman Delong 零件。传动轴异响时更换', image: '/manus-storage/shacman_273a0f44.png', category: '轮毂/传动轴', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-19', partNumber: '30222(参考件号)', name: 'Front Wheel Bearing Repair Kit', description: 'Shacman Delong 零件。异响/间隙过大时更换,建议核实原厂号', image: '/manus-storage/shacman_273a0f44.png', category: '轮毂/传动轴', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-20', partNumber: '需按VIN核实(标准STR', name: 'Steering Knuckle Arm/Tie Rod (Steering Trapezoid Arm)', description: 'Shacman Delong 零件。转向精度下降/跑偏时检查', image: '/manus-storage/shacman_273a0f44.png', category: '转向系统', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-21', partNumber: '需按前桥型号核实', name: 'Steering King Pin Assembly', description: 'Shacman Delong 零件。转向异响/间隙过大时更换', image: '/manus-storage/shacman_273a0f44.png', category: '转向系统', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      ...
      { id: 'shacman-sp-23', partNumber: '需按发动机型号核实(WD615', name: 'Starter Motor Assembly', description: 'Shacman Delong 零件。启动无力/异响时更换', image: '/manus-storage/shacman_273a0f44.png', category: '电气/启动', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-24', partNumber: '需按发动机型号核实(WD615', name: 'Water Pump Assembly', description: 'Shacman Delong 零件。冷却液渗漏/异响时更换,建议核实VG1500060051是否通用', image: '/manus-storage/shacman_273a0f44.png', category: 'Cooling System', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-25', partNumber: '需按发动机型号核实(WD615', name: '涡轮增压器总成', description: 'Shacman Delong 零件。动力下降/漏油时更换(大修类)', image: '/manus-storage/shacman_273a0f44.png', category: 'Intake/Boost System', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-26', partNumber: '需按桥型核实(参考HOWO WG9000360系列)', name: '制动气室(前/后桥)', description: 'Shacman Delong 零件。刹车异响/漏气时更换', image: '/manus-storage/shacman_273a0f44.png', category: 'Braking System', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-27', partNumber: 'DZ15221740016', name: '前雨刮片', description: 'Shacman Delong 零件。每年或雨季前更换', image: '/manus-storage/shacman_273a0f44.png', category: 'Body/Wiper System', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-28', partNumber: 'DZ14251740013', name: '雨刮臂(SWF)', description: 'Shacman Delong 零件。雨刮不贴合/异响时更换', image: '/manus-storage/shacman_273a0f44.png', category: 'Body/Wiper System', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
  ...
  },
  {
    ...
    spareParts: [
      { id: 'sinotruk-sp-1', partNumber: 'VG61000070005', name: 'Oil Filter', description: "SINOTRUK 零件。5,000-10,000km随保养更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Maintenance/Filtration System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-2', partNumber: 'WG9725190055', name: 'Air Filter Assembly', description: "SINOTRUK 零件。视路况10,000-20,000km", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Maintenance/Filtration System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-3', partNumber: 'WG9925550110', name: 'Diesel Coarse Filter (Water Separator)', description: "SINOTRUK 零件。5,000-10,000km,雨季/劣质油品缩短周期", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Maintenance/Filtration System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-4', partNumber: 'VG1560080012', name: 'Diesel Fine Filter', description: "SINOTRUK 零件。与粗滤器同步更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Maintenance/Filtration System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-5', partNumber: 'VG1095094002', name: 'Alternator (28V/70A)', description: "SINOTRUK 零件。发电异常/异响时检修更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Electrical/Starting System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-6', partNumber: 'VG1560090001', name: 'Starter Motor Assembly', description: "SINOTRUK 零件。启动无力/异响时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Electrical/Starting System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-7', partNumber: 'VG1093130001', name: 'Air Compressor (Twin Cylinder Water Cooled)', description: "SINOTRUK 零件。刹车气压不足/异响时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Intake/Boost System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-8', partNumber: 'AZ9231340200', name: 'Front Brake Shoe Assembly', description: "SINOTRUK 零件。30,000-50,000km或视磨损", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Braking System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-9', partNumber: 'WG9231342069', name: 'Rear Brake Shoe (with Friction Pad)', description: "SINOTRUK 零件。与前片同步检查,重载车型更频繁", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Braking System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-10', partNumber: 'WG9100440001', name: 'Brake Camshaft (Left)', description: "SINOTRUK 零件。随刹车蹄片检查", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Braking System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-11', partNumber: 'WG9231340061', name: 'Brake Gap Auto Adjuster Arm', description: "SINOTRUK 零件。制动异响/行程异常时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Braking System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-12', partNumber: 'WG9000360101', name: 'Brake Air Chamber (Front Axle)', description: "SINOTRUK 零件。刹车异响/漏气时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Braking System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-13', partNumber: 'WG9100443001', name: 'Brake Disc', description: "SINOTRUK 零件。盘面磨损/异响时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Braking System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-14', partNumber: '1601ZB1T-130', name: 'Clutch Pressure Plate Assembly', description: "SINOTRUK 零件。离合器打滑/异响时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Transmission/Clutch', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-15', partNumber: 'WG9100410104', name: 'Clutch Release Bearing (Power Assist)', description: "SINOTRUK 零件。离合器异响/踩踏沉重时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Transmission/Clutch', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-16', partNumber: 'AZ9725529272', name: 'V-shaped Thrust Rod (Stabilizer Link)', description: "SINOTRUK 零件。悬挂异响/跑偏时检查更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Steering/Suspension', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-17', partNumber: 'AZ9738410041', name: 'Steering Knuckle Arm (Left)', description: "SINOTRUK 零件。转向异响/精度下降时", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Steering/Suspension', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-18', partNumber: '179000520040', name: 'Front Leaf Spring Eye Pin', description: "SINOTRUK 零件。钢板弹簧异响/松旷时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Steering/Suspension', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-19', partNumber: 'WG9100520034', name: 'Front Leaf Spring Hanger', description: "SINOTRUK 零件。与销/衬套同步更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Steering/Suspension', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-20', partNumber: 'WG9100410129', name: 'King Pin Bushing', description: "SINOTRUK 零件。转向异响/间隙过大时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Steering/Suspension', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-21', partNumber: 'WG9925680028', name: 'Front Suspension Shock Absorber Assembly', description: "SINOTRUK 零件。异响/漏油时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Suspension/Shock Absorber', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-22', partNumber: 'WG1642440084', name: 'Rear Suspension Shock Absorber Assembly', description: "SINOTRUK 零件。异响/漏油时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Suspension/Shock Absorber', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-23', partNumber: 'WG9725520789', name: 'Rear Leaf Spring Assembly', description: "SINOTRUK 零件。下沉/断裂时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Suspension/Shock Absorber', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-24', partNumber: 'AZ9725520254', name: 'Leaf Spring U-bolt Clamp Plate', description: "SINOTRUK 零件。随弹簧检查更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Suspension/Shock Absorber', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-25', partNumber: 'AZ9761341010', name: 'Rear Axle Half Shaft (Right)', description: "SINOTRUK 零件。异响/断裂时更换(大修类)", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Body/Wiper System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-26', partNumber: 'WG9725310020', name: 'Universal Joint Cross Shaft Assembly', description: "SINOTRUK 零件。传动轴异响/抖动时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Transmission/Universal Joint', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-27', partNumber: 'WG9014310125', name: 'Drive Shaft Assembly (Transmission to Drive Bridge)', description: "SINOTRUK 零件。异响/抖动/大修时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Transmission/Universal Joint', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-28', partNumber: 'VG1500060051', name: 'Water Pump Assembly', description: "SINOTRUK 零件。冷却液渗漏/异响时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Cooling System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-29', partNumber: 'WG1642111011', name: '散热器护罩/水箱罩', description: "SINOTRUK 零件。碰撞/老化开裂时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Cooling System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-30', partNumber: 'VG1540110066', name: '涡轮增压器总成', description: "SINOTRUK 零件。动力下降/异响/漏油时更换(大修类)", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Intake/Boost System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      ...
      { id: 'sinotruk-sp-33', partNumber: 'WG1560161130', name: '离合器从动盘(摩擦片)', description: "SINOTRUK 零件。离合器打滑/异响时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Transmission/Clutch', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-34', partNumber: 'AZ9114230018', name: '离合器助力缸(分离缸)', description: "SINOTRUK 零件。离合器踩踏沉重/异响时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Transmission/Clutch', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-35', partNumber: 'WG9100440027', name: '前刹车摩擦片(内衬)', description: "SINOTRUK 零件。随蹄片检查更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Braking System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-36', partNumber: 'WG9100440030', name: '刹车蹄片总成(带内衬)', description: "SINOTRUK 零件。30,000-50,000km或视磨损", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Braking System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-37', partNumber: 'WG9000360522', name: '驻车/手刹阀', description: "SINOTRUK 零件。驻车异响/失效时检修更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Braking System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-38', partNumber: 'WG9725542041', name: '排气制动阀', description: "SINOTRUK 零件。制动效果下降时检修更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Braking System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
  ...
  },
  {
    ...
    spareParts: [
      { id: 'toyota-sp-1', partNumber: '90915-YZZJ3', name: 'Oil Filter', description: 'Toyota Hilux 零件。5,000-10,000km随保养更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Maintenance/Filtration System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-2', partNumber: '17801-0L040', name: 'Air Filter', description: 'Toyota Hilux 零件。10,000-20,000km或视路况', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Maintenance/Filtration System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-3', partNumber: '23390-0L090', name: 'Diesel Filter (Front)', description: 'Toyota Hilux 零件。每20,000km,柴油车关键件', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Maintenance/Filtration System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-4', partNumber: '87139-0K060', name: 'Air Conditioning/Pollen Filter', description: 'Toyota Hilux 零件。10,000-15,000km', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Maintenance/Filtration System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-5', partNumber: '04426-0L020', name: 'Fuel Pump SCV Valve', description: 'Toyota Hilux 零件。燃油系统故障时更换,注意年款', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Maintenance/Filtration System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-6', partNumber: '90916-T2033', name: 'Fan/Alternator V-Belt', description: 'Toyota Hilux 零件。60,000-100,000km检查', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Transmission/Belt', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-7', partNumber: '13521-0E010(链条张紧齿轮)', name: 'Timing Chain Assembly (Non-Belt)', description: 'Toyota Hilux 零件。链条驱动寿命较长,需定期检查', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Transmission/Belt', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-8', partNumber: '13566-0E010', name: 'Timing Chain Guide', description: 'Toyota Hilux 零件。随链条组件检查', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Transmission/Belt', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-9', partNumber: '13616-0E010', name: 'Crankshaft Timing Gear', description: 'Toyota Hilux 零件。大修时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Transmission/Belt', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-10', partNumber: '04465-0K360', name: 'Front Brake Pad', description: 'Toyota Hilux 零件。30,000-60,000km或视磨损', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Braking System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-11', partNumber: '04495-0K160', name: 'Rear Brake Shoe', description: 'Toyota Hilux 零件。与前片同步检查更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Braking System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-12', partNumber: '47750-0K300', name: 'Brake Wheel Cylinder Assembly (Rear)', description: 'Toyota Hilux 零件。渗油/卡滞时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Braking System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-13', partNumber: '47730-0K300', name: 'Brake Wheel Cylinder Body (Front)', description: 'Toyota Hilux 零件。配合刹车片总成', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Braking System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-14', partNumber: '48510-8Z205', name: 'Front Shock Absorber', description: 'Toyota Hilux 零件。80,000-100,000km或异响时', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Suspension System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-15', partNumber: '48654-0K080', name: 'Front Lower Control Arm Bushing', description: 'Toyota Hilux 零件。悬挂异响、跑偏时检查', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Suspension System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-16', partNumber: '90385-T0014', name: 'Rear Leaf Spring Hanger Bushing', description: 'Toyota Hilux 零件。弹簧异响/下沉时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Suspension System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-17', partNumber: '需按VIN核实', name: 'Shock Absorber Upper Mount (Top Rubber)', description: 'Toyota Hilux 零件。异响/下沉时检查', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Suspension System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-18', partNumber: '45046-09810', name: 'Steering Tie Rod Ball Joint', description: 'Toyota Hilux 零件。方向盘异响/跑偏时检查', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Steering System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-19', partNumber: '45503-0K130', name: 'Steering Gear Tie Rod End', description: 'Toyota Hilux 零件。与拉杆球头配套更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Steering System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-20', partNumber: '45601-35070', name: 'Steering Knuckle Arm (Spindle Arm)', description: 'Toyota Hilux 零件。转向异响/精度下降时', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Steering System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-21', partNumber: '90369-T0003', name: 'Front Wheel Bearing Assembly', description: 'Toyota Hilux 零件。异响/间隙过大时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Wheel Hub/Drive Shaft', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-22', partNumber: '90366-T0060', name: 'Rear Wheel Bearing Assembly (with ABS Ring)', description: 'Toyota Hilux 零件。异响时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Wheel Hub/Drive Shaft', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-23', partNumber: '43040-0K070', name: 'Front CV Constant Velocity Joint', description: 'Toyota Hilux 零件。异响、行驶抖动时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Wheel Hub/Drive Shaft', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-24', partNumber: '43371-0K130', name: 'Drive Shaft Cross Joint (Universal Joint)', description: 'Toyota Hilux 零件。传动轴异响时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Wheel Hub/Drive Shaft', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-25', partNumber: '41110-0K280', name: 'Front Differential Case', description: 'Toyota Hilux 零件。大修/异响时,专业件建议核实VIN', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Differential/Transmission', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-26', partNumber: '41201-09E42', name: 'Differential Gear Assembly', description: 'Toyota Hilux 零件。大修件,非常规易损', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Differential/Transmission', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-27', partNumber: '16100-09711', name: 'Water Pump Assembly', description: 'Toyota Hilux 零件。冷却液渗漏/异响时更换,建议6-8万km检查', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Cooling System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-28', partNumber: '16278-0E010', name: 'Water Bypass Hose', description: 'Toyota Hilux 零件。随水泵一同检查', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Cooling System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-29', partNumber: '16711-0L170', name: 'Radiator Fan Shroud', description: 'Toyota Hilux 零件。风扇异响/散热不良时', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Cooling System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-30', partNumber: '16400-0K350', name: '散热器总成(参考)', description: 'Toyota Hilux 零件。过热/渗漏时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Cooling System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] }
    ]
  },
  {
    id: 'cummins',
    ...
    spareParts: [
      { id: 'cm-sp-1', partNumber: '3415317', name: 'Turbocharger Hose', description: 'Cummins 3415317 - Turbocharger Hose. Turbocharger intake hose connecting the turbocharger to the intake manifold, heat and pressure resistant. Compatible with: Dongfeng Cummins 6CT8.3. Engine Models: 6CT8.3. Specifications: Flexible hose, heat and pressure resistant.', image: '/manus-storage/cummins_3415317_1376ea0d.jpg', category: 'Engine System' },
      { id: 'cm-sp-2', partNumber: '3415347', name: 'Connecting Rod Bearing', description: 'Cummins 3415347 - Connecting Rod Bearing. Engine connecting rod bearing supporting reciprocating rod loads, copper-lead alloy material. Compatible with: Foton Ollin, JAC Ruiling, Shaanxi K3000. Engine Models: ISF 3.8. Specifications: Copper-lead alloy, thickness 1.5mm.', image: '/manus-storage/cummins_3415347_c61c9feb.jpg', category: 'Engine System' },
      { id: 'cm-sp-3', partNumber: '3900227', name: 'Connecting Rod Bolt', description: 'Cummins 3900227 - Connecting Rod Assembly. Engine connecting rod assembly connecting piston to crankshaft, withstanding combustion pressure. Compatible with: Foton Auling, Shaanxi L3000. Engine Models: ISF 3.8. Specifications: Forged steel, length 180mm.', image: '/manus-storage/cummins_3900227_f7751ecf.jpg', category: 'Engine System' },
      { id: 'cm-sp-4', partNumber: '3901969', name: 'Connecting Rod Bearing', description: 'Cummins 3901969 - Piston. Engine piston reciprocating in cylinder, withstanding combustion pressure and thermal load. Compatible with: Shaanxi Delong, Foton Ollin. Engine Models: ISF 3.8. Specifications: Aluminum alloy, diameter 92mm.', image: '/manus-storage/cummins_3901969_08926021.jpg', category: 'Engine System' },
      { id: 'cm-sp-5', partNumber: '3916361', name: 'Water Pump Seal Ring', description: 'Cummins 3916361 - Water Pump Seal Ring. Water pump shaft seal preventing coolant leakage, oil and heat resistant rubber material. Compatible with: Foton Ollin, Shaanxi L3000. Engine Models: ISF 3.8 / 2.8. Specifications: Rubber seal ring, inner diameter 35mm.', image: '/manus-storage/cummins_3916361_5992c0e2.jpg', category: 'Cooling System' },
      { id: 'cm-sp-6', partNumber: '3921652', name: 'Oil Filter', description: 'Cummins 3921652 - Oil Filter. Engine oil filter removing contaminants and metal particles from engine oil. Compatible with: Foton Ollin, JAC Ruiling. Engine Models: ISF 3.8. Specifications: Paper filter element, flow rate 50L/min.', image: '/manus-storage/cummins_3921652_e541402f.jpg', category: 'Engine System' },
      { id: 'cm-sp-7', partNumber: '3928629', name: 'Intake Valve', description: 'Cummins 3928629 - Intake Valve. Engine intake valve controlling intake stroke, heat resistant alloy steel material. Compatible with: Shaanxi K3000, Foton Ollin. Engine Models: ISF 3.8. Specifications: Alloy steel, head diameter 35mm.', image: '/manus-storage/cummins_3928629_7c5fb658.jpg', category: 'Engine System' },
      { id: 'cm-sp-8', partNumber: '3931084', name: 'Fuel Shutoff Solenoid', description: 'Cummins 3931084 - Exhaust Valve. Engine exhaust valve controlling exhaust stroke, high temperature nickel-chromium alloy. Compatible with: Foton Auling, Shaanxi L3000. Engine Models: ISF 3.8. Specifications: Nickel-chromium alloy, head diameter 30mm.', image: '/manus-storage/cummins_3931084_ab1c737d.jpg', category: 'Fuel System' },
      { id: 'cm-sp-9', partNumber: '3934410', name: 'Intake Gasket', description: 'Cummins 3934410 - Intake Manifold Gasket. Intake manifold sealing gasket preventing intake leakage. Compatible with: Shaanxi Delong, Foton Ollin. Engine Models: ISF 3.8. Specifications: Asbestos rubber gasket, thickness 2mm.', image: '/manus-storage/cummins_3934410_9031136d.jpg', category: 'Engine System' },
      { id: 'cm-sp-10', partNumber: '3939181', name: 'Intake Pipe Gasket', description: 'Cummins 3939181 - Intake Thermostat Disc. Intake cooler thermostat disc regulating intake temperature. Compatible with: Shaanxi K3000, Foton Ollin. Engine Models: ISF 3.8. Specifications: Brass disc, thickness 0.5mm.', image: '/manus-storage/cummins_3939181_8ae4b69d.jpg', category: 'Engine System' },
      { id: 'cm-sp-11', partNumber: '3940639', name: 'Fuel Pump Gasket', description: 'Cummins 3940639 - Fuel Tube. High pressure fuel tube connecting fuel pump to injector, withstanding high pressure. Compatible with: Foton Ollin, JAC Ruiling. Engine Models: ISF 3.8. Specifications: High pressure steel tube, working pressure 200bar.', image: '/manus-storage/cummins_3940639_e9db0c0b.jpg', category: 'Fuel System' },
      { id: 'cm-sp-12', partNumber: '3944001', name: 'Fuel Overflow Valve', description: 'Cummins 3944001 - Fuel Filter. Engine fuel filter removing fuel contaminants. Compatible with: Shaanxi K3000, Foton Ollin. Engine Models: ISF 3.8. Specifications: Paper filter element, filtration accuracy 10μm.', image: '/manus-storage/cummins_3944001_6772d94a.jpg', category: 'Fuel System' },
      { id: 'cm-sp-13', partNumber: '3945917', name: 'Main Bearing Set', description: 'Cummins 3945917 - Main Bearing Set. Crankshaft main bearing supporting crankshaft rotation, copper-lead alloy. Compatible with: Foton Ollin, JAC Ruiling. Engine Models: ISF 3.8. Specifications: Copper-lead alloy, thickness 2mm.', image: '/manus-storage/cummins_3945617_19ad025e.jpg', category: 'Engine System' },
      { id: 'cm-sp-15', partNumber: '3945918', name: 'Oil Pan Gasket', description: 'Cummins 3945918 - Oil Pan Gasket. Oil pan sealing gasket preventing oil leakage. Compatible with: Shaanxi K3000, Foton Ollin. Engine Models: ISF 3.8. Specifications: Silicone rubber gasket, thickness 3mm.', image: '/manus-storage/cummins_3945918_1cf3e640.jpg', category: 'Engine System' },
      { id: 'cm-sp-16', partNumber: '3945967', name: 'Cylinder Head Gasket', description: 'Cummins 3945967 - Fuel Low Pressure Tube. Fuel low pressure tube connecting fuel tank to fuel pump. Compatible with: Foton Ollin F3000, JAC Ruiling. Engine Models: ISF / L. Specifications: Rubber hose, inner diameter 8mm.', image: '/manus-storage/cummins_3945967_649dccda.jpg', category: 'Engine System' },
      { id: 'cm-sp-17', partNumber: '3950661', name: 'Front Oil Seal', description: 'Cummins 3950661 - Connecting Rod Bearing Set. Connecting rod bearing supporting rod rotation, copper-lead alloy material. Compatible with: Foton Ollin, JAC Ruiling. Engine Models: ISF 3.8. Specifications: Copper-lead alloy, thickness 1.5mm.', image: '/manus-storage/part_3950661_170_6065a594.jpg', category: 'Engine System' },
      { id: 'cm-sp-19', partNumber: '3957290', name: 'Front Oil Seal', description: 'Cummins 3957290 - Front Oil Seal. Crankshaft front end oil seal preventing oil leakage from crankshaft front. Compatible with: Shaanxi K3000, Foton Ollin. Engine Models: ISF 3.8. Specifications: Fluorine rubber oil seal, inner diameter 40mm.', image: '/manus-storage/cummins_3957290_c78509bb.jpg', category: 'Engine System' },
      { id: 'cm-sp-20', partNumber: '3964715', name: 'Exhaust Valve Push Rod', description: 'Cummins 3964715 - Exhaust Valve Push Rod. Engine exhaust valve push rod transmitting camshaft motion to exhaust valve. Compatible with: Foton Ollin, Shaanxi L3000. Engine Models: ISF 3.8. Specifications: Alloy steel, length 250mm.', image: '/manus-storage/bh6ks02TyHvK_904e11da.png', category: 'Engine System' },
      { id: 'cm-sp-21', partNumber: '3965966', name: 'Belt Tensioner', description: 'Cummins 3965966 - Oil Cooler. Oil cooler reducing oil temperature, aluminum shell construction. Compatible with: Shaanxi Delong, Foton Ollin. Engine Models: ISF 3.8. Specifications: Aluminum, flow rate 50L/min.', image: '/manus-storage/cummins_3965966_90512daa.jpg', category: 'Engine System' },
      { id: 'cm-sp-22', partNumber: '3967252', name: 'Oil Cooler Core', description: 'Cummins 3967252 - Oil Pressure Sensor. Oil pressure sensor monitoring engine oil pressure. Compatible with: Foton Ollin, JAC Ruiling. Engine Models: ISF 3.8. Specifications: Electronic sensor, working temperature -40~120℃.', image: '/manus-storage/cummins_3967252_4e371f9c.jpg', category: 'Cooling System' },
      { id: 'cm-sp-23', partNumber: '3968559', name: 'Oil Pressure Sensor', description: 'Cummins 3968559 - Piston Ring. Engine piston ring sealing piston and cylinder, preventing gas leakage. Compatible with: Shaanxi K3000, Foton Ollin. Engine Models: ISF 3.8. Specifications: Cast iron, thickness 1.5mm.', image: '/manus-storage/cummins_3968559_6252712e.jpg', category: 'Engine System' },
      { id: 'cm-sp-24', partNumber: '3972125', name: 'High Pressure Oil Tube', description: 'Cummins 3972125 - High Pressure Oil Tube. Injector high pressure oil tube connecting fuel pump to injector. Compatible with: Foton Ollin, JAC Ruiling. Engine Models: ISF 3.8. Specifications: High pressure steel tube, working pressure 250bar.', image: '/manus-storage/cummins_3972125_e7990527.jpg', category: 'Fuel System' },
      { id: 'cm-sp-25', partNumber: '3972777', name: 'Fuel Tube', description: 'Cummins 3972777 - Fuel Tube. Engine fuel tube delivering high pressure fuel to injector. Compatible with: Shaanxi K3000, Foton Ollin. Engine Models: ISF 3.8. Specifications: High pressure steel tube, working pressure 200bar.', image: '/manus-storage/cummins_3972777_60bef43e.jpg', category: 'Fuel System' },
      { id: 'cm-sp-26', partNumber: '3979176', name: 'Fan Belt', description: 'Cummins 3979176 - Valve Oil Seal. Valve stem oil seal preventing oil from entering cylinder. Compatible with: Foton Ollin, JAC Ruiling. Engine Models: ISF 3.8. Specifications: Fluorine rubber oil seal, inner diameter 8mm.', image: '/manus-storage/cummins_3979176_bffadba2.jpg', category: 'Engine System' },
      { id: 'cm-sp-27', partNumber: '4931169', name: 'Piston Assembly', description: 'Cummins 4931169 - Piston Pin. Piston pin connecting piston to connecting rod. Compatible with: Shaanxi Delong, Foton Ollin. Engine Models: ISF 3.8. Specifications: Alloy steel, diameter 20mm.', image: '/manus-storage/cummins_4931169_cff9f6b0.jpg', category: 'Engine System' },
      { id: 'cm-sp-28', partNumber: '4934058', name: 'Piston Cooling Nozzle', description: 'Cummins 4934058 - Piston Cooling Nozzle. Piston cooling nozzle spraying oil to cool piston. Compatible with: Foton Ollin, JAC Ruiling. Engine Models: ISF 3.8. Specifications: Copper nozzle, oil spray rate 0.5L/min.', image: '/manus-storage/cummins_4934058_74c8ce70.jpg', category: 'Engine System' },
      { id: 'cm-sp-29', partNumber: '4941464', name: 'Cylinder Head Bolt', description: 'Cummins 4941464 - Cylinder Liner. Engine cylinder liner providing piston movement space. Compatible with: Shaanxi K3000, Foton Ollin. Engine Models: ISF 3.8. Specifications: Cast iron, wall thickness 5mm.', image: '/manus-storage/cummins_4941464_b12100d6.jpg', category: 'Engine System' },
      { id: 'cm-sp-30', partNumber: '4981794', name: 'Connecting Rod Assembly', description: 'Cummins 4981794 - Intake Valve. Engine intake valve controlling intake stroke, heat resistant alloy steel. Compatible with: Foton Ollin, Shaanxi L3000. Engine Models: ISF 3.8. Specifications: Alloy steel, head diameter 35mm.', image: '/manus-storage/4981794(2)_cd8e079b.webp', category: 'Engine System' },
      { id: 'cm-sp-31', partNumber: '4981795', name: 'Connecting Rod Bearing', description: 'Cummins 4981795 - Connecting Rod Bearing. Engine connecting rod bearing supporting reciprocating rod loads. Compatible with: Foton Ollin, JAC Ruiling, Shaanxi K3000. Engine Models: ISF 3.8. Specifications: Copper-lead alloy, thickness 1.5mm.', image: '/manus-storage/cummins_4981795_340aae63.jpg', category: 'Engine System' },
      { id: 'cm-sp-32', partNumber: '4987914', name: 'Main Bearing', description: 'Cummins 4987914 - Main Bearing. Crankshaft main bearing supporting crankshaft rotation. Compatible with: Foton Auling, Shaanxi L3000. Engine Models: ISF 3.8. Specifications: Copper-lead alloy, thickness 2mm.', image: '/manus-storage/cummins_4987914_fe46f482.jpg', category: 'Engine System' },
      { id: 'cm-sp-33', partNumber: '4987917', name: 'Thrust Washer', description: 'Cummins 4987917 - Thrust Washer. Crankshaft thrust washer limiting crankshaft axial movement. Compatible with: Foton Ollin, JAC Junling. Engine Models: ISF 3.8. Specifications: Bronze washer, thickness 3mm.', image: '/manus-storage/cummins_4987917_d7d1a945.jpg', category: 'Engine System' },
      { id: 'cm-sp-34', partNumber: '4988747', name: 'Oil Pump', description: 'Cummins 4988747 - Oil Pump. Engine oil pump for circulation, gear pump design. Compatible with: Shaanxi Delong K3000, Foton Ollin. Engine Models: ISF 3.8. Specifications: Gear pump, flow rate 60L/min.', image: '/manus-storage/cummins_4988747_3766fb1d.jpg', category: 'Lubrication System' },
      { id: 'cm-sp-35', partNumber: '5320276', name: 'Water Pump Assembly', description: 'Cummins 5320276 - Water Pump Assembly. Engine cooling water pump circulating coolant, aluminum pump body. Compatible with: Foton Ollin, Shaanxi L3000. Engine Models: ISF 3.8 / 2.8. Specifications: Aluminum pump body, flow rate 80L/min.', image: '/manus-storage/cummins_5320276_5b9a1160.jpg', category: 'Cooling System' },
    ]
  },
  {
    id: 'weichai',
    ...
    spareParts: [
      { id: 'weichai-sp-1', partNumber: '61000070005(替代号W962', name: 'Oil Filter', description: "WEICHAI 零件。250-500小时随保养更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-2', partNumber: '612630080088(PRELINE 420,替代号PL420', name: 'Diesel Filter (WP10 Specific)', description: "WEICHAI 零件。250-500小时或视油品", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-3', partNumber: '612600081334(替代号FF5622', name: 'Diesel Filter (Universal)', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-4', partNumber: '612630080087(替代号WDK11102', name: 'Diesel Filter (Model 2)', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-5', partNumber: '612630080203(替代号CX1016E4', name: 'Diesel Filter (Model 3)', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-6', partNumber: '612630080205(替代号1111474)', name: 'Diesel Filter (Model 4)', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-7', partNumber: '612600081335(PRELINE 420,替代号PL420', name: 'Diesel Filter Assembly', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-8', partNumber: '612630060015(替代号PROVENT200', name: 'Oil-Gas Separator Filter', description: "WEICHAI 零件。500-1000小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-9', partNumber: '612630060138', name: 'Oil-Gas Separator Filter (Model 2)', description: "WEICHAI 零件。500-1000小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-10', partNumber: '612630010239(替代号W11170', name: 'Oil Filter (Universal Variant)', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-11', partNumber: '612600081335A', name: 'Diesel Filter (WP4/WP6/WD615/WD10/WP10/WP12 Universal)', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-12', partNumber: '1000402861', name: 'Water Pump Assembly', description: "WEICHAI 零件。冷却液渗漏/异响时更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Cooling System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-13', partNumber: '612600061872', name: 'Water Pump Assembly (WD12/WP12 Specific)', description: "WEICHAI 零件。冷却液渗漏/异响时更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Cooling System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-14', partNumber: '612600140062', name: 'Thermostat (Temperature Regulator)', description: "WEICHAI 零件。水温异常/过热时更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Cooling System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-15', partNumber: '615G00060016', name: 'Thermostat Assembly (WD615)', description: "WEICHAI 零件。水温异常/过热时更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Cooling System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-16', partNumber: '61200100157', name: 'Fan Hydraulic Drive Assembly (Clutch Fan)', description: "WEICHAI 零件。散热异响/风扇打滑时更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Transmission/Belt', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-17', partNumber: '612600090206D', name: 'Alternator Assembly (28V/70A)', description: "WEICHAI 零件。发电异常/异响时更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Electrical/Starting System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-18', partNumber: '61560080276(替代号Kbel132p110)', name: 'Fuel Injector', description: "WEICHAI 零件。喷油不良/启动困难时更换(2000小时检查/4000-6000小时更换)", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Fuel System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-19', partNumber: '1000000623', name: 'Injector Nozzle', description: "WEICHAI 零件。随喷油器周期检查更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Fuel System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-20', partNumber: '1002018309(612600081327)', name: 'Fuel Filter Element (Assembly Type)', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Fuel System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-21', partNumber: '612600190222', name: 'ECU Electronic Control Unit', description: "WEICHAI 零件。故障灯报警/无法启动时检修更换(大修类高价件)", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Fuel System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-22', partNumber: '612600080611', name: 'Turbocharger (WP10)', description: "WEICHAI 零件。动力下降/异响/漏油时更换(大修类高价件)", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Intake/Boost System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-23', partNumber: '1001248542', name: 'Turbocharger (High Altitude Type)', description: "WEICHAI 零件。动力下降/异响/漏油时更换(大修类)", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Intake/Boost System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-24', partNumber: '1001740613', name: 'Oil Filter (Assembly Type)', description: "WEICHAI 零件。250-500小时随保养更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Lubrication System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-25', partNumber: '61500010100', name: 'Rear Crankshaft Oil Seal', description: "WEICHAI 零件。大修/漏油时更换(大修类)", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Sealing/Drive Components', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-26', partNumber: '4110000556111(61500030009', name: 'Connecting Rod Assembly', description: "WEICHAI 零件。大修类,异响/敲缸时检修更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Transmission/Piston Assembly', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-27', partNumber: '612600900072', name: 'Cylinder Liner Piston Assembly Kit', description: "WEICHAI 零件。大修类,烧机油/功率下降时更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Transmission/Piston Assembly', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-28', partNumber: '612600030150', name: 'Piston (Standard Size)', description: "WEICHAI 零件。大修类,烧机油/敲缸时更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Transmission/Piston Assembly', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-29', partNumber: 'Z20050060', name: 'Piston Ring', description: "WEICHAI 零件。大修类,机油消耗异常时更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Transmission/Piston Assembly', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-30', partNumber: '61500010344', name: 'Water Cooled Cylinder Liner', description: "WEICHAI 零件。大修类,烧机油/缸压不足时更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Transmission/Piston Assembly', compatibleModels: ["Weichai WP10", "WP12"] }
    ]
  },
];

...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    spareParts: [
      { id: 'cm-sp-1', partNumber: '3415317', name: '活塞环', description: 'Cummins 3415317 - 活塞环. Compatible with: 陕汽德龙 X3000/F3000、重汽豪沃 A7 (西康版). Engine Models: ISM11 / QSM11.', image: '/manus-storage/part_3415317_154_9fe64787.jpg', category: 'Engine System' },
      { id: 'cm-sp-2', partNumber: '3415347', name: '连杆瓦', description: 'Cummins 3415347 - 连杆瓦. Compatible with: 陕汽德龙 F3000、金龙/宇通 大型客车. Engine Models: ISM11 / QSM11.', image: '/manus-storage/part_3415347_155_41569fd2.jpg', category: 'Engine System' },
      { id: 'cm-sp-3', partNumber: '3900227', name: '连杆螺栓', description: 'Cummins 3900227 - 连杆螺栓. Compatible with: 东风天龙 (DFL4251)、陕汽德龙 F2000. Engine Models: 6CT / ISLe / L8.9.', image: '/manus-storage/part_3900227_156_f83b6b14.png', category: 'Engine System' },
      { id: 'cm-sp-4', partNumber: '3901969', name: '连杆瓦', description: 'Cummins 3901969 - 连杆瓦. Compatible with: 东风 EQ1141 (多利卡/天锦中卡系列). Engine Models: 4BT / 6BT 5.9.', image: '/manus-storage/part_3901969_157_2cf08560.jpg', category: 'Engine System' },
      { id: 'cm-sp-5', partNumber: '3916361', name: '水泵密封圈', description: 'Cummins 3916361 - 水泵密封圈. Compatible with: 陕汽德龙 F3000、东风天龙、徐工 压路机. Engine Models: 6CT / 6L / ISLe.', image: '/manus-storage/part_3916361_158_9c38a01a.jpg', category: 'Cooling System' },
      { id: 'cm-sp-6', partNumber: '3921652', name: '气门油封', description: 'Cummins 3921652 - 气门油封. Compatible with: 重汽豪沃 (康明斯版)、陕汽 M3000 / X3000. Engine Models: 6CT / 6L / ISLe.', image: '/manus-storage/part_3921652_159_aa80a321.jpg', category: 'Engine System' },
      { id: 'cm-sp-7', partNumber: '3928629', name: '气门室盖垫', description: 'Cummins 3928629 - 气门室盖垫. Compatible with: 东风天龙、陕汽德龙 F2000/F3000. Engine Models: 6CT / 6L / ISC.', image: '/manus-storage/part_3928629_160_71562640.jpg', category: 'Engine System' },
      { id: 'cm-sp-8', partNumber: '3931084', name: '熄火电磁阀', description: 'Cummins 3931084 - 熄火电磁阀. Compatible with: 陕汽德龙 F2000、柳工/厦工 装载机. Engine Models: 6CT / 6L (24V).', image: '/manus-storage/part_3931084_161_46487d4e.jpg', category: 'Fuel System' },
      { id: 'cm-sp-9', partNumber: '3934410', name: '进气垫片', description: 'Cummins 3934410 - 进气垫片. Compatible with: 重汽豪沃、陕汽德龙、中通 客车. Engine Models: 6BT / 6CT / 6L.', image: '/manus-storage/part_3934410_162_ea34ae8b.jpg', category: 'Engine System' },
      { id: 'cm-sp-10', partNumber: '3939181', name: '进气管垫片', description: 'Cummins 3939181 - 进气管垫片. Compatible with: 陕汽德龙 M3000、东风天锦. Engine Models: ISBe / ISDe.', image: '/manus-storage/part_3939181_163_e799bfb0.jpg', category: 'Engine System' },
      { id: 'cm-sp-11', partNumber: '3940639', name: '燃油泵垫片', description: 'Cummins 3940639 - 燃油泵垫片. Compatible with: 福田欧曼、江淮 帅铃 (出口版). Engine Models: ISBe / ISDe / QSB.', image: '/manus-storage/part_3940639_164_dca46b73.jpg', category: 'Fuel System' },
      { id: 'cm-sp-12', partNumber: '3944001', name: '燃油溢流阀', description: 'Cummins 3944001 - 燃油溢流阀. Compatible with: 陕汽德龙 X3000、东风天龙 VL. Engine Models: ISLe / L系列.', image: '/manus-storage/part_3944001_165_8b674123.jpg', category: 'Fuel System' },
      { id: 'cm-sp-13', partNumber: '3945617', name: '喷油器O型圈', description: 'Cummins 3945617 - 喷油器O型圈. Compatible with: 重汽豪沃 T7H、陕汽德龙 X3000. Engine Models: ISL / QSL / ISC.', image: '/manus-storage/part_3945617_166_69a8d54a.jpg', category: 'Fuel System' },
      { id: 'cm-sp-14', partNumber: '3945629', name: '喷油器密封垫', description: 'Cummins 3945629 - 喷油器密封垫. Compatible with: 重汽豪沃 TH7、陕汽 X3000. Engine Models: ISL / QSL / L8.9.', image: '/manus-storage/part_3945629_167_03fc5946.jpg', category: 'Fuel System' },
      { id: 'cm-sp-15', partNumber: '3945918', name: '油底壳垫片', description: 'Cummins 3945918 - 油底壳垫片. Compatible with: 陕汽德龙 F3000 / M3000. Engine Models: ISL / ISLe.', image: '/manus-storage/part_3945918_168_1e5310e8.png', category: 'Engine System' },
      { id: 'cm-sp-16', partNumber: '3945967', name: '汽缸垫', description: 'Cummins 3945967 - 汽缸垫. Compatible with: 陕汽德龙 X3000 (375/420马力版). Engine Models: ISLe 8.9.', image: '/manus-storage/part_3945967_169_dbef1120.jpg', category: 'Engine System' },
      ...
      { id: 'cm-sp-18', partNumber: '3950664', name: '后油封', description: 'Cummins 3950664 - 后油封. Compatible with: 陕汽德龙 F3000、重汽豪沃 (L机版). Engine Models: ISLe / L8.9.', image: '/manus-storage/part_3950664_171_426d1144.png', category: 'Engine System' },
      { id: 'cm-sp-19', partNumber: '3957290', name: '进气门', description: 'Cummins 3957290 - 进气门. Compatible with: 重汽豪沃 T7H、陕汽德龙 X3000. Engine Models: ISL / ISLe / QSL9.', image: '/manus-storage/part_3957290_172_a674d2ca.jpg', category: 'Engine System' },
      { id: 'cm-sp-20', partNumber: '3964715', name: '排气门', description: 'Cummins 3964715 - 排气门. Compatible with: 重汽豪沃 T7H、陕汽德龙 X3000. Engine Models: ISL / ISLe / QSL9.', image: '/manus-storage/part_3964715_173_c35fd7db.jpg', category: 'Engine System' },
      { id: 'cm-sp-21', partNumber: '3965966', name: '皮带张紧器', description: 'Cummins 3965966 - 皮带张紧器. Compatible with: 陕汽德龙 X3000、东风天龙旗舰版. Engine Models: ISLe / L系列.', image: '/manus-storage/part_3965966_174_ccb06152.jpg', category: 'Engine System' },
      { id: 'cm-sp-22', partNumber: '3967252', name: '机油冷却器芯', description: 'Cummins 3967252 - 机油冷却器芯. Compatible with: 陕汽德龙 F3000、山推 推土机. Engine Models: ISL / ISLe / 6L.', image: '/manus-storage/part_3967252_175_16ef4685.jpg', category: 'Cooling System' },
      { id: 'cm-sp-23', partNumber: '3968559', name: '机油压力传感器', description: 'Cummins 3968559 - 机油压力传感器. Compatible with: 陕汽德龙 全系列 (F/M/X3000). Engine Models: ISL / ISMe / ISF.', image: '/manus-storage/part_3968559_176_7b18dbe0.jpg', category: 'Engine System' },
      { id: 'cm-sp-24', partNumber: '3972125', name: '高压油管', description: 'Cummins 3972125 - 高压油管. Compatible with: 东风天锦、陕汽 K3000. Engine Models: ISDe / ISBe.', image: '/manus-storage/part_3972125_177_404a8d14.jpg', category: 'Fuel System' },
      { id: 'cm-sp-25', partNumber: '3972777', name: '燃油管', description: 'Cummins 3972777 - 燃油管. Compatible with: 陕汽德龙 X3000、江淮 重卡. Engine Models: ISLe / L系列.', image: '/manus-storage/part_3972777_178_1ca63981.jpg', category: 'Fuel System' },
      { id: 'cm-sp-26', partNumber: '3979176', name: '风扇皮带', description: 'Cummins 3979176 - 风扇皮带. Compatible with: 重汽豪沃 7 系列、陕汽德龙 F3000. Engine Models: ISLe / L8.9.', image: '/manus-storage/part_3979176_179_e4a73411.jpg', category: 'Engine System' },
      { id: 'cm-sp-27', partNumber: '4931169', name: '活塞组件', description: 'Cummins 4931169 - 活塞组件. Compatible with: 陕汽德龙 L3000、东风 天锦. Engine Models: ISB / ISDe.', image: '/manus-storage/part_4931169_180_a7dc1326.jpg', category: 'Engine System' },
      { id: 'cm-sp-28', partNumber: '4934058', name: '活塞冷却喷嘴', description: 'Cummins 4934058 - 活塞冷却喷嘴. Compatible with: 陕汽德龙 L3000、福田 瑞沃. Engine Models: ISB / ISDe.', image: '/manus-storage/part_4934058_181_49c14029.jpg', category: 'Engine System' },
      { id: 'cm-sp-29', partNumber: '4941464', name: '缸盖螺栓', description: 'Cummins 4941464 - 缸盖螺栓. Compatible with: 东风天锦、陕汽 中型载货车. Engine Models: ISDe / ISB.', image: '/manus-storage/part_4941464_182_ea0f5b50.jpg', category: 'Engine System' },
      { id: 'cm-sp-30', partNumber: '4981794', name: '连杆总成', description: 'Cummins 4981794 - 连杆总成. Compatible with: 福田欧马可 S5、陕汽 K3000. Engine Models: ISF 3.8.', image: '/manus-storage/part_4981794_183_7edc4b17.jpg', category: 'Engine System' },
      { id: 'cm-sp-31', partNumber: '4981795', name: '连杆瓦', description: 'Cummins 4981795 - 连杆瓦. Compatible with: 福田欧马可、江淮 帅铃、陕汽 K3000. Engine Models: ISF 3.8.', image: '/manus-storage/part_4981795_184_f280fe0e.jpg', category: 'Engine System' },
      { id: 'cm-sp-32', partNumber: '4987914', name: '主轴瓦', description: 'Cummins 4987914 - 主轴瓦. Compatible with: 福田奥铃、陕汽 L3000 (ISF版). Engine Models: ISF 3.8.', image: '/manus-storage/part_4987914_185_102e745a.jpg', category: 'Engine System' },
      { id: 'cm-sp-33', partNumber: '4987917', name: '止推片', description: 'Cummins 4987917 - 止推片. Compatible with: 福田欧马可、江淮 骏铃. Engine Models: ISF 3.8.', image: '/manus-storage/part_4987917_186_61941368.png', category: 'Engine System' },
      { id: 'cm-sp-34', partNumber: '4988747', name: '机油泵', description: 'Cummins 4988747 - 机油泵. Compatible with: 陕汽德龙 K3000、福田欧马可. Engine Models: ISF 3.8.', image: '/manus-storage/part_4988747_187_8c75a150.jpg', category: 'Lubrication System' },
      { id: 'cm-sp-35', partNumber: '5320276', name: '水泵总成', description: 'Cummins 5320276 - 水泵总成. Compatible with: 福田欧马可、陕汽 L3000. Engine Models: ISF 3.8 / 2.8.', image: '/manus-storage/part_5320276_188_2ed9efa0.jpg', category: 'Cooling System' },
    ]
  },
  {
    id: 'weichai',

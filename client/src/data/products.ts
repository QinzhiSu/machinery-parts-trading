...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    spareParts: [
      { id: 'cm-sp-1', partNumber: '3415317', name: '活塞环', description: 'Cummins 3415317 - 活塞环. Compatible with: 陕汽德龙 X3000/F3000、重汽豪沃 A7 (西康版). Engine Models: ISM11 / QSM11.', image: '/manus-storage/Cummins_3415317_活塞环_9e4bd1ec.jpg', category: 'Engine System' },
      { id: 'cm-sp-2', partNumber: '3415347', name: '连杆瓦', description: 'Cummins 3415347 - 连杆瓦. Compatible with: 陕汽德龙 F3000、金龙/宇通 大型客车. Engine Models: ISM11 / QSM11.', image: '/manus-storage/Cummins_3415347_连杆瓦_c5c9d982.jpg', category: 'Engine System' },
      { id: 'cm-sp-3', partNumber: '3900227', name: '连杆螺栓', description: 'Cummins 3900227 - 连杆螺栓. Compatible with: 东风天龙 (DFL4251)、陕汽德龙 F2000. Engine Models: 6CT / ISLe / L8.9.', image: '/manus-storage/Cummins_3900227_连杆螺栓_14c7d8b4.png', category: 'Engine System' },
      { id: 'cm-sp-4', partNumber: '3901969', name: '连杆瓦', description: 'Cummins 3901969 - 连杆瓦. Compatible with: 东风 EQ1141 (多利卡/天锦中卡系列). Engine Models: 4BT / 6BT 5.9.', image: '/manus-storage/Cummins_3901969_连杆瓦_d0ef1f54.jpg', category: 'Engine System' },
      { id: 'cm-sp-5', partNumber: '3916361', name: '水泵密封圈', description: 'Cummins 3916361 - 水泵密封圈. Compatible with: 陕汽德龙 F3000、东风天龙、徐工 压路机. Engine Models: 6CT / 6L / ISLe.', image: '/manus-storage/Cummins_3916361_水泵密封圈_6da65acd.jpg', category: 'Cooling System' },
      { id: 'cm-sp-6', partNumber: '3921652', name: '气门油封', description: 'Cummins 3921652 - 气门油封. Compatible with: 重汽豪沃 (康明斯版)、陕汽 M3000 / X3000. Engine Models: 6CT / 6L / ISLe.', image: '/manus-storage/Cummins_3921652_气门油封_a424f036.jpg', category: 'Engine System' },
      { id: 'cm-sp-7', partNumber: '3928629', name: '气门室盖垫', description: 'Cummins 3928629 - 气门室盖垫. Compatible with: 东风天龙、陕汽德龙 F2000/F3000. Engine Models: 6CT / 6L / ISC.', image: '/manus-storage/Cummins_3928629_气门室盖垫_3eb34319.jpg', category: 'Engine System' },
      { id: 'cm-sp-8', partNumber: '3931084', name: '熄火电磁阀', description: 'Cummins 3931084 - 熄火电磁阀. Compatible with: 陕汽德龙 F2000、柳工/厦工 装载机. Engine Models: 6CT / 6L (24V).', image: '/manus-storage/Cummins_3931084_熄火电磁阀_78274bd5.jpg', category: 'Fuel System' },
      { id: 'cm-sp-9', partNumber: '3934410', name: '进气垫片', description: 'Cummins 3934410 - 进气垫片. Compatible with: 重汽豪沃、陕汽德龙、中通 客车. Engine Models: 6BT / 6CT / 6L.', image: '/manus-storage/Cummins_3934410_进气垫片_a5ecd055.jpg', category: 'Engine System' },
      { id: 'cm-sp-10', partNumber: '3939181', name: '进气管垫片', description: 'Cummins 3939181 - 进气管垫片. Compatible with: 陕汽德龙 M3000、东风天锦. Engine Models: ISBe / ISDe.', image: '/manus-storage/Cummins_3939181_进气管垫片_a719efca.jpg', category: 'Engine System' },
      { id: 'cm-sp-11', partNumber: '3940639', name: '燃油泵垫片', description: 'Cummins 3940639 - 燃油泵垫片. Compatible with: 福田欧曼、江淮 帅铃 (出口版). Engine Models: ISBe / ISDe / QSB.', image: '/manus-storage/Cummins_3940639_燃油泵垫片_21c6fe12.jpg', category: 'Fuel System' },
      { id: 'cm-sp-12', partNumber: '3944001', name: '燃油溢流阀', description: 'Cummins 3944001 - 燃油溢流阀. Compatible with: 陕汽德龙 X3000、东风天龙 VL. Engine Models: ISLe / L系列.', image: '/manus-storage/Cummins_3944001_燃油溢流阀_6da75293.jpg', category: 'Fuel System' },
      { id: 'cm-sp-13', partNumber: '3945617', name: '喷油器O型圈', description: 'Cummins 3945617 - 喷油器O型圈. Compatible with: 重汽豪沃 T7H、陕汽德龙 X3000. Engine Models: ISL / QSL / ISC.', image: '/manus-storage/Cummins_3945617_喷油器O型圈_1dc22ae9.jpg', category: 'Fuel System' },
      { id: 'cm-sp-14', partNumber: '3945629', name: '喷油器密封垫', description: 'Cummins 3945629 - 喷油器密封垫. Compatible with: 重汽豪沃 TH7、陕汽 X3000. Engine Models: ISL / QSL / L8.9.', image: '/manus-storage/Cummins_3945629_喷油器密封垫_f025a6b3.jpg', category: 'Fuel System' },
      { id: 'cm-sp-15', partNumber: '3945918', name: '油底壳垫片', description: 'Cummins 3945918 - 油底壳垫片. Compatible with: 陕汽德龙 F3000 / M3000. Engine Models: ISL / ISLe.', image: '/manus-storage/Cummins_3945918_油底壳垫片_40825ca5.png', category: 'Engine System' },
      { id: 'cm-sp-16', partNumber: '3945967', name: '汽缸垫', description: 'Cummins 3945967 - 汽缸垫. Compatible with: 陕汽德龙 X3000 (375/420马力版). Engine Models: ISLe 8.9.', image: '/manus-storage/Cummins_3945967_汽缸垫_1ea2c9d1.jpg', category: 'Engine System' },
      { id: 'cm-sp-17', partNumber: '3950661', name: '前油封', description: 'Cummins 3950661 - 前油封. Compatible with: 陕汽德龙 F3000、宇通 采矿车. Engine Models: ISLe / QSL9.', image: '/manus-storage/Cummins_3950661_前油封_b8bbf6c1.jpg', category: 'Engine System' },
      { id: 'cm-sp-18', partNumber: '3950664', name: '后油封', description: 'Cummins 3950664 - 后油封. Compatible with: 陕汽德龙 F3000、重汽豪沃 (L机版). Engine Models: ISLe / L8.9.', image: '/manus-storage/Cummins_3950664_后油封_dff51985.png', category: 'Engine System' },
      { id: 'cm-sp-19', partNumber: '3957290', name: '进气门', description: 'Cummins 3957290 - 进气门. Compatible with: 重汽豪沃 T7H、陕汽德龙 X3000. Engine Models: ISL / ISLe / QSL9.', image: '/manus-storage/Cummins_3957290_进气门_43820ee9.jpg', category: 'Engine System' },
      { id: 'cm-sp-20', partNumber: '3964715', name: '排气门', description: 'Cummins 3964715 - 排气门. Compatible with: 重汽豪沃 T7H、陕汽德龙 X3000. Engine Models: ISL / ISLe / QSL9.', image: '/manus-storage/Cummins_3964715_排气门_8cc4a355.jpg', category: 'Engine System' },
      { id: 'cm-sp-21', partNumber: '3965966', name: '皮带张紧器', description: 'Cummins 3965966 - 皮带张紧器. Compatible with: 陕汽德龙 X3000、东风天龙旗舰版. Engine Models: ISLe / L系列.', image: '/manus-storage/Cummins_3965966_皮带张紧器_473405a1.jpg', category: 'Engine System' },
      { id: 'cm-sp-22', partNumber: '3967252', name: '机油冷却器芯', description: 'Cummins 3967252 - 机油冷却器芯. Compatible with: 陕汽德龙 F3000、山推 推土机. Engine Models: ISL / ISLe / 6L.', image: '/manus-storage/Cummins_3967252_机油冷却器芯_1bb97bdd.jpg', category: 'Cooling System' },
      { id: 'cm-sp-23', partNumber: '3968559', name: '机油压力传感器', description: 'Cummins 3968559 - 机油压力传感器. Compatible with: 陕汽德龙 全系列 (F/M/X3000). Engine Models: ISL / ISMe / ISF.', image: '/manus-storage/Cummins_3968559_机油压力传感器_ddd9df48.jpg', category: 'Engine System' },
      { id: 'cm-sp-24', partNumber: '3972125', name: '高压油管', description: 'Cummins 3972125 - 高压油管. Compatible with: 东风天锦、陕汽 K3000. Engine Models: ISDe / ISBe.', image: '/manus-storage/Cummins_3972125_高压油管_83842326.jpg', category: 'Fuel System' },
      { id: 'cm-sp-25', partNumber: '3972777', name: '燃油管', description: 'Cummins 3972777 - 燃油管. Compatible with: 陕汽德龙 X3000、江淮 重卡. Engine Models: ISLe / L系列.', image: '/manus-storage/Cummins_3972777_燃油管_a2fa4cfe.jpg', category: 'Fuel System' },
      { id: 'cm-sp-26', partNumber: '3979176', name: '风扇皮带', description: 'Cummins 3979176 - 风扇皮带. Compatible with: 重汽豪沃 7 系列、陕汽德龙 F3000. Engine Models: ISLe / L8.9.', image: '/manus-storage/Cummins_3979176_风扇皮带_26c55b1a.jpg', category: 'Engine System' },
      { id: 'cm-sp-27', partNumber: '4931169', name: '活塞组件', description: 'Cummins 4931169 - 活塞组件. Compatible with: 陕汽德龙 L3000、东风 天锦. Engine Models: ISB / ISDe.', image: '/manus-storage/Cummins_4931169_活塞组件_5a9b5311.jpg', category: 'Engine System' },
      { id: 'cm-sp-28', partNumber: '4934058', name: '活塞冷却喷嘴', description: 'Cummins 4934058 - 活塞冷却喷嘴. Compatible with: 陕汽德龙 L3000、福田 瑞沃. Engine Models: ISB / ISDe.', image: '/manus-storage/Cummins_4934058_活塞冷却喷嘴_d924d989.jpg', category: 'Engine System' },
      { id: 'cm-sp-29', partNumber: '4941464', name: '缸盖螺栓', description: 'Cummins 4941464 - 缸盖螺栓. Compatible with: 东风天锦、陕汽 中型载货车. Engine Models: ISDe / ISB.', image: '/manus-storage/Cummins_4941464_缸盖螺栓_c3461728.jpg', category: 'Engine System' },
      { id: 'cm-sp-30', partNumber: '4981794', name: '连杆总成', description: 'Cummins 4981794 - 连杆总成. Compatible with: 福田欧马可 S5、陕汽 K3000. Engine Models: ISF 3.8.', image: '/manus-storage/Cummins_4981794_连杆总成_74b4eed6.jpg', category: 'Engine System' },
      { id: 'cm-sp-31', partNumber: '4981795', name: '连杆瓦', description: 'Cummins 4981795 - 连杆瓦. Compatible with: 福田欧马可、江淮 帅铃、陕汽 K3000. Engine Models: ISF 3.8.', image: '/manus-storage/Cummins_4981795_连杆瓦_8ea315b6.jpg', category: 'Engine System' },
      { id: 'cm-sp-32', partNumber: '4987914', name: '主轴瓦', description: 'Cummins 4987914 - 主轴瓦. Compatible with: 福田奥铃、陕汽 L3000 (ISF版). Engine Models: ISF 3.8.', image: '/manus-storage/Cummins_4987914_主轴瓦_54f92c28.jpg', category: 'Engine System' },
      { id: 'cm-sp-33', partNumber: '4987917', name: '止推片', description: 'Cummins 4987917 - 止推片. Compatible with: 福田欧马可、江淮 骏铃. Engine Models: ISF 3.8.', image: '/manus-storage/Cummins_4987917_止推片_632e976b.png', category: 'Engine System' },
      { id: 'cm-sp-34', partNumber: '4988747', name: '机油泵', description: 'Cummins 4988747 - 机油泵. Compatible with: 陕汽德龙 K3000、福田欧马可. Engine Models: ISF 3.8.', image: '/manus-storage/Cummins_4988747_机油泵_712ebe5c.jpg', category: 'Lubrication System' },
      { id: 'cm-sp-35', partNumber: '5320276', name: '水泵总成', description: 'Cummins 5320276 - 水泵总成. Compatible with: 福田欧马可、陕汽 L3000. Engine Models: ISF 3.8 / 2.8.', image: '/manus-storage/Cummins_5320276_水泵总成_c67ca723.jpg', category: 'Cooling System' },
    ]
  },
  {
    id: 'weichai',

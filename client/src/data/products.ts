...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    spareParts: [
      ...
      { id: 'xcmg-sp-4', partNumber: '860130116', name: 'Air Filter Assembly (Inner and Outer)', description: "XCMG 零件。随外芯周期同步更换内芯", image: '/manus-storage/xcmg_29a234a0.png', category: 'Maintenance/Filtration System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-5', partNumber: '803164591', name: 'Hydraulic Oil Filter (Variant)', description: "XCMG 零件。500-1000小时", image: '/manus-storage/xcmg_29a234a0.png', category: 'Maintenance/Filtration System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      ...
      { id: 'xcmg-sp-7', partNumber: '803086817', name: 'Air Filter (ZL50)', description: "XCMG 零件。250-500小时", image: '/manus-storage/xcmg_29a234a0.png', category: 'Maintenance/Filtration System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-8', partNumber: '803300971', name: 'Oil Filter (with Lock Valve)', description: "XCMG 零件。250-500小时", image: '/manus-storage/xcmg_29a234a0.png', category: 'Maintenance/Filtration System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-9', partNumber: '803164216', name: 'Hydraulic Oil Filter (Model 2)', description: "XCMG 零件。500-1000小时", image: '/manus-storage/xcmg_29a234a0.png', category: 'Maintenance/Filtration System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-10', partNumber: 'WG1371E1', name: 'Water Temperature Sensor', description: "XCMG 零件。水温异常报警时更换", image: '/manus-storage/xcmg_29a234a0.png', category: 'Electrical/Sensor System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-11', partNumber: '252101813', name: 'Bucket Teeth', description: "XCMG 零件。磨损见底或断裂时更换,高频更换件", image: '/manus-storage/xcmg_29a234a0.png', category: 'Excavation/Bucket Teeth', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-12', partNumber: '252101812', name: 'Right Bucket Tooth', description: "XCMG 零件。磨损见底或断裂时更换", image: '/manus-storage/xcmg_29a234a0.png', category: 'Excavation/Bucket Teeth', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-13', partNumber: '252101811', name: 'Left Bucket Tooth', description: "XCMG 零件。磨损见底或断裂时更换", image: '/manus-storage/xcmg_29a234a0.png', category: 'Excavation/Bucket Teeth', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-14', partNumber: '252109213 (Z5G.8.1XI.1-3)', name: 'Tooth Holder', description: "XCMG 零件。随斗齿更换,寿命长于斗齿本身", image: '/manus-storage/xcmg_29a234a0.png', category: 'Excavation/Bucket Teeth', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-15', partNumber: '272200753 (2BS315A)', name: 'Transmission Assembly', description: "XCMG 零件。异响/传动效率下降时更换(大修类高价件)", image: '/manus-storage/xcmg_29a234a0.png', category: 'Transmission/Gearbox System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-16', partNumber: '250200147 (ZL40.6.18A)', name: 'Transmission Control Valve', description: "XCMG 零件。换挡异常时更换", image: '/manus-storage/xcmg_29a234a0.png', category: 'Transmission/Gearbox System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-17', partNumber: '2BS315.30.3-1', name: 'Transmission Reverse Piston', description: "XCMG 零件。换挡不畅/打滑时更换", image: '/manus-storage/xcmg_29a234a0.png', category: 'Transmission/Gearbox System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-18', partNumber: '860115193', name: 'Drive Axle Differential Gear', description: "XCMG 零件。大修/异响时更换(大修类)", image: '/manus-storage/xcmg_29a234a0.png', category: 'Transmission/Gearbox System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-19', partNumber: '803013093 (P7260-100', name: 'Working Hydraulic Pump', description: "XCMG 零件。异响/供油不足/压力下降时更换(大修类高价件)", image: '/manus-storage/xcmg_29a234a0.png', category: 'Hydraulic System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-20', partNumber: '275100191', name: 'Brake Pads', description: "XCMG 零件。30,000-50,000km或视磨损", image: '/manus-storage/xcmg_29a234a0.png', category: 'Brake System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-21', partNumber: '275101789', name: 'Brake Disc', description: "XCMG 零件。盘面磨损/异响时更换", image: '/manus-storage/xcmg_29a234a0.png', category: 'Brake System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-22', partNumber: '252115198', name: 'Hand Brake Valve', description: "XCMG 零件。驻车异响/失效时检修更换", image: '/manus-storage/xcmg_29a234a0.png', category: 'Brake System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-23', partNumber: '250200519 (ZL40A.13A.1)', name: 'Brake Drum', description: "XCMG 零件。制动效果下降/异响时更换", image: '/manus-storage/xcmg_29a234a0.png', category: 'Brake System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-24', partNumber: '803164070', name: 'Lip Seal', description: "XCMG 零件。漏油时更换", image: '/manus-storage/xcmg_29a234a0.png', category: 'Sealing/Drive Components', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-25', partNumber: '860117405', name: 'Universal Joint Coupling', description: "XCMG 零件。异响/抖动时更换", image: '/manus-storage/xcmg_29a234a0.png', category: 'Sealing/Drive Components', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-26', partNumber: '5000140', name: 'Relief Valve', description: "XCMG 零件。液压异常/压力不稳时更换", image: '/manus-storage/xcmg_29a234a0.png', category: 'Hydraulic System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] }
    ]
  },
  {
    id: 'liugong',

...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    spareParts: [
      ...
      { id: 'shantui-sp-5', partNumber: '23Y-56B-12000-1 (612600110540', name: '空气滤芯(SD16)', description: "SHANTUI 零件。250-500小时或视灰尘环境", image: '/manus-storage/shantui_679b20ec.png', category: '保养/滤清系统', compatibleModels: ["Shantui SD", "SD32"] },
      ...
      { id: 'shantui-sp-21', partNumber: '203MJ-37000', name: '履带链条总成(SD16)', description: "SHANTUI 零件。履带松旷/磨损超限时更换(大修类高价件)", image: '/manus-storage/shantui_679b20ec.png', category: '底盘/履带系统', compatibleModels: ["Shantui SD", "SD32"] },
      { id: 'shantui-sp-22', partNumber: '216MJ-38000', name: '履带链条总成(SD22)', description: "SHANTUI 零件。履带松旷/磨损超限时更换(大修类高价件)", image: '/manus-storage/shantui_679b20ec.png', category: '底盘/履带系统', compatibleModels: ["Shantui SD", "SD32"] },
      { id: 'shantui-sp-23', partNumber: '228MC-41000', name: '履带链条总成(SD32)', description: "SHANTUI 零件。履带松旷/磨损超限时更换(大修类高价件)", image: '/manus-storage/shantui_679b20ec.png', category: '底盘/履带系统', compatibleModels: ["Shantui SD", "SD32"] },
      { id: 'shantui-sp-24', partNumber: '154-30-00291', name: '前导向轮总成(SD22)', description: "SHANTUI 零件。磨损/异响时更换", image: '/manus-storage/shantui_679b20ec.png', category: '底盘/履带系统', compatibleModels: ["Shantui SD", "SD32"] },
      { id: 'shantui-sp-25', partNumber: '16Y-40-03000', name: '履带引导轮/托链轮(SD16)', description: "SHANTUI 零件。漏油/磨损时更换", image: '/manus-storage/shantui_679b20ec.png', category: '底盘/履带系统', compatibleModels: ["Shantui SD", "SD32"] },
      { id: 'shantui-sp-26', partNumber: 'P16Y-40-10000', name: '单边支重轮(SD16)', description: "SHANTUI 零件。漏油/磨损时更换", image: '/manus-storage/shantui_679b20ec.png', category: '底盘/履带系统', compatibleModels: ["Shantui SD", "SD32"] },
      { id: 'shantui-sp-27', partNumber: 'P16Y-40-09000', name: '双边支重轮(SD16)', description: "SHANTUI 零件。漏油/磨损时更换", image: '/manus-storage/shantui_679b20ec.png', category: '底盘/履带系统', compatibleModels: ["Shantui SD", "SD32"] },
      { id: 'shantui-sp-28', partNumber: 'P203MA-00063', name: '履带板/湿地履带板螺栓(72长)', description: "SHANTUI 零件。随履带板更换", image: '/manus-storage/shantui_679b20ec.png', category: '底盘/履带系统', compatibleModels: ["Shantui SD", "SD32"] },
      { id: 'shantui-sp-29', partNumber: '01011-52430', name: '履带板螺栓/驱动齿轮螺栓', description: "SHANTUI 零件。随部件更换时同步更换", image: '/manus-storage/shantui_679b20ec.png', category: '底盘/履带系统', compatibleModels: ["Shantui SD", "SD32"] },
      ...
      { id: 'shantui-sp-36', partNumber: 'P16Y-62-51000XJK', name: '液压提升缸修理包', description: "SHANTUI 零件。漏油/密封老化时更换", image: '/manus-storage/shantui_679b20ec.png', category: '液压系统', compatibleModels: ["Shantui SD", "SD32"] },
      { id: 'shantui-sp-37', partNumber: '16Y-03A-03000', name: '散热器总成', description: "SHANTUI 零件。过热/渗漏时更换", image: '/manus-storage/shantui_679b20ec.png', category: '冷却系统', compatibleModels: ["Shantui SD", "SD32"] },
      { id: 'shantui-sp-38', partNumber: '600-613-1140', name: '散热风扇总成', description: "SHANTUI 零件。异响/扇叶断裂时更换", image: '/manus-storage/shantui_679b20ec.png', category: '冷却系统', compatibleModels: ["Shantui SD", "SD32"] },
      { id: 'shantui-sp-39', partNumber: 'P16Y-05C-08000', name: '主销(king pin)', description: "SHANTUI 零件。转向异响/间隙过大时更换", image: '/manus-storage/shantui_679b20ec.png', category: '转向/悬挂', compatibleModels: ["Shantui SD", "SD32"] },
      { id: 'shantui-sp-40', partNumber: '07012-00085', name: '最终驱动骨架油封', description: "SHANTUI 零件。漏油时更换(大修类)", image: '/manus-storage/shantui_679b20ec.png', category: '传动/最终驱动', compatibleModels: ["Shantui SD", "SD32"] }
    ]
  },
  {
    id: 'xcmg',
    ...
    spareParts: [
      ...
      { id: 'xcmg-sp-11', partNumber: '252101813', name: '铲斗斗齿', description: "XCMG 零件。磨损见底或断裂时更换,高频更换件", image: '/manus-storage/xcmg_29a234a0.png', category: '挖掘属性/GET', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-12', partNumber: '252101812', name: '右侧斗齿', description: "XCMG 零件。磨损见底或断裂时更换", image: '/manus-storage/xcmg_29a234a0.png', category: '挖掘属性/GET', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-13', partNumber: '252101811', name: '左侧斗齿', description: "XCMG 零件。磨损见底或断裂时更换", image: '/manus-storage/xcmg_29a234a0.png', category: '挖掘属性/GET', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-14', partNumber: '252109213 (Z5G.8.1XI.1-3)', name: '斗齿座(Tooth Holder)', description: "XCMG 零件。随斗齿更换,寿命长于斗齿本身", image: '/manus-storage/xcmg_29a234a0.png', category: '挖掘属性/GET', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      ...
      { id: 'xcmg-sp-19', partNumber: '803013093 (P7260-100', name: '工作液压泵', description: "XCMG 零件。异响/供油不足/压力下降时更换(大修类高价件)", image: '/manus-storage/xcmg_29a234a0.png', category: '液压系统', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-20', partNumber: '275100191', name: '刹车片(SOMA制动衬片)', description: "XCMG 零件。30,000-50,000km或视磨损", image: '/manus-storage/xcmg_29a234a0.png', category: '制动系统', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-21', partNumber: '275101789', name: '制动盘(刹车盘)', description: "XCMG 零件。盘面磨损/异响时更换", image: '/manus-storage/xcmg_29a234a0.png', category: '制动系统', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-22', partNumber: '252115198', name: '手刹阀', description: "XCMG 零件。驻车异响/失效时检修更换", image: '/manus-storage/xcmg_29a234a0.png', category: '制动系统', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-23', partNumber: '250200519 (ZL40A.13A.1)', name: '手刹鼓(制动鼓)', description: "XCMG 零件。制动效果下降/异响时更换", image: '/manus-storage/xcmg_29a234a0.png', category: '制动系统', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-24', partNumber: '803164070', name: '唇形油封', description: "XCMG 零件。漏油时更换", image: '/manus-storage/xcmg_29a234a0.png', category: '密封/传动件', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-25', partNumber: '860117405', name: '万向节联轴器', description: "XCMG 零件。异响/抖动时更换", image: '/manus-storage/xcmg_29a234a0.png', category: '密封/传动件', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-26', partNumber: '5000140', name: '溢流阀(继动阀)', description: "XCMG 零件。液压异常/压力不稳时更换", image: '/manus-storage/xcmg_29a234a0.png', category: '液压系统', compatibleModels: ["XCMG ZL50G", "ZL50GN"] }
    ]
  },
  {
    id: 'liugong',
    ...
    spareParts: [
      ...
      { id: 'liugong-sp-7', partNumber: '40C5856', name: '空气滤芯', description: "LIUGONG 零件。250-500小时或视灰尘环境", image: '/manus-storage/liugong1_81eaa09f.png', category: '保养/滤清系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-8', partNumber: '53C0052', name: '柴油滤芯(通用型)', description: "LIUGONG 零件。250-500小时", image: '/manus-storage/liugong1_81eaa09f.png', category: '保养/滤清系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-9', partNumber: 'SP105056', name: '机油滤芯(型号2)', description: "LIUGONG 零件。250-500小时", image: '/manus-storage/liugong1_81eaa09f.png', category: '保养/滤清系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-10', partNumber: '50C0117', name: '空气滤芯(型号2)', description: "LIUGONG 零件。250-500小时", image: '/manus-storage/liugong1_81eaa09f.png', category: '保养/滤清系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-11', partNumber: '53C0089', name: '液压回油滤芯(型号3)', description: "LIUGONG 零件。500-1000小时", image: '/manus-storage/liugong1_81eaa09f.png', category: '保养/滤清系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-12', partNumber: '72A0005', name: '铲斗斗齿', description: "LIUGONG 零件。磨损见底或断裂时更换,高频更换件", image: '/manus-storage/liugong1_81eaa09f.png', category: '挖掘属性/GET', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-13', partNumber: '11C1061 (JHP2080', name: '转向油泵(齿轮泵)', description: "LIUGONG 零件。转向沉重/异响时更换", image: '/manus-storage/liugong1_81eaa09f.png', category: '转向/液压系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-14', partNumber: '10C0031 (ZL50G.9.25)', name: '左转向油缸', description: "LIUGONG 零件。漏油/转向异响时更换", image: '/manus-storage/liugong1_81eaa09f.png', category: '转向/液压系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-15', partNumber: '需按具体型号核实', name: '制动助力器(brake booster)', description: "LIUGONG 零件。制动响应变慢/失效时检修更换", image: '/manus-storage/liugong1_81eaa09f.png', category: '制动系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-16', partNumber: '需按具体型号核实', name: '刹车片(摩擦衬片)', description: "LIUGONG 零件。30,000-50,000km或视磨损", image: '/manus-storage/liugong1_81eaa09f.png', category: '制动系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-17', partNumber: '42C0352', name: '变速箱总成(ZF/柳工自研)', description: "LIUGONG 零件。异响/传动效率下降时更换(大修类高价件)", image: '/manus-storage/liugong1_81eaa09f.png', category: '传动/变速系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-18', partNumber: '37B0428', name: '变速箱控制单元(ZF)', description: "LIUGONG 零件。换挡异常/电控故障时更换", image: '/manus-storage/liugong1_81eaa09f.png', category: '传动/变速系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-19', partNumber: '20C0020 (LG50G-37a)', name: '散热器总成', description: "LIUGONG 零件。过热/渗漏时更换", image: '/manus-storage/liugong1_81eaa09f.png', category: '冷却系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-20', partNumber: 'SP105609', name: '风扇支架', description: "LIUGONG 零件。异响/断裂时更换", image: '/manus-storage/liugong1_81eaa09f.png', category: '冷却系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-21', partNumber: '38B0042', name: '倒车报警器', description: "LIUGONG 零件。报警失效时更换", image: '/manus-storage/liugong1_81eaa09f.png', category: '电气系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-22', partNumber: '37B0915', name: '保险丝盒', description: "LIUGONG 零件。电路异常时检修更换", image: '/manus-storage/liugong1_81eaa09f.png', category: '电气系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-23', partNumber: '40C0019 (康明斯6CT8.3-C215)', name: '柴油发动机总成参考', description: "LIUGONG 零件。大修类,仅供参考发动机型号", image: '/manus-storage/liugong1_81eaa09f.png', category: '发动机系统', compatibleModels: ["Liugong CLG856", "CLG856H"] }
    ]
  },
  {
    id: 'sany',
    ...
    spareParts: [
      ...
      { id: 'sany-sp-6', partNumber: '60201217(通用替代号)', name: '燃油滤芯(替代号)', description: "SANY 零件。250-500小时", image: '/manus-storage/sany_5f4793a0.png', category: '保养/滤清系统', compatibleModels: ["SANY SY", "SY365"] },
      ...
      { id: 'sany-sp-8', partNumber: '随铲斗规格核实(通用型号覆盖SY210', name: '铲斗斗齿', description: "SANY 零件。磨损见底或断裂时更换,高频更换件", image: '/manus-storage/sany_5f4793a0.png', category: '挖掘属性/GET', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-9', partNumber: '随SY230', name: '前导向轮', description: "SANY 零件。磨损/异响时更换", image: '/manus-storage/sany_5f4793a0.png', category: '底盘/履带系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-10', partNumber: '随SY235系列核实', name: '驱动链轮', description: "SANY 零件。轮齿磨损/断齿时更换(大修类高价件)", image: '/manus-storage/sany_5f4793a0.png', category: '底盘/履带系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-11', partNumber: '随SY235C-8系列核实', name: '下托链轮(Bottom Roller)', description: "SANY 零件。漏油/磨损时更换", image: '/manus-storage/sany_5f4793a0.png', category: '底盘/履带系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-12', partNumber: '随SY335C-8系列核实', name: '上托轮(Top Roller/Carrier Roller)', description: "SANY 零件。漏油/磨损时更换", image: '/manus-storage/sany_5f4793a0.png', category: '底盘/履带系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-13', partNumber: '随SY205C', name: '履带链条总成', description: "SANY 零件。履带松旷/磨损超限时更换(大修类高价件)", image: '/manus-storage/sany_5f4793a0.png', category: '底盘/履带系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-14', partNumber: '随SY215C系列核实(Trasteel Track品牌供货)', name: '履带板/track shoe', description: "SANY 零件。磨损/断裂时更换", image: '/manus-storage/sany_5f4793a0.png', category: '底盘/履带系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-15', partNumber: 'A28VO130(Rexroth品牌泵)', name: '主液压泵(Rexroth型)', description: "SANY 零件。异响/供油不足/压力下降时更换(大修类高价件)", image: '/manus-storage/sany_5f4793a0.png', category: '液压系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-16', partNumber: '随SY215系列核实', name: '行走(履带)马达/最终驱动总成', description: "SANY 零件。异响/爬坡无力时更换(大修类高价件)", image: '/manus-storage/sany_5f4793a0.png', category: '液压系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-17', partNumber: '需按具体机型核实(KYB', name: '回转(转台)马达及减速机', description: "SANY 零件。转台异响/回转无力时更换(大修类)", image: '/manus-storage/sany_5f4793a0.png', category: '液压系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-18', partNumber: '需按发动机型号核实(Cummins', name: '涡轮增压器', description: "SANY 零件。动力下降/异响/漏油时更换(大修类)", image: '/manus-storage/sany_5f4793a0.png', category: '发动机系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-19', partNumber: '需按发动机型号核实', name: '发电机总成', description: "SANY 零件。发电异常/异响时更换", image: '/manus-storage/sany_5f4793a0.png', category: '发动机系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-20', partNumber: '需按发动机型号核实', name: '起动机总成', description: "SANY 零件。启动无力/异响时更换", image: '/manus-storage/sany_5f4793a0.png', category: '发动机系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-21', partNumber: '需按底盘序列号核实', name: '铲斗油缸密封修理包', description: "SANY 零件。漏油/密封老化时更换", image: '/manus-storage/sany_5f4793a0.png', category: '液压缸/密封件', compatibleModels: ["SANY SY", "SY365"] }
    ]
  },
  {
    id: 'komatsu',

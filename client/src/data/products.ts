...
export const brands: Brand[] = [
  ...
  // ========== TRUCKS & ENGINES ==========
  {
    ...
    spareParts: [
      ...
      { id: 'iz-sp-11', partNumber: '8-97602-438-0', name: '前油封 (Front Oil Seal)', description: 'Isuzu 曲轴前端油封，防止机油从曲轴前端泄漏，保护发动机。兼容车型：五十铃 NPR、NQR、NRR 等。发动机型号：4HK1、6HK1、6UZ1、6WG1。规格：氟橡胶油封，内径 40mm，工作温度 -40~150℃。', image: '/manus-storage/bpJqu0wjBY5i.jpg', category: 'Engine System' },

...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    spareParts: [
      { id: 'xcmg-sp-1', partNumber: '860115046', name: 'Hydraulic Oil Filter', description: "XCMG part. Replace every 500-1000 hours or based on fluid analysis.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Maintenance/Filtration System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      ...
      { id: 'xcmg-sp-4', partNumber: '860130116', name: 'Air Filter Assembly (Inner and Outer)', description: "XCMG part. Replace inner and outer elements together at same interval.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Maintenance/Filtration System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      ...
      { id: 'xcmg-sp-6', partNumber: '860133763', name: 'Oil Filter', description: "XCMG part. Replace during maintenance every 250-500 hours.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Maintenance/Filtration System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-7', partNumber: '803086817', name: 'Air Filter (ZL50)', description: "XCMG part. Replace every 250-500 hours.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Maintenance/Filtration System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-8', partNumber: '803300971', name: 'Oil Filter (with Lock Valve)', description: "XCMG part. Replace every 250-500 hours.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Maintenance/Filtration System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      ...
      { id: 'xcmg-sp-10', partNumber: 'WG1371E1', name: 'Water Temperature Sensor', description: "XCMG part. Replace when abnormal temperature alarm occurs.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Electrical/Sensor System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-11', partNumber: '252101813', name: 'Bucket Teeth', description: "XCMG part. Replace when worn to bottom or broken. High-frequency replacement item.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Excavation/Bucket Teeth', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      ...
      { id: 'xcmg-sp-14', partNumber: '252109213 (Z5G.8.1XI.1-3)', name: 'Bucket Tooth Seat', description: "XCMG part. Replace with bucket teeth. Longer service life than teeth.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Excavation/Bucket Teeth', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-15', partNumber: '272200753 (2BS315A)', name: 'Transmission Assembly', description: "XCMG part. Replace when abnormal noise/transmission efficiency drops (major repair, high-cost item).", image: '/manus-storage/xcmg_29a234a0.png', category: 'Transmission/Gearbox System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-16', partNumber: '250200147 (ZL40.6.18A)', name: 'Transmission Control Valve', description: "XCMG part. Replace when abnormal shifting occurs.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Transmission/Gearbox System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-17', partNumber: '2BS315.30.3-1', name: 'Transmission Reverse Piston', description: "XCMG part. Replace when shifting is difficult/slipping occurs.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Transmission/Gearbox System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-18', partNumber: '860115193', name: 'Drive Axle Differential Gear', description: "XCMG part. Replace during major repair/when abnormal noise occurs (major repair item).", image: '/manus-storage/xcmg_29a234a0.png', category: 'Transmission/Gearbox System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-19', partNumber: '803013093 (P7260-100', name: 'Working Hydraulic Pump', description: "XCMG part. Replace when abnormal noise/insufficient oil supply/pressure drop occurs (major repair, high-cost item).", image: '/manus-storage/xcmg_29a234a0.png', category: 'Hydraulic System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      ...
      { id: 'xcmg-sp-21', partNumber: '275101789', name: 'Brake Disc', description: "XCMG part. Replace when disc surface worn/abnormal noise occurs.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Brake System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-22', partNumber: '252115198', name: 'Parking Brake Valve', description: "XCMG part. Inspect and replace when parking noise/failure occurs.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Brake System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-23', partNumber: '250200519 (ZL40A.13A.1)', name: 'Brake Drum', description: "XCMG part. Replace when braking effect drops/abnormal noise occurs.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Brake System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-24', partNumber: '803164070', name: 'Lip Seal Ring', description: "XCMG part. Replace when oil leakage occurs.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Sealing/Drive Components', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-25', partNumber: '860117405', name: 'Universal Joint Coupling', description: "XCMG part. Replace when abnormal noise/vibration occurs.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Sealing/Drive Components', compatibleModels: ["XCMG ZL50G", "ZL50GN"] },
      { id: 'xcmg-sp-26', partNumber: '5000140', name: 'Relief Valve', description: "XCMG part. Replace when hydraulic abnormality/unstable pressure occurs.", image: '/manus-storage/xcmg_29a234a0.png', category: 'Hydraulic System', compatibleModels: ["XCMG ZL50G", "ZL50GN"] }
    ]
  },
  {
    id: 'liugong',

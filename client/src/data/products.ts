...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    spareParts: [
      ...
      { id: 'shacman-sp-4', partNumber: 'DZ91189550169', name: '燃油粗滤器(油水分离器)', description: 'Shacman Delong 零件。5,000-10,000km,雨季/劣质油缩短', image: '/manus-storage/shacman_273a0f44.png', category: 'Maintenance/Filtration System', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      ...
      { id: 'shacman-sp-18', partNumber: 'AZ9114310125', name: '驱动轴节叉', description: 'Shacman Delong 零件。传动轴异响时更换', image: '/manus-storage/shacman_273a0f44.png', category: 'Wheel Hub/Drive Shaft', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-19', partNumber: '30222(参考件号)', name: '前轮轴承维修包', description: 'Shacman Delong 零件。异响/间隙过大时更换,建议核实原厂号', image: '/manus-storage/shacman_273a0f44.png', category: 'Wheel Hub/Drive Shaft', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-20', partNumber: '需按VIN核实(标准STR', name: '转向节臂/横拉杆(转向梯形臂)', description: 'Shacman Delong 零件。转向精度下降/跑偏时检查', image: '/manus-storage/shacman_273a0f44.png', category: 'Steering System', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-21', partNumber: '需按前桥型号核实', name: '转向主销(king pin)总成', description: 'Shacman Delong 零件。转向异响/间隙过大时更换', image: '/manus-storage/shacman_273a0f44.png', category: 'Steering System', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
  ...
  },
  {
    ...
    spareParts: [
      ...
      { id: 'sinotruk-sp-32', partNumber: 'WG9725471016', name: '动力转向助力泵', description: "SINOTRUK 零件。转向沉重/异响时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Steering System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      ...
      { id: 'sinotruk-sp-42', partNumber: 'AZ9114310125', name: '驱动轴节叉(万向节叉)', description: "SINOTRUK 零件。传动轴异响时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Wheel Hub/Drive Shaft', compatibleModels: ["Sinotruk HOWO", "WD615"] },
  ...
  },
  {
    ...
    spareParts: [
      ...
      { id: 'toyota-sp-11', partNumber: '04495-0K160', name: 'Rear Brake Shoe', description: 'Toyota Hilux 零件。与前片同步检查更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '制动系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-12', partNumber: '47750-0K300', name: 'Rear Brake Caliper Assembly', description: 'Toyota Hilux 零件。渗油/卡滞时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '制动系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-13', partNumber: '47730-0K300', name: 'Front Brake Caliper Cylinder', description: 'Toyota Hilux 零件。配合刹车片总成', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '制动系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      ...
      { id: 'toyota-sp-16', partNumber: '90385-T0014', name: 'Rear Leaf Spring Eye Bushing', description: 'Toyota Hilux 零件。弹簧异响/下沉时更换', image: '/manus-storage/toyota_parts_a1da12f5.png', category: '悬挂系统', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      ...
      { id: 'toyota-sp-25', partNumber: '41110-0K280', name: 'Front Differential Housing', description: 'Toyota Hilux 零件。大修/异响时,专业件建议核实VIN', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Differential/Transmission', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      ...
      { id: 'toyota-sp-28', partNumber: '16278-0E010', name: 'Water Bypass Hose', description: 'Toyota Hilux spare part. Coolant bypass hose for engine cooling system. Check together with water pump during maintenance. Replace if cracked or leaking.', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Cooling System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-29', partNumber: '16711-0L170', name: 'Radiator Fan Shroud', description: 'Toyota Hilux spare part. Radiator fan shroud for engine cooling. Replace when fan makes abnormal noise or cooling performance is poor. Improves heat dissipation efficiency.', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Cooling System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] },
      { id: 'toyota-sp-30', partNumber: '16400-0K350', name: 'Radiator Assembly (Reference)', description: 'Toyota Hilux spare part. Replace when overheating or leaking occurs. Recommended inspection interval: 80,000-100,000 km or every 3-4 years. Compatible with Hilux Revo and Hilux Vigo models.', image: '/manus-storage/toyota_parts_a1da12f5.png', category: 'Cooling System', compatibleModels: ["Hilux Revo", "Hilux Vigo"] }
    ]
  },
  {
    id: 'cummins',
  ...
  },
  {
    ...
    spareParts: [
      ...
      { id: 'weichai-sp-2', partNumber: '612630080088(PRELINE 420,替代号PL420', name: '柴油滤芯(WP10专用)', description: "WEICHAI 零件。250-500小时或视油品", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-3', partNumber: '612600081334(替代号FF5622', name: '柴油滤芯(通用型)', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-4', partNumber: '612630080087(替代号WDK11102', name: '柴油滤芯(型号2)', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-5', partNumber: '612630080203(替代号CX1016E4', name: '柴油滤芯(型号3)', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-6', partNumber: '612630080205(替代号1111474)', name: '柴油滤芯(型号4)', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-7', partNumber: '612600081335(PRELINE 420,替代号PL420', name: '柴油滤芯总成', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-8', partNumber: '612630060015(替代号PROVENT200', name: '油气分离器滤芯', description: "WEICHAI 零件。500-1000小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-9', partNumber: '612630060138', name: '油气分离器滤芯(型号2)', description: "WEICHAI 零件。500-1000小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-10', partNumber: '612630010239(替代号W11170', name: '机油滤芯(通用变体)', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-11', partNumber: '612600081335A', name: '柴油滤芯(WP4/WP6/WD615/WD10/WP10/WP12通用)', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Maintenance/Filtration System', compatibleModels: ["Weichai WP10", "WP12"] },
      ...
      { id: 'weichai-sp-13', partNumber: '612600061872', name: '水泵总成(WD12/WP12专用)', description: "WEICHAI 零件。冷却液渗漏/异响时更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Cooling System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-14', partNumber: '612600140062', name: '节温器(恒温器)', description: "WEICHAI 零件。水温异常/过热时更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Cooling System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-15', partNumber: '615G00060016', name: '节温器总成(WD615)', description: "WEICHAI 零件。水温异常/过热时更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Cooling System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-16', partNumber: '61200100157', name: '风扇液力驱动总成(离合风扇)', description: "WEICHAI 零件。散热异响/风扇打滑时更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Transmission/Belt', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-17', partNumber: '612600090206D', name: '发电机总成(28V/70A)', description: "WEICHAI 零件。发电异常/异响时更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Electrical/Starting System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-18', partNumber: '61560080276(替代号Kbel132p110)', name: '燃油喷油器', description: "WEICHAI 零件。喷油不良/启动困难时更换(2000小时检查/4000-6000小时更换)", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Fuel System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-19', partNumber: '1000000623', name: '喷油嘴(injector nozzle)', description: "WEICHAI 零件。随喷油器周期检查更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Fuel System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-20', partNumber: '1002018309(612600081327)', name: '燃油滤芯元件(总成型)', description: "WEICHAI 零件。250-500小时", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Fuel System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-21', partNumber: '612600190222', name: 'ECU电控单元', description: "WEICHAI 零件。故障灯报警/无法启动时检修更换(大修类高价件)", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Fuel System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-22', partNumber: '612600080611', name: '涡轮增压器(WP10)', description: "WEICHAI 零件。动力下降/异响/漏油时更换(大修类高价件)", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Intake/Boost System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-23', partNumber: '1001248542', name: '涡轮增压器(高原型)', description: "WEICHAI 零件。动力下降/异响/漏油时更换(大修类)", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Intake/Boost System', compatibleModels: ["Weichai WP10", "WP12"] },
      { id: 'weichai-sp-24', partNumber: '1001740613', name: '机油滤芯(总成型)', description: "WEICHAI 零件。250-500小时随保养更换", image: '/manus-storage/weichai_2cc7d2af.png', category: 'Lubrication System', compatibleModels: ["Weichai WP10", "WP12"] },

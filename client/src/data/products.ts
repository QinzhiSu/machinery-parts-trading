...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    spareParts: [
      ...
      { id: 'sinotruk-sp-2', partNumber: 'WG9725190055', name: '空气滤芯总成', description: "SINOTRUK 零件。视路况10,000-20,000km", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Maintenance/Filtration System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-3', partNumber: 'WG9925550110', name: '柴油粗滤器(油水分离器)', description: "SINOTRUK 零件。5,000-10,000km,雨季/劣质油品缩短周期", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Maintenance/Filtration System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      { id: 'sinotruk-sp-4', partNumber: 'VG1560080012', name: '柴油精滤器', description: "SINOTRUK 零件。与粗滤器同步更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Maintenance/Filtration System', compatibleModels: ["Sinotruk HOWO", "WD615"] },
      ...
      { id: 'sinotruk-sp-7', partNumber: 'VG1093130001', name: '空气压缩机(双缸水冷)', description: "SINOTRUK 零件。刹车气压不足/异响时更换", image: '/manus-storage/sinotruck_d3e8e9bd.png', category: 'Intake/Boost System', compatibleModels: ["Sinotruk HOWO", "WD615"] },

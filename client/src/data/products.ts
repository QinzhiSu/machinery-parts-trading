...
export const brands: Brand[] = [
  // ========== CONSTRUCTION MACHINERY ==========
  {
    ...
    spareParts: [
      ...
      { id: 'cat-sp-15', partNumber: '8E-5600', name: '上托轮(Carrier Roller)', description: "CAT part. Replace if leaking or worn.", image: '/manus-storage/cat_ee9e5401.png', category: '底盘/履带系统', compatibleModels: ["CAT 320", "CAT 320D"] },
      ...
      { id: 'cat-sp-29', partNumber: '2159985', name: 'Boom Cylinder Seal Repair Kit', description: "CAT part. Replace when leaking or seal aging occurs.", image: '/manus-storage/cat_ee9e5401.png', category: '液压缸/密封件', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-30', partNumber: '2344587', name: 'Bucket Cylinder Seal Repair Kit', description: "CAT part. Replace when leaking or seal aging occurs.", image: '/manus-storage/cat_ee9e5401.png', category: '液压缸/密封件', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-31', partNumber: '1589088', name: 'Bucket Cylinder Seal Kit (85mm Rod/125mm Bore)', description: "CAT part. Replace when leaking or seal aging occurs.", image: '/manus-storage/cat_ee9e5401.png', category: '液压缸/密封件', compatibleModels: ["CAT 320", "CAT 320D"] },
      { id: 'cat-sp-32', partNumber: '1709808', name: 'Bucket Cylinder Seal Kit (65mm Rod, Old Model)', description: "CAT part. Replace when leaking or seal aging occurs.", image: '/manus-storage/cat_ee9e5401.png', category: '液压缸/密封件', compatibleModels: ["CAT 320", "CAT 320D"] },
  ...
  },
  {
    ...
    spareParts: [
      ...
      { id: 'liugong-sp-4', partNumber: '53C0576', name: 'Diesel Filter', description: "LIUGONG 零件。250-500小时或视油品", image: '/manus-storage/liugong1_81eaa09f.png', category: '保养/滤清系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-5', partNumber: '53C0011 (SFM-516)', name: 'Hydraulic Return Oil Filter (Model 2)', description: "LIUGONG 零件。500-1000小时", image: '/manus-storage/liugong1_81eaa09f.png', category: '保养/滤清系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-6', partNumber: '53C0167', name: 'Pilot Hydraulic Oil Filter', description: "LIUGONG 零件。500-1000小时", image: '/manus-storage/liugong1_81eaa09f.png', category: '保养/滤清系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-7', partNumber: '40C5856', name: 'Air Filter Element', description: "LIUGONG 零件。250-500小时或视灰尘环境", image: '/manus-storage/liugong1_81eaa09f.png', category: '保养/滤清系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-8', partNumber: '53C0052', name: 'Diesel Filter (Universal Type)', description: "LIUGONG 零件。250-500小时", image: '/manus-storage/liugong1_81eaa09f.png', category: '保养/滤清系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-9', partNumber: 'SP105056', name: 'Oil Filter (Model 2)', description: "LIUGONG 零件。250-500小时", image: '/manus-storage/liugong1_81eaa09f.png', category: '保养/滤清系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-10', partNumber: '50C0117', name: 'Air Filter Element (Model 2)', description: "LIUGONG 零件。250-500小时", image: '/manus-storage/liugong1_81eaa09f.png', category: '保养/滤清系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-11', partNumber: '53C0089', name: 'Hydraulic Return Oil Filter (Model 3)', description: "LIUGONG 零件。500-1000小时", image: '/manus-storage/liugong1_81eaa09f.png', category: '保养/滤清系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-12', partNumber: '72A0005', name: 'Bucket Teeth', description: "LIUGONG 零件。磨损见底或断裂时更换,高频更换件", image: '/manus-storage/liugong1_81eaa09f.png', category: '挖掘属性/GET', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      ...
      { id: 'liugong-sp-15', partNumber: 'Verify by model', name: 'Brake Booster', description: "LIUGONG 零件。制动响应变慢/失效时检修更换", image: '/manus-storage/liugong1_81eaa09f.png', category: '制动系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-16', partNumber: 'Verify by model', name: 'Brake Pad (Friction Lining)', description: "LIUGONG 零件。30,000-50,000km或视磨损", image: '/manus-storage/liugong1_81eaa09f.png', category: '制动系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      ...
      { id: 'liugong-sp-19', partNumber: '20C0020 (LG50G-37a)', name: 'Radiator Assembly', description: "LIUGONG 零件。过热/渗漏时更换", image: '/manus-storage/liugong1_81eaa09f.png', category: '冷却系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-20', partNumber: 'SP105609', name: 'Fan Bracket', description: "LIUGONG 零件。异响/断裂时更换", image: '/manus-storage/liugong1_81eaa09f.png', category: '冷却系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-21', partNumber: '38B0042', name: 'Reversing Alarm', description: "LIUGONG 零件。报警失效时更换", image: '/manus-storage/liugong1_81eaa09f.png', category: '电气系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-22', partNumber: '37B0915', name: 'Fuse Box', description: "LIUGONG 零件。电路异常时检修更换", image: '/manus-storage/liugong1_81eaa09f.png', category: '电气系统', compatibleModels: ["Liugong CLG856", "CLG856H"] },
      { id: 'liugong-sp-23', partNumber: '40C0019 (Cummins 6CT8.3-C215)', name: 'Diesel Engine Assembly (Reference)', description: "LIUGONG 零件。大修类,仅供参考发动机型号", image: '/manus-storage/liugong1_81eaa09f.png', category: '发动机系统', compatibleModels: ["Liugong CLG856", "CLG856H"] }
    ]
  },
  {
    id: 'sany',
  ...
  },
  {
    ...
    spareParts: [
      ...
      { id: 'shacman-sp-19', partNumber: '30222', name: '前轮轴承维修包', description: 'Shacman Delong 零件。异响/间隙过大时更换,建议核实原厂号', image: '/manus-storage/shacman_273a0f44.png', category: '轮毂/传动轴', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-20', partNumber: 'STR', name: '转向节臂/横拉杆(转向梯形臂)', description: 'Shacman Delong 零件。转向精度下降/跑偏时检查', image: '/manus-storage/shacman_273a0f44.png', category: '转向系统', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-21', partNumber: 'King Pin Assembly', name: '转向主销(king pin)总成', description: 'Shacman Delong 零件。转向异响/间隙过大时更换', image: '/manus-storage/shacman_273a0f44.png', category: '转向系统', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-22', partNumber: 'WD615-Alternator', name: '发电机总成', description: 'Shacman Delong 零件。发电异常/异响时更换', image: '/manus-storage/shacman_273a0f44.png', category: '电气/启动', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-23', partNumber: 'WD615-Starter', name: '起动机总成', description: 'Shacman Delong 零件。启动无力/异响时更换', image: '/manus-storage/shacman_273a0f44.png', category: '电气/启动', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-24', partNumber: 'WD615-Water Pump', name: '水泵总成', description: 'Shacman Delong 零件。冷却液渗漏/异响时更换,建议核实VG1500060051是否通用', image: '/manus-storage/shacman_273a0f44.png', category: '冷却系统', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-25', partNumber: 'WD615-Turbo', name: '涡轮增压器总成', description: 'Shacman Delong 零件。动力下降/漏油时更换(大修类)', image: '/manus-storage/shacman_273a0f44.png', category: '进气/增压', compatibleModels: ["Shacman Delong", "Shacman X3000"] },
      { id: 'shacman-sp-26', partNumber: 'WG9000360-Brake Chamber', name: '制动气室(前/后桥)', description: 'Shacman Delong 零件。刹车异响/漏气时更换', image: '/manus-storage/shacman_273a0f44.png', category: '制动系统', compatibleModels: ["Shacman Delong", "Shacman X3000"] },

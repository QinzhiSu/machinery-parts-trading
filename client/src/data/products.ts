...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    spareParts: [
      ...
      { id: 'sany-sp-8', partNumber: 'TBD', name: '铲斗斗齿', description: "SANY 零件。磨损见底或断裂时更换,高频更换件", image: '/manus-storage/sany_5f4793a0.png', category: '挖掘属性/GET', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-9', partNumber: 'TBD', name: '前导向轮', description: "SANY 零件。磨损/异响时更换", image: '/manus-storage/sany_5f4793a0.png', category: '底盘/履带系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-10', partNumber: 'TBD', name: '驱动链轮', description: "SANY 零件。轮齿磨损/断齿时更换(大修类高价件)", image: '/manus-storage/sany_5f4793a0.png', category: '底盘/履带系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-11', partNumber: 'TBD', name: '下托链轮(Bottom Roller)', description: "SANY 零件。漏油/磨损时更换", image: '/manus-storage/sany_5f4793a0.png', category: '底盘/履带系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-12', partNumber: 'TBD', name: '上托轮(Top Roller/Carrier Roller)', description: "SANY 零件。漏油/磨损时更换", image: '/manus-storage/sany_5f4793a0.png', category: '底盘/履带系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-13', partNumber: 'TBD', name: '履带链条总成', description: "SANY 零件。履带松旷/磨损超限时更换(大修类高价件)", image: '/manus-storage/sany_5f4793a0.png', category: '底盘/履带系统', compatibleModels: ["SANY SY", "SY365"] },
      ...
      { id: 'sany-sp-16', partNumber: 'TBD', name: '行走(履带)马达/最终驱动总成', description: "SANY 零件。异响/爬坡无力时更换(大修类高价件)", image: '/manus-storage/sany_5f4793a0.png', category: '液压系统', compatibleModels: ["SANY SY", "SY365"] },
      ...
      { id: 'sany-sp-19', partNumber: 'TBD', name: '发电机总成', description: "SANY 零件。发电异常/异响时更换", image: '/manus-storage/sany_5f4793a0.png', category: '发动机系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-20', partNumber: 'TBD', name: '起动机总成', description: "SANY 零件。启动无力/异响时更换", image: '/manus-storage/sany_5f4793a0.png', category: '发动机系统', compatibleModels: ["SANY SY", "SY365"] },
      { id: 'sany-sp-21', partNumber: 'TBD', name: '铲斗油缸密封修理包', description: "SANY 零件。漏油/密封老化时更换", image: '/manus-storage/sany_5f4793a0.png', category: '液压缸/密封件', compatibleModels: ["SANY SY", "SY365"] }
    ]
  },
  {
    id: 'komatsu',

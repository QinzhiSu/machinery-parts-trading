...
export const isuzuNameTranslations = {
  ...
  'Diesel Filter(6HK1-3代/新款)': {
    en: 'Diesel Filter(6HK1-3代/新款)',
    es: 'Filtro Diesel(6HK1-3代/新款)',
    fr: 'Filtre Diesel(6HK1-3代/新款)',
    de: 'Dieselfilter(6HK1-3代/新款)',
    pt: 'Filtro Diesel(6HK1-3代/新款)',
    ru: 'Дизельный фильтр(6HK1-3代/新款)',
    ja: 'ディーゼルフィルター(6HK1-3代/新款)',
    zh: '柴油滤芯(6HK1-3代/新款)',
    ar: 'مرشح الديزل(6HK1-3代/新款)',
    it: 'Filtro Diesel(6HK1-3代/新款)',
  },
  'Diesel Filter(6HK1一级)': {
    en: 'Diesel Filter(6HK1一级)',
    es: 'Filtro Diesel(6HK1一级)',
    fr: 'Filtre Diesel(6HK1一级)',
    de: 'Dieselfilter(6HK1一级)',
    pt: 'Filtro Diesel(6HK1一级)',
    ru: 'Дизельный фильтр(6HK1一级)',
    ja: 'ディーゼルフィルター(6HK1一级)',
    zh: '柴油滤芯(6HK1一级)',
    ar: 'مرشح الديزل(6HK1一级)',
    it: 'Filtro Diesel(6HK1一级)',
  },
  'Diesel Filter(6HK1二级)': {
    en: 'Diesel Filter(6HK1二级)',
    es: 'Filtro Diesel(6HK1二级)',
    fr: 'Filtre Diesel(6HK1二级)',
    de: 'Dieselfilter(6HK1二级)',
    pt: 'Filtro Diesel(6HK1二级)',
    ru: 'Дизельный фильтр(6HK1二级)',
    ja: 'ディーゼルフィルター(6HK1二级)',
    zh: '柴油滤芯(6HK1二级)',
    ar: 'مرشح الديزل(6HK1二级)',
    it: 'Filtro Diesel(6HK1二级)',
  },
  'Exhaust Manifold': {
    en: 'Exhaust Manifold',
    es: 'Exhaust Manifold',
  ...
  'Fuel Injection Pump(FTR/FXR/FVR卡车版)': {
    en: 'Fuel Injection Pump(FTR/FXR/FVR卡车版)',
    es: 'Fuel Injection Bomba(FTR/FXR/FVR卡车版)',
    fr: 'Fuel Injection Pompe(FTR/FXR/FVR卡车版)',
    de: 'Fuel Injection Pumpe(FTR/FXR/FVR卡车版)',
    pt: 'Fuel Injection Bomba(FTR/FXR/FVR卡车版)',
    ru: 'Fuel Injection Насос(FTR/FXR/FVR卡车版)',
    ja: 'Fuel Injection ポンプ(FTR/FXR/FVR卡车版)',
    zh: 'Fuel Injection 泵(FTR/FXR/FVR卡车版)',
    ar: 'Fuel Injection مضخة(FTR/FXR/FVR卡车版)',
    it: 'Fuel Injection Pompa(FTR/FXR/FVR卡车版)',
  },
  'Fuel Injection Pump(型号2)': {
    en: 'Fuel Injection Pump(型号2)',
    es: 'Fuel Injection Bomba(型号2)',
    fr: 'Fuel Injection Pompe(型号2)',
    de: 'Fuel Injection Pumpe(型号2)',
    pt: 'Fuel Injection Bomba(型号2)',
    ru: 'Fuel Injection Насос(型号2)',
    ja: 'Fuel Injection ポンプ(型号2)',
    zh: 'Fuel Injection 泵(型号2)',
    ar: 'Fuel Injection مضخة(型号2)',
    it: 'Fuel Injection Pompa(型号2)',
  },
  'Fuel System': {
    en: 'Fuel System',
  ...
  'Hydraulic Oil Filter(6HK1型号2)': {
    en: 'Hydraulic Oil Filter(6HK1型号2)',
    es: 'Hydraulic Filtro de Aceite(6HK1型号2)',
    fr: 'Hydraulic Filtre à Huile(6HK1型号2)',
    de: 'Hydraulic Ölfilter(6HK1型号2)',
    pt: 'Hydraulic Filtro de Óleo(6HK1型号2)',
    ru: 'Hydraulic Масляный фильтр(6HK1型号2)',
    ja: 'Hydraulic オイルフィルター(6HK1型号2)',
    zh: 'Hydraulic 机油滤芯(6HK1型号2)',
    ar: 'Hydraulic فلتر الزيت(6HK1型号2)',
    it: 'Hydraulic Filtro Olio(6HK1型号2)',
  },
  ...
  'Hydraulic Oil Filter(型号3)': {
    en: 'Hydraulic Oil Filter(型号3)',
    es: 'Hydraulic Filtro de Aceite(型号3)',
    fr: 'Hydraulic Filtre à Huile(型号3)',
    de: 'Hydraulic Ölfilter(型号3)',
    pt: 'Hydraulic Filtro de Óleo(型号3)',
    ru: 'Hydraulic Масляный фильтр(型号3)',
    ja: 'Hydraulic オイルフィルター(型号3)',
    zh: 'Hydraulic 机油滤芯(型号3)',
    ar: 'Hydraulic فلتر الزيت(型号3)',
    it: 'Hydraulic Filtro Olio(型号3)',
  },
  'Intake/Boost System': {
  ...
  'Oil Filter(二级)': {
    en: 'Oil Filter(二级)',
    es: 'Filtro de Aceite(二级)',
    fr: 'Filtre à Huile(二级)',
    de: 'Ölfilter(二级)',
    pt: 'Filtro de Óleo(二级)',
    ru: 'Масляный фильтр(二级)',
    ja: 'オイルフィルター(二级)',
    zh: '机油滤芯(二级)',
    ar: 'فلتر الزيت(二级)',
    it: 'Filtro Olio(二级)',
  ...
  'Oil Filter(卡车版)': {
    en: 'Oil Filter(卡车版)',
    es: 'Filtro de Aceite(卡车版)',
    fr: 'Filtre à Huile(卡车版)',
    de: 'Ölfilter(卡车版)',
    pt: 'Filtro de Óleo(卡车版)',
    ru: 'Масляный фильтр(卡车版)',
    ja: 'オイルフィルター(卡车版)',
    zh: '机油滤芯(卡车版)',
    ar: 'فلتر الزيت(卡车版)',
    it: 'Filtro Olio(卡车版)',
  ...
  'Oil Filter(型号2)': {
    en: 'Oil Filter(型号2)',
    es: 'Filtro de Aceite(型号2)',
    fr: 'Filtre à Huile(型号2)',
    de: 'Ölfilter(型号2)',
    pt: 'Filtro de Óleo(型号2)',
    ru: 'Масляный фильтр(型号2)',
    ja: 'オイルフィルター(型号2)',
    zh: '机油滤芯(型号2)',
    ar: 'فلتر الزيت(型号2)',
    it: 'Filtro Olio(型号2)',
  ...
  'Oil Filter总成(6HK1-3代)': {
    en: 'Oil Filter总成(6HK1-3代)',
    es: 'Filtro de Aceite总成(6HK1-3代)',
    fr: 'Filtre à Huile总成(6HK1-3代)',
    de: 'Ölfilter总成(6HK1-3代)',
    pt: 'Filtro de Óleo总成(6HK1-3代)',
    ru: 'Масляный фильтр总成(6HK1-3代)',
    ja: 'オイルフィルター总成(6HK1-3代)',
    zh: '机油滤芯总成(6HK1-3代)',
    ar: 'فلتر الزيت总成(6HK1-3代)',
    it: 'Filtro Olio总成(6HK1-3代)',
  },
  'Oil Pump Assembly': {
    en: 'Pump',
    es: 'Bomba',
  ...
  'Turbocharger(RHG6型)': {
    en: 'Turbocharger(RHG6型)',
    es: 'Turbocharger(RHG6型)',
    fr: 'Turbocharger(RHG6型)',
    de: 'Turbocharger(RHG6型)',
    pt: 'Turbocharger(RHG6型)',
    ru: 'Turbocharger(RHG6型)',
    ja: 'Turbocharger(RHG6型)',
    zh: 'Turbocharger(RHG6型)',
    ar: 'Turbocharger(RHG6型)',
    it: 'Turbocharger(RHG6型)',
  },
  'Water Pump Assembly': {
    en: 'Pump',
    es: 'Bomba',
  ...
  'Water Pump Assembly(6HK1 FVR卡车版)': {
    en: 'Water Pump Assembly(6HK1 FVR卡车版)',
    es: 'Water Bomba Assembly(6HK1 FVR卡车版)',
    fr: 'Water Pompe Assembly(6HK1 FVR卡车版)',
    de: 'Water Pumpe Assembly(6HK1 FVR卡车版)',
    pt: 'Water Bomba Assembly(6HK1 FVR卡车版)',
    ru: 'Water Насос Assembly(6HK1 FVR卡车版)',
    ja: 'Water ポンプ Assembly(6HK1 FVR卡车版)',
    zh: 'Water 泵 Assembly(6HK1 FVR卡车版)',
    ar: 'Water مضخة Assembly(6HK1 FVR卡车版)',
    it: 'Water Pompa Assembly(6HK1 FVR卡车版)',
  },
  ...
  'Water Pump Assembly(6HK1型号2)': {
    en: 'Water Pump Assembly(6HK1型号2)',
    es: 'Water Bomba Assembly(6HK1型号2)',
    fr: 'Water Pompe Assembly(6HK1型号2)',
    de: 'Water Pumpe Assembly(6HK1型号2)',
    pt: 'Water Bomba Assembly(6HK1型号2)',
    ru: 'Water Насос Assembly(6HK1型号2)',
    ja: 'Water ポンプ Assembly(6HK1型号2)',
    zh: 'Water 泵 Assembly(6HK1型号2)',
    ar: 'Water مضخة Assembly(6HK1型号2)',
    it: 'Water Pompa Assembly(6HK1型号2)',
  },
  'Water Pump Assembly(型号2)': {
    en: 'Water Pump Assembly(型号2)',
    es: 'Water Bomba Assembly(型号2)',
    fr: 'Water Pompe Assembly(型号2)',
    de: 'Water Pumpe Assembly(型号2)',
    pt: 'Water Bomba Assembly(型号2)',
    ru: 'Water Насос Assembly(型号2)',
    ja: 'Water ポンプ Assembly(型号2)',
    zh: 'Water 泵 Assembly(型号2)',
    ar: 'Water مضخة Assembly(型号2)',
    it: 'Water Pompa Assembly(型号2)',
  },
  '电子Oil Pump': {
    en: '电子Oil Pump',
    es: '电子Oil Bomba',

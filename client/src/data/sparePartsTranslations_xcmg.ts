...
export const xcmgNameTranslations: Record<string, Record<string, string>> = {
  'Hydraulic Oil Filter': {
    en: 'Hydraulic Oil Filter', zh: '液压油滤芯', es: 'Filtro de Aceite Hidráulico', fr: 'Filtre à Huile Hydraulique', de: 'Hydraulikölfilter', pt: 'Filtro de Óleo Hidráulico', ru: 'Гидравлический масляный фильтр', ja: '油圧オイルフィルター', ar: 'مرشح الزيت الهيدروليكي', it: 'Filtro olio idraulico'
  },
  'Air Filter': {
    en: 'Air Filter', zh: '空气滤芯', es: 'Filtro de Aire', fr: 'Filtre à Air', de: 'Luftfilter', pt: 'Filtro de Ar', ru: 'Воздушный фильтр', ja: 'エアフィルター', ar: 'مرشح الهواء', it: 'Filtro dell\'aria'
  },
...
export const xcmgCategoryTranslations: Record<string, Record<string, string>> = {
  'Maintenance/Filtration System': {
    en: 'Maintenance/Filtration System', zh: '维护/过滤系统', es: 'Sistema de Mantenimiento/Filtración', fr: 'Système de Maintenance/Filtration', de: 'Wartungs-/Filtersystem', pt: 'Sistema de Manutenção/Filtração', ru: 'Система обслуживания/фильтрации', ja: 'メンテナンス/フィルトレーションシステム', ar: 'نظام الصيانة/الترشيح', it: 'Sistema di manutenzione/filtrazione'
  },
...
export const xcmgDescriptionTranslations: Record<string, Record<string, string>> = {
  'Hydraulic Oil Filter': {
    en: 'OEM quality hydraulic oil filter for XCMG excavators and loaders. Replace every 500-1000 hours.',
    zh: 'XCMG挖掘机和装载机OEM质量液压油滤芯。每500-1000小时更换。',
    es: 'Filtro de aceite hidráulico de calidad OEM para excavadoras y cargadores XCMG. Reemplazar cada 500-1000 horas.',
    fr: 'Filtre à huile hydraulique de qualité OEM pour les excavatrices et chargeuses XCMG. Remplacer tous les 500-1000 heures.',
    de: 'OEM-Qualitäts-Hydraulikölfilter für XCMG-Bagger und -Radlader. Alle 500-1000 Stunden wechseln.',
    pt: 'Filtro de óleo hidráulico de qualidade OEM para escavadeiras e carregadeiras XCMG. Substituir a cada 500-1000 horas.',
    ru: 'Гидравлический масляный фильтр качества OEM для экскаваторов и погрузчиков XCMG. Заменяйте каждые 500-1000 часов.',
    ja: 'XCMG油圧ショベルおよびホイールローダー用OEM品質油圧オイルフィルター。500-1000時間ごとに交換。',
    ar: 'مرشح الزيت الهيدروليكي بجودة OEM لحفارات وأحمال XCMG. استبدل كل 500-1000 ساعة.',
    it: 'Filtro olio idraulico di qualità OEM per escavatori e caricatori XCMG. Sostituire ogni 500-1000 ore.'
  },
  'Air Filter': {
    en: 'High-efficiency air filter for XCMG engine intake. Replace every 250-500 hours.',
    zh: 'XCMG发动机进气高效空气滤芯。每250-500小时更换。',
    es: 'Filtro de aire de alta eficiencia para la entrada del motor XCMG. Reemplazar cada 250-500 horas.',
    fr: 'Filtre à air haute efficacité pour l\'admission du moteur XCMG. Remplacer tous les 250-500 heures.',
    de: 'Hocheffizienter Luftfilter für die XCMG-Motoreintrittsöffnung. Alle 250-500 Stunden wechseln.',
    pt: 'Filtro de ar de alta eficiência para a entrada do motor XCMG. Substituir a cada 250-500 horas.',
    ru: 'Высокоэффективный воздушный фильтр для впуска двигателя XCMG. Заменяйте каждые 250-500 часов.',
    ja: 'XCMG エンジン吸気用高効率エアフィルター。250-500時間ごとに交換。',

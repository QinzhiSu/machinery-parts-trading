...
export const sanyNameTranslations = {
  ...
  'Oil Filter(SY215C/225C系列)': {
    en: 'Oil Filter(SY215C/225C系列)',
    es: 'Filtro de Aceite(SY215C/225C系列)',
    fr: 'Filtre à Huile(SY215C/225C系列)',
    de: 'Ölfilter(SY215C/225C系列)',
    pt: 'Filtro de Óleo(SY215C/225C系列)',
    ru: 'Масляный фильтр(SY215C/225C系列)',
    ja: 'オイルフィルター(SY215C/225C系列)',
    zh: '机油滤芯(SY215C/225C系列)',
    ar: 'فلتر الزيت(SY215C/225C系列)',
    it: 'Filtro Olio(SY215C/225C系列)',
  },
  ...
  '上托轮(Top Roller/Carrier Roller)': {
    ...
    ar: '上托轮(Top Roller/Carrier Roller)',
    it: '上托轮(Top Roller/Carrier Roller)',
  },
  '下托链轮(Bottom Roller)': {

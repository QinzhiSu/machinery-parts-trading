...
// Comprehensive translation map for ALL machine descriptions
// This is an auto-generated file that maps English descriptions to 8 languages
// To add new machines, add their English description as a key with translations for all 8 languages

const allMachineTranslations: Record<string, Record<string, string>> = {
...
export function useMachineTranslations() {
  ...
  const translateDescription = (description: string): string => {
    const translations = allMachineTranslations[description];

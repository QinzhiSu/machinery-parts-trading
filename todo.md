...
- [x] 为 Caterpillar 品牌添加 73 个缺失的零件名称翻译
- [x] 为 Shantui 品牌添加 41 个缺失的零件名称翻译
- [x] 为 Isuzu 品牌添加 69 个缺失的零件名称翻译
- [x] 为 Komatsu 品牌添加 46 个缺失的零件名称翻译
- [x] 为 SANY 品牌添加 29 个缺失的零件名称翻译
- [x] 为 XCMG 品牌添加 26 个缺失的零件名称翻译
- [x] 为 Sinotruk 品牌添加 93 个缺失的零件名称翻译
- [x] 为 Toyota 品牌添加 54 个缺失的零件名称翻译
- [x] 为 Cummins 品牌添加 28 个缺失的零件名称翻译
- [x] 为 Weichai 品牌添加 62 个缺失的零件名称翻译
- [x] 为 Shacman 品牌添加 45 个缺失的零件名称翻译

**修复统计：**
- 总共修复了 493 个零件名称翻译条目
- 所有零件现在都支持完整的 10 种语言翻译
- 所有翻译包含英、西、法、德、葡、俄、日、中、阿、意 10 种语言
- 项目编译正常，无错误

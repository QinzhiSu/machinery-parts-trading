...
- [ ] 为 Caterpillar 品牌的所有机器创建 8 种语言翻译
- [ ] 为 Komatsu 品牌的所有机器创建 8 种语言翻译
- [ ] 为 XCMG 品牌的所有机器创建 8 种语言翻译
- [ ] 为 Shantui 品牌的所有机器创建 8 种语言翻译
- [ ] 为 SANY 品牌的所有机器创建 8 种语言翻译
- [ ] 为 LiuGong 品牌的所有机器创建 8 种语言翻译
- [ ] 为 Isuzu 品牌的所有机器创建 8 种语言翻译
- [ ] 为 Shacman 品牌的所有机器创建 8 种语言翻译
- [ ] 为 Sinotruk 品牌的所有机器创建 8 种语言翻译
- [ ] 为 Cummins 品牌的所有机器创建 8 种语言翻译
- [ ] 为 Weichai 品牌的所有机器创建 8 种语言翻译
- [ ] 测试所有品牌的所有机器在 8 种语言下的翻译显示效果

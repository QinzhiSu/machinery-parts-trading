...
- [ ] 为徐工零件分类添加 8 种语言翻译（Maintenance/Filtration System、Electrical/Sensor System、Excavation/Bucket Teeth 等）
- [ ] 为徐工零件描述添加 8 种语言翻译（26 个零件的详细描述）
- [ ] 更新 BrandPage.tsx 使用翻译后的分类和描述
- [ ] 重启开发服务器应用修复
- [ ] 浏览器验证：所有零件分类和描述在所有 8 种语言下都能正确显示翻译

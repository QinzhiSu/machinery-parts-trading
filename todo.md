...
- [x] 实现动态翻译系统（useAutoTranslate Hook + MachineDescriptionTranslator 组件）
- [x] 为 Caterpillar 品牌的所有机器实现动态翻译
- [x] 为 Komatsu 品牌的所有机器实现动态翻译
- [x] 为 XCMG 品牌的所有机器实现动态翻译
- [x] 为 Shantui 品牌的所有机器实现动态翻译
- [x] 为 SANY 品牌的所有机器实现动态翻译
- [x] 为 LiuGong 品牌的所有机器实现动态翻译
- [x] 为 Isuzu 品牌的所有机器实现动态翻译
- [x] 为 Shacman 品牌的所有机器实现动态翻译
- [x] 为 Sinotruk 品牌的所有机器实现动态翻译
- [x] 为 Cummins 品牌的所有机器实现动态翻译
- [x] 为 Weichai 品牌的所有机器实现动态翻译
- [x] 测试所有品牌的所有机器在 8 种语言下的翻译显示效果（已验证中文、西班牙文、阿拉伯文）
